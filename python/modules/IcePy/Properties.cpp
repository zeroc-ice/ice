...
static PyMethodDef PropertyMethods[] = {
    {"getProperty",
     ...
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_getProperty)},
    {"getIceProperty",
     reinterpret_cast<PyCFunction>(propertiesGetIceProperty),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_getIceProperty)},
    {"getPropertyWithDefault",
     reinterpret_cast<PyCFunction>(propertiesGetPropertyWithDefault),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_getPropertyWithDefault)},
    {"getPropertyAsInt",
     reinterpret_cast<PyCFunction>(propertiesGetPropertyAsInt),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_getPropertyAsInt)},
    {"getIcePropertyAsInt",
     reinterpret_cast<PyCFunction>(propertiesGetIcePropertyAsInt),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_getIcePropertyAsInt)},
    {"getPropertyAsIntWithDefault",
     reinterpret_cast<PyCFunction>(propertiesGetPropertyAsIntWithDefault),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_getPropertyAsIntWithDefault)},
    {"getPropertyAsList",
     reinterpret_cast<PyCFunction>(propertiesGetPropertyAsList),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_getPropertyAsList)},
    {"getIcePropertyAsList",
     reinterpret_cast<PyCFunction>(propertiesGetIcePropertyAsList),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_getIcePropertyAsList)},
    {"getPropertyAsListWithDefault",
     reinterpret_cast<PyCFunction>(propertiesGetPropertyAsListWithDefault),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_getPropertyAsListWithDefault)},
    {"getPropertiesForPrefix",
     reinterpret_cast<PyCFunction>(propertiesGetPropertiesForPrefix),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_getPropertiesForPrefix)},
    {"setProperty",
     reinterpret_cast<PyCFunction>(propertiesSetProperty),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_setProperty)},
    {"getCommandLineOptions",
     reinterpret_cast<PyCFunction>(propertiesGetCommandLineOptions),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_Properties_getCommandLineOptions)},
    {"parseCommandLineOptions",
     reinterpret_cast<PyCFunction>(propertiesParseCommandLineOptions),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_parseCommandLineOptions)},
    {"parseIceCommandLineOptions",
     reinterpret_cast<PyCFunction>(propertiesParseIceCommandLineOptions),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_Properties_parseIceCommandLineOptions)},
    {"load", reinterpret_cast<PyCFunction>(propertiesLoad), METH_VARARGS, PyDoc_STR(IcePy_DOC_Properties_load)},
    {"clone", reinterpret_cast<PyCFunction>(propertiesClone), METH_NOARGS, PyDoc_STR(IcePy_DOC_Properties_clone)},
    {} /* sentinel */
};
...
namespace IcePy
{
    ...
    PyTypeObject PropertiesType = {
        ...
        .tp_doc = PyDoc_STR(IcePy_DOC_Properties),
