...
static PyMethodDef PropertyMethods[] = {
    ...
    {"getPropertyWithDefault",
     ...
     METH_VARARGS,
     PyDoc_STR("getPropertyWithDefault(key: str, default: str) -> str")},
    {"getPropertyAsInt",
    ...
    {"getPropertyAsIntWithDefault",
     ...
     METH_VARARGS,
     PyDoc_STR("getPropertyAsIntWithDefault(key: str, default: int) -> int")},
    {"getPropertyAsList",
    ...
    {"getPropertyAsListWithDefault",
     ...
     METH_VARARGS,
     PyDoc_STR("getPropertyAsListWithDefault(key: str, default: list[str]) -> list[str]")},
