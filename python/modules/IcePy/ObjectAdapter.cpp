...
static PyMethodDef AdapterMethods[] = {
    ...
    {"waitForHold",
     ...
     METH_VARARGS,
     PyDoc_STR("waitForHold(timeout: int) -> bool")},
    ...
    {"findDefaultServant",
     ...
     METH_VARARGS,
     PyDoc_STR("findDefaultServant(category: str) -> Ice.Object | None")},
    {"addServantLocator",
    ...
    {"findServantLocator",
     ...
     METH_VARARGS,
     PyDoc_STR("findServantLocator(category: str) -> Ice.ServantLocator | None")},
    {"createProxy",
    ...
    {"setLocator",
     ...
     METH_VARARGS,
     PyDoc_STR("setLocator(locator: Ice.LocatorPrx | None) -> None")},
    {"getLocator",
     reinterpret_cast<PyCFunction>(adapterGetLocator),
     METH_NOARGS,
     PyDoc_STR("getLocator() -> Ice.LocatorPrx | None")},
    {"getEndpoints",
     reinterpret_cast<PyCFunction>(adapterGetEndpoints),
     METH_NOARGS,
     PyDoc_STR("getEndpoints() -> tuple[Endpoint, ...]")},
