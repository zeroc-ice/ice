...
static PyMethodDef AdapterMethods[] = {
    {"getName", reinterpret_cast<PyCFunction>(adapterGetName), METH_NOARGS, PyDoc_STR(IcePy_DOC_ObjectAdapter_getName)},
    {"getCommunicator",
     reinterpret_cast<PyCFunction>(adapterGetCommunicator),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_getCommunicator)},
    {"activate",
     reinterpret_cast<PyCFunction>(adapterActivate),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_activate)},
    {"hold", reinterpret_cast<PyCFunction>(adapterHold), METH_NOARGS, PyDoc_STR(IcePy_DOC_ObjectAdapter_hold)},
    {"waitForHold",
     reinterpret_cast<PyCFunction>(adapterWaitForHold),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_waitForHold)},
    {"deactivate",
     reinterpret_cast<PyCFunction>(adapterDeactivate),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_deactivate)},
    {"waitForDeactivate",
     reinterpret_cast<PyCFunction>(adapterWaitForDeactivate),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_waitForDeactivate)},
    {"isDeactivated",
     reinterpret_cast<PyCFunction>(adapterIsDeactivated),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_isDeactivated)},
    {"destroy", reinterpret_cast<PyCFunction>(adapterDestroy), METH_NOARGS, PyDoc_STR(IcePy_DOC_ObjectAdapter_destroy)},
    {"add", reinterpret_cast<PyCFunction>(adapterAdd), METH_VARARGS, PyDoc_STR(IcePy_DOC_ObjectAdapter_add)},
    {"addFacet",
     reinterpret_cast<PyCFunction>(adapterAddFacet),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_addFacet)},
    {"addWithUUID",
     reinterpret_cast<PyCFunction>(adapterAddWithUUID),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_addWithUUID)},
    {"addFacetWithUUID",
     reinterpret_cast<PyCFunction>(adapterAddFacetWithUUID),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_addFacetWithUUID)},
    {"addDefaultServant",
     reinterpret_cast<PyCFunction>(adapterAddDefaultServant),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_addDefaultServant)},
    {"remove", reinterpret_cast<PyCFunction>(adapterRemove), METH_VARARGS, PyDoc_STR(IcePy_DOC_ObjectAdapter_remove)},
    {"removeFacet",
     reinterpret_cast<PyCFunction>(adapterRemoveFacet),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_removeFacet)},
    {"removeAllFacets",
     reinterpret_cast<PyCFunction>(adapterRemoveAllFacets),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_removeAllFacets)},
    {"removeDefaultServant",
     reinterpret_cast<PyCFunction>(adapterRemoveDefaultServant),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_removeDefaultServant)},
    {"find", reinterpret_cast<PyCFunction>(adapterFind), METH_VARARGS, PyDoc_STR(IcePy_DOC_ObjectAdapter_find)},
    {"findFacet",
     reinterpret_cast<PyCFunction>(adapterFindFacet),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_findFacet)},
    {"findAllFacets",
     reinterpret_cast<PyCFunction>(adapterFindAllFacets),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_findAllFacets)},
    {"findByProxy",
     reinterpret_cast<PyCFunction>(adapterFindByProxy),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_findByProxy)},
    {"findDefaultServant",
     reinterpret_cast<PyCFunction>(adapterFindDefaultServant),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_findDefaultServant)},
    {"addServantLocator",
     reinterpret_cast<PyCFunction>(adapterAddServantLocator),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_addServantLocator)},
    {"removeServantLocator",
     reinterpret_cast<PyCFunction>(adapterRemoveServantLocator),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_removeServantLocator)},
    {"findServantLocator",
     reinterpret_cast<PyCFunction>(adapterFindServantLocator),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_findServantLocator)},
    {"createProxy",
     reinterpret_cast<PyCFunction>(adapterCreateProxy),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_createProxy)},
    {"createDirectProxy",
     reinterpret_cast<PyCFunction>(adapterCreateDirectProxy),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_createDirectProxy)},
    {"createIndirectProxy",
     reinterpret_cast<PyCFunction>(adapterCreateIndirectProxy),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_createIndirectProxy)},
    {"setLocator",
     reinterpret_cast<PyCFunction>(adapterSetLocator),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_setLocator)},
    {"getLocator",
     reinterpret_cast<PyCFunction>(adapterGetLocator),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_getLocator)},
    {"getEndpoints",
     reinterpret_cast<PyCFunction>(adapterGetEndpoints),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_getEndpoints)},
    {"getPublishedEndpoints",
     reinterpret_cast<PyCFunction>(adapterGetPublishedEndpoints),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectAdapter_getPublishedEndpoints)},
...
namespace IcePy
{
    ...
    PyTypeObject ObjectAdapterType = {
        ...
        .tp_doc = PyDoc_STR(IcePy_DOC_ObjectAdapter),
