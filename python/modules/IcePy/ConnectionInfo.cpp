...
static PyGetSetDef IPConnectionInfoGetters[] = {
    ...
    {STRCAST("localPort"), reinterpret_cast<getter>(ipConnectionInfoGetLocalPort), 0, PyDoc_STR(STRCAST("local port")),
     0},
...
static PyGetSetDef WSConnectionInfoGetters[] = {
    {STRCAST("headers"), reinterpret_cast<getter>(wsConnectionInfoGetHeaders), 0, PyDoc_STR(STRCAST("request headers")),
     0},
    {0, 0} /* sentinel */
};
...
static PyGetSetDef SSLConnectionInfoGetters[] = {
    ...
    {STRCAST("certs"), reinterpret_cast<getter>(sslConnectionInfoGetCerts), 0, PyDoc_STR(STRCAST("certificate chain")),
     0},
