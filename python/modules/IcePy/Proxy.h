...
PyObject* createProxy(const std::shared_ptr<Ice::ObjectPrx>&, const Ice::CommunicatorPtr&, PyObject* = 0);
...
//
std::shared_ptr<Ice::ObjectPrx> getProxy(PyObject*);
...
//
bool getProxyArg(PyObject*, const std::string&, const std::string&, std::shared_ptr<Ice::ObjectPrx>&,
