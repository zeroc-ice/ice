...
For pre-releases, the version includes a pre-release suffix, for example ``3.8.0-alpha.0``.
...
For pre-releases, ``CC`` encodes the pre-release; for example, for Ice 3.8.0-alpha.0, the returned value is 30850.
