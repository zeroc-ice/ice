...
static PyMethodDef methods[] = {
    ...
    {"stringToProtocolVersion",
     ...
     METH_VARARGS,
     PyDoc_STR(
         "stringToProtocolVersion(version: str) -> Ice.ProtocolVersion\n\n"
    ...
    {"protocolVersionToString",
     ...
     METH_VARARGS,
     PyDoc_STR(
         "protocolVersionToString(version: Ice.ProtocolVersion) -> str\n\n"
    ...
    {"stringToEncodingVersion",
     ...
     METH_VARARGS,
     PyDoc_STR(
         "stringToEncodingVersion(version: str) -> Ice.EncodingVersion\n\n"
    ...
    {"encodingVersionToString",
     ...
     METH_VARARGS,
     PyDoc_STR(
         "encodingVersionToString(version: Ice.EncodingVersion) -> str\n\n"
    ...
    {"createProperties",
     ...
     METH_VARARGS,
     PyDoc_STR(
         "createProperties(args: list[str] | None = None) -> Ice.Properties\n\n"
    ...
    {"stringToIdentity",
     ...
     METH_O,
     PyDoc_STR(
         "stringToIdentity(s: str) -> Ice.Identity\n\n"
    ...
    {"identityToString",
     ...
     METH_VARARGS,
     PyDoc_STR(
         "identityToString(ident: Ice.Identity, mode: Ice.ToStringMode = Ice.ToStringMode.Unicode) -> str\n\n"
