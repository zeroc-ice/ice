...
static PyMethodDef ProxyMethods[] = {
    {"ice_getCommunicator",
     ...
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getCommunicator)},
    {"ice_toString",
     reinterpret_cast<PyCFunction>(proxyRepr),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_toString)},
    {"ice_getIdentity",
     reinterpret_cast<PyCFunction>(proxyIceGetIdentity),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getIdentity)},
    {"ice_identity",
     reinterpret_cast<PyCFunction>(proxyIceIdentity),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_identity)},
    {"ice_getContext",
     reinterpret_cast<PyCFunction>(proxyIceGetContext),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getContext)},
    {"ice_context",
     reinterpret_cast<PyCFunction>(proxyIceContext),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_context)},
    {"ice_getFacet",
     reinterpret_cast<PyCFunction>(proxyIceGetFacet),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getFacet)},
    {"ice_facet", reinterpret_cast<PyCFunction>(proxyIceFacet), METH_VARARGS, PyDoc_STR(IcePy_DOC_ObjectPrx_ice_facet)},
    {"ice_getAdapterId",
     reinterpret_cast<PyCFunction>(proxyIceGetAdapterId),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getAdapterId)},
    {"ice_adapterId",
     reinterpret_cast<PyCFunction>(proxyIceAdapterId),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_adapterId)},
    {"ice_getEndpoints",
     reinterpret_cast<PyCFunction>(proxyIceGetEndpoints),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getEndpoints)},
    {"ice_endpoints",
     reinterpret_cast<PyCFunction>(proxyIceEndpoints),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_endpoints)},
    {"ice_getLocatorCacheTimeout",
     reinterpret_cast<PyCFunction>(proxyIceGetLocatorCacheTimeout),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getLocatorCacheTimeout)},
    {"ice_getInvocationTimeout",
     reinterpret_cast<PyCFunction>(proxyIceGetInvocationTimeout),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getInvocationTimeout)},
    {"ice_getConnectionId",
     reinterpret_cast<PyCFunction>(proxyIceGetConnectionId),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getConnectionId)},
    {"ice_isCollocationOptimized",
     reinterpret_cast<PyCFunction>(proxyIceIsCollocationOptimized),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_isCollocationOptimized)},
    {"ice_collocationOptimized",
     reinterpret_cast<PyCFunction>(proxyIceCollocationOptimized),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_collocationOptimized)},
    {"ice_locatorCacheTimeout",
     reinterpret_cast<PyCFunction>(proxyIceLocatorCacheTimeout),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_locatorCacheTimeout)},
    {"ice_invocationTimeout",
     reinterpret_cast<PyCFunction>(proxyIceInvocationTimeout),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_invocationTimeout)},
    {"ice_isConnectionCached",
     reinterpret_cast<PyCFunction>(proxyIceIsConnectionCached),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_isConnectionCached)},
    {"ice_connectionCached",
     reinterpret_cast<PyCFunction>(proxyIceConnectionCached),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_connectionCached)},
    {"ice_getEndpointSelection",
     reinterpret_cast<PyCFunction>(proxyIceGetEndpointSelection),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getEndpointSelection)},
    {"ice_endpointSelection",
     reinterpret_cast<PyCFunction>(proxyIceEndpointSelection),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_endpointSelection)},
    {"ice_getEncodingVersion",
     reinterpret_cast<PyCFunction>(proxyIceGetEncodingVersion),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getEncodingVersion)},
    {"ice_encodingVersion",
     reinterpret_cast<PyCFunction>(proxyIceEncodingVersion),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_encodingVersion)},
    {"ice_getRouter",
     reinterpret_cast<PyCFunction>(proxyIceGetRouter),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getRouter)},
    {"ice_router",
     reinterpret_cast<PyCFunction>(proxyIceRouter),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_router)},
    {"ice_getLocator",
     reinterpret_cast<PyCFunction>(proxyIceGetLocator),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getLocator)},
    {"ice_locator",
     reinterpret_cast<PyCFunction>(proxyIceLocator),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_locator)},
    {"ice_twoway",
     reinterpret_cast<PyCFunction>(proxyIceTwoway),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_twoway)},
    {"ice_isTwoway",
     reinterpret_cast<PyCFunction>(proxyIceIsTwoway),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_isTwoway)},
    {"ice_oneway",
     reinterpret_cast<PyCFunction>(proxyIceOneway),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_oneway)},
    {"ice_isOneway",
     reinterpret_cast<PyCFunction>(proxyIceIsOneway),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_isOneway)},
    {"ice_batchOneway",
     reinterpret_cast<PyCFunction>(proxyIceBatchOneway),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_batchOneway)},
    {"ice_isBatchOneway",
     reinterpret_cast<PyCFunction>(proxyIceIsBatchOneway),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_isBatchOneway)},
    {"ice_datagram",
     reinterpret_cast<PyCFunction>(proxyIceDatagram),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_datagram)},
    {"ice_isDatagram",
     reinterpret_cast<PyCFunction>(proxyIceIsDatagram),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_isDatagram)},
    {"ice_batchDatagram",
     reinterpret_cast<PyCFunction>(proxyIceBatchDatagram),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_batchDatagram)},
    {"ice_isBatchDatagram",
     reinterpret_cast<PyCFunction>(proxyIceIsBatchDatagram),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_isBatchDatagram)},
    {"ice_compress",
     reinterpret_cast<PyCFunction>(proxyIceCompress),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_compress)},
    {"ice_getCompress",
     reinterpret_cast<PyCFunction>(proxyIceGetCompress),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getCompress)},
    {"ice_connectionId",
     reinterpret_cast<PyCFunction>(proxyIceConnectionId),
     METH_VARARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_connectionId)},
    {"ice_fixed", reinterpret_cast<PyCFunction>(proxyIceFixed), METH_VARARGS, PyDoc_STR(IcePy_DOC_ObjectPrx_ice_fixed)},
    {"ice_isFixed",
     reinterpret_cast<PyCFunction>(proxyIceIsFixed),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_isFixed)},
    {"ice_getConnection",
     reinterpret_cast<PyCFunction>(proxyIceGetConnection),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getConnection)},
    {"ice_getConnectionAsync",
     reinterpret_cast<PyCFunction>(proxyIceGetConnectionAsync),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getConnectionAsync)},
    {"ice_getCachedConnection",
     reinterpret_cast<PyCFunction>(proxyIceGetCachedConnection),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_getCachedConnection)},
    {"ice_flushBatchRequests",
     reinterpret_cast<PyCFunction>(proxyIceFlushBatchRequests),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_flushBatchRequests)},
    {"ice_flushBatchRequestsAsync",
     reinterpret_cast<PyCFunction>(proxyIceFlushBatchRequestsAsync),
     METH_NOARGS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_flushBatchRequestsAsync)},
    {"ice_invoke",
     reinterpret_cast<PyCFunction>(proxyIceInvoke),
     METH_VARARGS | METH_KEYWORDS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_invoke)},
    {"ice_invokeAsync",
     reinterpret_cast<PyCFunction>(proxyIceInvokeAsync),
     METH_VARARGS | METH_KEYWORDS,
     PyDoc_STR(IcePy_DOC_ObjectPrx_ice_invokeAsync)},
    {"newProxy",
     reinterpret_cast<PyCFunction>(proxyNewProxy),
     METH_VARARGS | METH_STATIC,
     PyDoc_STR(IcePy_DOC_ObjectPrx_newProxy)},
    {} /* sentinel */
};
...
namespace IcePy
{
    ...
    PyTypeObject ProxyType = {
        ...
        .tp_doc = PyDoc_STR(IcePy_DOC_ObjectPrx),
