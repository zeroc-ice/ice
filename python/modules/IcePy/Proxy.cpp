...
static PyMethodDef ProxyMethods[] = {
    ...
    {STRCAST("ice_getInvocationTimeout"), reinterpret_cast<PyCFunction>(proxyIceGetInvocationTimeout), METH_NOARGS,
     PyDoc_STR(STRCAST("ice_getInvocationTimeout() -> int"))},
    {STRCAST("ice_getConnectionId"), reinterpret_cast<PyCFunction>(proxyIceGetConnectionId), METH_NOARGS,
    ...
    {STRCAST("ice_getConnectionAsync"), reinterpret_cast<PyCFunction>(proxyIceGetConnectionAsync), METH_NOARGS,
