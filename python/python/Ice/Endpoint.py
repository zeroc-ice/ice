...
if "EndpointInfo" not in _M_Ice.__dict__:
    ...
    _M_Ice._t_EndpointInfo = IcePy.defineValue(
        "::Ice::EndpointInfo",
        EndpointInfo,
        -1,
        (),
...
if "IPEndpointInfo" not in _M_Ice.__dict__:
    ...
    _M_Ice._t_IPEndpointInfo = IcePy.defineValue(
        "::Ice::IPEndpointInfo",
        IPEndpointInfo,
        -1,
        (),
...
if "TCPEndpointInfo" not in _M_Ice.__dict__:
    ...
    class TCPEndpointInfo(_M_Ice.IPEndpointInfo):
        ...
        def __init__(
            ...
            _M_Ice.IPEndpointInfo.__init__(
...
if "UDPEndpointInfo" not in _M_Ice.__dict__:
    ...
    _M_Ice._t_UDPEndpointInfo = IcePy.defineValue(
        "::Ice::UDPEndpointInfo",
        UDPEndpointInfo,
        -1,
        (),
...
if "WSEndpointInfo" not in _M_Ice.__dict__:
    ...
    _M_Ice._t_WSEndpointInfo = IcePy.defineValue(
        "::Ice::WSEndpointInfo",
        WSEndpointInfo,
        -1,
        (),
...
if "OpaqueEndpointInfo" not in _M_Ice.__dict__:
    ...
    class OpaqueEndpointInfo(_M_Ice.EndpointInfo):
        ...
        def __init__(
            ...
            timeout=0,
            compress=False,
            rawEncoding=Ice._struct_marker,
            rawBytes=None,
        ):
    ...
    _M_Ice._t_OpaqueEndpointInfo = IcePy.defineValue(
