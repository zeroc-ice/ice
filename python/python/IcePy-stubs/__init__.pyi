...
# This stub is the single source of truth for IcePy docstrings:
# python/modules/IcePy/DocStrings.h is generated from it by scripts/generateIcePyDocs.py,
# and CI verifies that the header is current (scripts/generateIcePyDocs.py --check).
...
class Communicator:
    def __init__(self, initData: Ice.InitializationData | None, /) -> None: ...
    def _getWrapper(self) -> Ice.Communicator: ...
    def _setWrapper(self, wrapper: Ice.Communicator, /) -> None: ...
    def addAdminFacet(self, servant: Ice.Object, facet: str, /) -> None: ...
    ...
    def findAdminFacet(self, facet: str, /) -> Ice.Object | NativePropertiesAdmin | None: ...
    def findAllAdminFacets(self) -> dict[str, Ice.Object | NativePropertiesAdmin]: ...
    ...
    def propertyToProxy(self, property: str, /) -> Ice.ObjectPrx | None: ...
    ...
    def removeAdminFacet(self, facet: str, /) -> Ice.Object | None: ...
    ...
    def stringToProxy(self, str: str, /) -> Ice.ObjectPrx | None: ...
...
class EndpointInfo:
    ...
    """Ice.EndpointInfo | None: The information of the underlying endpoint or ``None`` if there's no underlying
    endpoint."""

    compress: bool
    """bool: Specifies whether or not compression should be used if available when using this endpoint."""
...
class ObjectAdapter:
    ...
    def setLocator(self, locator: Ice.LocatorPrx | None, /) -> None: ...
    def setPublishedEndpoints(self, newEndpoints: tuple[Endpoint, ...] | list[Endpoint], /) -> None: ...
    def waitForDeactivate(self, timeout: int, /) -> bool: ...
    def waitForHold(self, timeout: int, /) -> bool: ...

class ObjectPrx:
    def __init__(self, communicator: Ice.Communicator, proxyString: str, /) -> None: ...
    ...
    def ice_facet(self, new_facet: str, /) -> Ice.ObjectPrx: ...
    ...
    def ice_identity(self, newIdentity: Ice.Identity, /) -> Ice.ObjectPrx: ...
    def ice_invocationTimeout(self, timeout: int, /) -> Self: ...
    def ice_invoke(
        self, operation: str, mode: Ice.OperationMode, inParams: bytes, ctx: dict[str, str] | None = None
    ) -> tuple[bool, bytes]: ...
    def ice_invokeAsync(
        self, operation: str, mode: Ice.OperationMode, inParams: bytes, ctx: dict[str, str] | None = None
...
class Properties:
    def __init__(self, args: list[str] | None = None, defaults: Ice.Properties | None = None, /) -> None: ...
...
def defineProxy(sliceId: str, proxyType: Type[ObjectPrx], /): ...
