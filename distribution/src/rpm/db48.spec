...
%package utils
Summary: Command line tools for managing Berkeley DB (version 4.8) databases
Group: Applications/Databases
Requires: db48 = %{version}-%{release}
...
(version 4.8) databases.

%package devel
Summary: Development files for the Berkeley DB (version 4.8) library
...
%package java
Summary: Development files for using the Berkeley DB (version 4.8) with Java
Group: Development/Libraries
...
for i in db_* ; do mv $i db48_${i#db_} ; done
