...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  %(prog)s -s C:\\workspace\\ice --version 3.8.3 --source-base-url https://sources.zeroc.com/ice -o C:\\output\\symbols
  %(prog)s -s C:\\workspace\\ice --version 3.8.3-nightly.20251210.2 --source-base-url https://sources.zeroc.com/ice -o symbols --verbose
        """,
    )
    parser.add_argument(
        "--source-dir",
