...
```bash
sudo dnf install -y https://zeroc.com/download/ice/nightly/3.9/el9/ice-repo-3.9-nightly-1.0.0-1.el9.noarch.rpm
...
```bash
sudo dnf install -y https://zeroc.com/download/ice/nightly/3.9/el10/ice-repo-3.9-nightly-1.0.0-1.el10.noarch.rpm
