...
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\testCommon.lib ..\..\lib\	copy $(OutDir)\testCommon21.dll ..\..\bin
...
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\testCommond.lib ..\..\lib\	copy $(OutDir)\testCommon21d.pdb ..\..\bin	copy $(OutDir)\testCommon21d.dll ..\..\bin
# End Special Build Tool
