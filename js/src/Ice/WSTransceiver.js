...
class WSTransceiver {
    ...
    initialize() {
        ...
        if (this._state === StateNeedConnect) {
            ...
            try {
                ...
                this._exception = new ConnectFailedException("connect failed", { cause: e });
                throw this._exception;
            }
    ...
    socketClosed(event) {
        ...
        if (this._state < StateConnected) {
            this._exception = new ConnectFailedException("connect failed", { cause: event });
            this._connectedCallback();
            ...
            this._exception = new ConnectionLostException();
        } else {
            this._exception = new SocketException("connection closed", { cause: event });
        }
