...
export class MyDerivedClassI extends Test.MyDerivedClass {
    ...
    supportsCompress(_: Ice.Current) {
        return false;
    }
    ...
    opBool(p1: boolean, p2: boolean, _: Ice.Current): [boolean, boolean] {
        return [p2, p1];
    }

    opBoolS(p1: boolean[], p2: boolean[], _: Ice.Current): [boolean[], boolean[]] {
        const p3 = p1.concat(p2);
        return [p1.reverse(), p3];
    }

    opBoolSS(p1: boolean[][], p2: boolean[][], _: Ice.Current): [boolean[][], boolean[][]] {
        const p3 = p1.concat(p2);
        return [p1.reverse(), p3];
    }

    opByte(p1: number, p2: number, _: Ice.Current): [number, number] {
    ...
    opByteS(p1: Uint8Array, p2: Uint8Array, _: Ice.Current): [Uint8Array, Uint8Array] {
    ...
    opByteSS(p1: Uint8Array[], p2: Uint8Array[], _: Ice.Current): [Uint8Array[], Uint8Array[]] {
        const r = p1.concat(p2);
        return [r, p1.reverse()];
    }

    opFloatDouble(p1: number, p2: number, _: Ice.Current): [number, number, number] {
        return [p2, p1, p2];
    }

    opFloatDoubleS(p1: number[], p2: number[], _: Ice.Current): [number[], number[], number[]] {
        const r = p2.concat(p1);
        const p4 = p2.reverse();
        return [r, p1, p4];
    }

    opFloatDoubleSS(p1: number[][], p2: number[][], _: Ice.Current): [number[][], number[][], number[][]] {
    ...
    opLongFloatD(
        p1: Map<bigint, number>,
        p2: Map<bigint, number>,
        _: Ice.Current,
    ): [Map<bigint, number>, Map<bigint, number>] {
        const r = new Map(p1);
        p2.forEach((value, key) => r.set(key, value));
        return [r, p1];
    }
    ...
    opMyEnum(p1: Test.MyEnum, _: Ice.Current): [Test.MyEnum, Test.MyEnum] {
    ...
    opShortIntLong(p1: number, p2: number, p3: bigint, _: Ice.Current): [bigint, number, number, bigint] {
        return [p3, p1, p2, p3];
    }
    ...
    opString(p1: string, p2: string, _: Ice.Current): [string, string] {
        return [p1 + " " + p2, p2 + " " + p1];
    }
    ...
    opLongLongSD(
        p1: Map<bigint, bigint[]>,
        p2: Map<bigint, bigint[]>,
        _: Ice.Current,
    ...
    opIntS(s: number[], _: Ice.Current): number[] {
        return s.map((v) => -v);
    }

    opByteSOneway(_s: Uint8Array, _: Ice.Current): void {
    ...
    opDoubleMarshaling(p1: number, p2: number[], _: Ice.Current) {
    ...
    opStringS(p1: string[], p2: string[], _: Ice.Current): [string[], string[]] {
        const p3 = p1.concat(p2);
        const r = p1.reverse();
        return [r, p3];
    }

    opStringSS(p1: string[][], p2: string[][], _: Ice.Current): [string[][], string[][]] {
        const p3 = p1.concat(p2);
        const r = p2.reverse();
        return [r, p3];
    }

    opStringSSS(p1: string[][][], p2: string[][][], _: Ice.Current): [string[][][], string[][][]] {
        const p3 = p1.concat(p2);
        const r = p2.reverse();
        return [r, p3];
    }
    ...
    opStruct(p1: Test.Structure, p2: Test.Structure, _: Ice.Current): [Test.Structure, Test.Structure] {
        p1.s.s = "a new string";
        return [p2, p1];
    }
    ...
    opShort1(value: number, _: Ice.Current): number {
        return value;
    }

    opInt1(value: number, _: Ice.Current): number {
        return value;
    }

    opLong1(value: bigint, _: Ice.Current): bigint {
        return value;
    }

    opFloat1(value: number, _: Ice.Current): number {
        return value;
    }

    opDouble1(value: number, _: Ice.Current): number {
        return value;
    }

    opString1(value: string, _: Ice.Current): string {
        return value;
    }

    opStringS1(value: string[], _: Ice.Current): string[] {
        return value;
    }

    opByteBoolD1(value: Map<number, boolean>, _: Ice.Current): Map<number, boolean> {
        return value;
    }

    opStringS2(value: string[], _: Ice.Current): string[] {
        return value;
    }

    opByteBoolD2(value: Map<number, boolean>, _: Ice.Current): Map<number, boolean> {
        return value;
    }
    ...
    opMyStruct1(value: Test.MyStruct1, _: Ice.Current): Test.MyStruct1 {
        return value;
    }

    opStringLiterals(_: Ice.Current): string[] {
        return [
            Test.s0,
            Test.s1,
            Test.s2,
    ...
    opMStruct1(_: Ice.Current): Test.Structure {
        return new Test.Structure();
    }

    opMStruct2(p1: Test.Structure, _: Ice.Current): [Test.Structure, Test.Structure] {
        return [p1, p1];
    }

    opMSeq1(_: Ice.Current): string[] {
        return [];
    }

    opMSeq2(p1: string[], _: Ice.Current): [string[], string[]] {
        return [p1, p1];
    }

    opMDict1(_: Ice.Current): Map<string, string> {
        return new Map();
    }

    opMDict2(p1: Map<string, string>, _: Ice.Current): [Map<string, string>, Map<string, string>] {
        return [p1, p1];
    }
}
