...
export class Client extends TestHelper {
    async allTests() {
        ...
        const ia = (await initial.iaop()) as Test.MA.IAPrx;
        const ib1 = (await initial!.ib1op()) as Test.MB.IB1Prx;
        const ib2 = (await initial!.ib2op()) as Test.MB.IB2Prx;
        const ic = (await initial!.icop()) as Test.MA.ICPrx;
        test(ia != ib1);
        test(ia != ib2);
        test(ia != ic);
        test(ib1 != ic);
