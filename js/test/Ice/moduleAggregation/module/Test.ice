...
module Outer
{
    module Inner
    {
        ...
        module Deep
        {
            // DeepCombined struct uses types from deep nested modules defined in transitive includes
            // (FirstDeep.ice and SecondDeep.ice). This tests that multi-level nested module merging
            // works correctly across transitive includes.
            struct DeepCombined
            {
                DeepFirst deepFirst;
