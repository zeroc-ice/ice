...
(function(module, require, exports)
{
    ...
    async function allTests(communicator, out)
    {
        ...
        let ref20 = "test -e 2.0:default -p 12010";
        ...
        let ref13 = "test -e 1.3:default -p 12010";
        ...
        if(communicator.getProperties().getPropertyAsInt("Ice.IPv6") === 0)
        {
            ...
            */
            ...
            //
            derived = Test.MyDerivedClassPrx.uncheckedCast(communicator.stringToProxy("test -e 1.0:default -p 12010"));
            p2 = await derived.echo(p1);

            pstr = communicator.proxyToString(p2);
            test(pstr === "test -t -e 1.0:ssl -h 127.0.0.1 -p 10001 -t infinite:opaque -t 99 -e 1.0 -v abch");

            let p = communicator.stringToProxy("test:default -p 12010");
