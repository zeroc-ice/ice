...
export class Client extends TestHelper
{
    async allTests()
    {
        ...
        out.write("testing batch requests with communicator... ");
        {
            ...
            await communicator.flushBatchRequests(Ice.CompressBatch.No);
            test(await p.waitForBatch(2));
        }
        ...
        out.write("testing AsyncResult operations... ");
        {
            ...
            p2.ice_ping();
            {
                let r2 = p2.ice_flushBatchRequests();
                test(r2.operation === "ice_flushBatchRequests");
                test(r2.connection === null); // Expected
                test(r2.communicator == communicator);
                test(r2.proxy == p2);
            }
            ...
            p2.ice_ping();
            {
                let r2 = con.flushBatchRequests(Ice.CompressBatch.No);
                test(r2.operation === "flushBatchRequests");
                test(r2.connection == con);
                test(r2.communicator == communicator);
                test(r2.proxy === null);
            }
            ...
            p2.ice_ping();
            {
                let r2 = communicator.flushBatchRequests(Ice.CompressBatch.No);
                test(r2.operation === "flushBatchRequests");
                test(r2.connection === null);
                test(r2.communicator == communicator);
                test(r2.proxy === null);
            }
        }
