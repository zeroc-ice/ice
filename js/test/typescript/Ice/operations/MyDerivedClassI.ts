...
export class MyDerivedClassI extends Test.MyDerivedClass {
    ...
    opFloatDoubleS(p1: Test.FloatS, p2: Test.DoubleS, current: Ice.Current): [Test.DoubleS, Test.FloatS, Test.DoubleS] {
    ...
    opShortIntLong(p1: number, p2: number, p3: Ice.Long, current: Ice.Current): [Ice.Long, number, number, Ice.Long] {
        return [p3, p1, p2, p3];
    }
    ...
    opStringMyEnumD(
        p1: Test.StringMyEnumD,
        p2: Test.StringMyEnumD,
        current: Ice.Current,
    ): [Test.StringMyEnumD, Test.StringMyEnumD] {
        const r = new Map(p1);
        p2.forEach((value, key) => r.set(key, value));
        return [r, p1];
    }
    ...
    opMyEnumStringD(
        ...
        current: Ice.Current,
    ): [Test.MyEnumStringD, Test.MyEnumStringD] {
        const r = new Map(p1);
        p2.forEach((value, key) => r.set(key, value));
        return [r, p1];
    }
    ...
    opMyStructMyEnumD(
        p1: Test.MyStructMyEnumD,
        p2: Test.MyStructMyEnumD,
        current: Ice.Current,
    ): [Test.MyStructMyEnumD, Test.MyStructMyEnumD] {
        const r = new Ice.HashMap(p1);
        p2.forEach((value, key) => r.set(key, value));
        return [r, p1];
    }
    ...
    opLongFloatDS(
        ...
        p2: Test.LongFloatDS,
        current: Ice.Current,
    ): [Test.LongFloatDS, Test.LongFloatDS] {
        const p3 = p2.concat(p1);
        const r = p1.reverse();
        return [r, p3];
    }
    ...
    opStringStringDS(
        ...
        current: Ice.Current,
    ): [Test.StringStringDS, Test.StringStringDS] {
        const p3 = p2.concat(p1);
        const r = p1.reverse();
        return [r, p3];
    }
    ...
    opStringMyEnumDS(
        ...
        current: Ice.Current,
    ): [Test.StringMyEnumDS, Test.StringMyEnumDS] {
        const p3 = p2.concat(p1);
        const r = p1.reverse();
        return [r, p3];
    }
    ...
    opMyEnumStringDS(
        ...
        current: Ice.Current,
    ): [Test.MyEnumStringDS, Test.MyEnumStringDS] {
        const p3 = p2.concat(p1);
        const r = p1.reverse();
        return [r, p3];
    }
    ...
    opMyStructMyEnumDS(
        ...
        current: Ice.Current,
    ): [Test.MyStructMyEnumDS, Test.MyStructMyEnumDS] {
        const p3 = p2.concat(p1);
        const r = p1.reverse();
        return [r, p3];
    }
    ...
    opShortShortSD(
        p1: Test.ShortShortSD,
        p2: Test.ShortShortSD,
        current: Ice.Current,
    ): [Test.ShortShortSD, Test.ShortShortSD] {
        const r = new Map(p1);
        p2.forEach((value, key) => r.set(key, value));
        const p3 = new Map(p2);
        return [r, p3];
    ...
    opStringFloatSD(
        p1: Test.StringFloatSD,
        p2: Test.StringFloatSD,
        current: Ice.Current,
    ): [Test.StringFloatSD, Test.StringFloatSD] {
        const r = new Map(p1);
        p2.forEach((value, key) => r.set(key, value));
        const p3 = new Map(p2);
        return [r, p3];
    ...
    opStringDoubleSD(
        p1: Test.StringDoubleSD,
        p2: Test.StringDoubleSD,
        current: Ice.Current,
    ): [Test.StringDoubleSD, Test.StringDoubleSD] {
        const r = new Map(p1);
        p2.forEach((value, key) => r.set(key, value));
        const p3 = new Map(p2);
        return [r, p3];
    ...
    opStringStringSD(
        p1: Test.StringStringSD,
        p2: Test.StringStringSD,
        current: Ice.Current,
    ): [Test.StringStringSD, Test.StringStringSD] {
        const r = new Map(p1);
        p2.forEach((value, key) => r.set(key, value));
        const p3 = new Map(p2);
        return [r, p3];
    ...
    opMyEnumMyEnumSD(
        p1: Test.MyEnumMyEnumSD,
        p2: Test.MyEnumMyEnumSD,
        current: Ice.Current,
    ): [Test.MyEnumMyEnumSD, Test.MyEnumMyEnumSD] {
        const r = new Map(p1);
        p2.forEach((value, key) => r.set(key, value));
        const p3 = new Map(p2);
        return [r, p3];
    ...
    opStringStringD(
        p1: Test.StringStringD,
        p2: Test.StringStringD,
        current: Ice.Current,
    ): [Test.StringStringD, Test.StringStringD] {
        const r = new Map(p1);
        p2.forEach((value, key) => r.set(key, value));
        return [r, p1];
    }
