...
public class TestFacetI implements TestFacet, java.util.function.Consumer<java.util.Map<String, String>>
{
    ...
    @Override public synchronized java.util.Map<String, String> getChanges(com.zeroc.Ice.Current current)
    {
        return _changes;
    }

    @Override public synchronized void accept(java.util.Map<String, String> changes) { _changes = changes; }
