...
public class Client extends test.TestHelper {
  public void run(String[] argvs) {
    ...
    try {
      ...
      test(
          args.length == 3 && args[0].equals("-a") && args[1].equals("-b") && args[2].equals("-c"));
      args = Options.split("\"-a\" '-b' $'-c'");
      test(
          args.length == 3 && args[0].equals("-a") && args[1].equals("-b") && args[2].equals("-c"));
      args = Options.split("  '-b' \"-a\" $'-c' ");
      test(
          args.length == 3 && args[0].equals("-b") && args[1].equals("-a") && args[2].equals("-c"));
      args = Options.split(" $'-c' '-b' \"-a\"  ");
      test(
          args.length == 3 && args[0].equals("-c") && args[1].equals("-b") && args[2].equals("-a"));
      ...
      test(
          args.length == 1
              && args[0].equals("-Dir=C:\\test\\filewith\"quote")); // -Dir=C:\test\filewith"quote
      ...
      test(args.length == 1 && args[0].equals("-Dir=C:\\test\\file")); // -Dir=C:\test\file
      args =
          Options.split("-Dir=\"C:\\test\\filewith\\\"quote\""); // -Dir="C:\test\filewith\"quote"
      test(
          args.length == 1
              && args[0].equals("-Dir=C:\\test\\filewith\"quote")); // -Dir=C:\test\filewith"quote
      ...
      test(
          args.length == 1
              && args[0].equals("-Dir=C:\\oest\\oilewith\"quote")); // -Dir=C:\oest\oilewith"quote
