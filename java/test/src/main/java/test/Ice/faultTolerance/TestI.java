...
public final class TestI implements TestIntf
{
    ...
    @Override public void abort(com.zeroc.Ice.Current current) { Runtime.getRuntime().halt(0); }

    @Override public void idempotentAbort(com.zeroc.Ice.Current current) { Runtime.getRuntime().halt(0); }

    @Override public int pid(com.zeroc.Ice.Current current) { return _pseudoPid; }
