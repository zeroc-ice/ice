    ...
    out.flush();
    {
      ...
      if (communicator.getProperties().getProperty("Ice.IPv6").equals("1")) {
        ...
        if (System.getProperty("os.name").contains("OS X")
          ...
          endpoint.append(
              " --interface \"::1\""); // Use loopback to prevent other machines to answer.
        }
      } else {
        ...
        if (System.getProperty("os.name").contains("OS X")
            || System.getProperty("os.name").startsWith("Windows")) {
          endpoint.append(
              " --interface 127.0.0.1"); // Use loopback to prevent other machines to answer.
        }
      }
      ...
      while (nRetry-- > 0) {
        ...
        try {
          ...
          if (communicator.getProperties().getProperty("Ice.IPv6").equals("1")) {
            // Multicast IPv6 not supported on the platform. This occurs for example on macOS Big
            // Sur
