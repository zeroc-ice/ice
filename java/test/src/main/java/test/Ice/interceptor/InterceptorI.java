...
{
    InterceptorI(com.zeroc.Ice.Object servant) { _servant = servant; }
    ...
    @Override
    public CompletionStage<OutputStream> dispatch(com.zeroc.Ice.Request request) throws com.zeroc.Ice.UserException
    {
    ...
    boolean getLastStatus() { return _lastStatus; }

    String getLastOperation() { return _lastOperation; }
