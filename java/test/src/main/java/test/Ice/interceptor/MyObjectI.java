...
class MyObjectI implements MyObject {
  ...
  @Override
  public int badAdd(int x, int y, com.zeroc.Ice.Current current) throws InvalidInputException {
  ...
  @Override
  public CompletionStage<Integer> amdAddAsync(
      final int x, final int y, com.zeroc.Ice.Current current) {
  ...
  @Override
  public CompletionStage<Integer> amdAddWithRetryAsync(
      final int x, final int y, com.zeroc.Ice.Current current) {
    String val = current.ctx.get("retry");
