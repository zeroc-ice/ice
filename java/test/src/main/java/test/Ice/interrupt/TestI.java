...
{
    TestI(TestControllerI controller) { _controller = controller; }

    @Override public void op(com.zeroc.Ice.Current current) {}

    @Override public void opIdempotent(com.zeroc.Ice.Current current) { throw new com.zeroc.Ice.UnknownException(); }

    @Override
    public void sleep(int to, com.zeroc.Ice.Current current) throws test.Ice.interrupt.Test.InterruptedException
    {
