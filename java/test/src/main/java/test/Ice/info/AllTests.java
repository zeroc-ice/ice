...
public class AllTests {
  ...
  public static void allTests(test.TestHelper helper) {
    ...
    out.flush();
    {
      ...
      test(
          opaqueEndpoint.rawEncoding.equals(new com.zeroc.Ice.EncodingVersion((byte) 1, (byte) 8)));
    }
    out.println("ok");
    ...
    {
      final String host =
          communicator.getProperties().getPropertyAsInt("Ice.IPv6") != 0 ? "::1" : "127.0.0.1";
      communicator
          .getProperties()
          .setProperty(
    ...
    com.zeroc.Ice.ObjectPrx base =
        communicator.stringToProxy(
            "test:" + helper.getTestEndpoint(0) + ":" + helper.getTestEndpoint(0, "udp"));
