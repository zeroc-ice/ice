...
public class AllTests
{
        ...
        throws UnknownMetricsView
    {
        while(true)
        {
            ...
            boolean ok = true;
            for(com.zeroc.Ice.MX.Metrics m : r.returnValue.get(map))
            {
                if(m.current != value)
                {
                    ok = false;
    ...
    static Map<String, com.zeroc.Ice.MX.Metrics> toMap(com.zeroc.Ice.MX.Metrics[] mmap)
    {
        Map<String, com.zeroc.Ice.MX.Metrics> m = new java.util.HashMap<>();
        for(com.zeroc.Ice.MX.Metrics e : mmap)
        {
            m.put(e.id, e);
        }
        return m;
        ...
        throws UnknownMetricsView
    {
        ...
        Map<String, com.zeroc.Ice.MX.Metrics> map;
