  ...
  static MetricsPrx allTests(test.TestHelper helper, CommunicatorObserverI obsv)
    ...
    if (!collocated) {
      ...
      bs =
          new byte
              [1024 * 1024
                  * 10]; // Try with large amount of data which should be sent in several chunks
      metrics.opByteS(bs);
      ...
      test(
          clientMetrics.getMetricsView("View").returnValue.get("ConnectionEstablishment").length
              == 0);
      ...
      testAttribute(
          clientMetrics, clientProps, "ConnectionEstablishment", "parent", "Communicator", c, out);
      testAttribute(
          clientMetrics, clientProps, "ConnectionEstablishment", "id", hostAndPort, c, out);
      testAttribute(
          clientMetrics,
          clientProps,
          "ConnectionEstablishment",
      ...
      testAttribute(
          clientMetrics, clientProps, "ConnectionEstablishment", "endpointType", type, c, out);
      testAttribute(
          clientMetrics,
          clientProps,
          "ConnectionEstablishment",
      ...
      testAttribute(
          ...
          out);
      testAttribute(
          clientMetrics, clientProps, "ConnectionEstablishment", "endpointHost", host, c, out);
      testAttribute(
          clientMetrics, clientProps, "ConnectionEstablishment", "endpointPort", port, c, out);
      ...
      testAttribute(
          clientMetrics, clientProps, "EndpointLookup", "endpointIsDatagram", "false", c, out);
      testAttribute(
          clientMetrics, clientProps, "EndpointLookup", "endpointIsSecure", isSecure, c, out);
      testAttribute(clientMetrics, clientProps, "EndpointLookup", "endpointTimeout", "500", c, out);
      testAttribute(
          clientMetrics, clientProps, "EndpointLookup", "endpointCompress", "false", c, out);
      testAttribute(
          clientMetrics, clientProps, "EndpointLookup", "endpointHost", "localhost", c, out);
    ...
    if (!collocated) {
      testAttribute(
          serverMetrics, serverProps, "Dispatch", "endpoint", endpoint + " -t 60000", op, out);
