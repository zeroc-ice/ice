...
public class TestI implements TestIntf {
    TestI(
        ...
        _registry.addObject(
                _adapter1.add(new HelloI(), com.zeroc.Ice.Util.stringToIdentity("hello")), null);
    }
    ...
    public HelloPrx getHello(com.zeroc.Ice.Current current) {
        return HelloPrx.uncheckedCast(
                _adapter1.createIndirectProxy(com.zeroc.Ice.Util.stringToIdentity("hello")));
    }

    @Override
    public HelloPrx getReplicatedHello(com.zeroc.Ice.Current current) {
        return HelloPrx.uncheckedCast(
                _adapter1.createProxy(com.zeroc.Ice.Util.stringToIdentity("hello")));
    }
