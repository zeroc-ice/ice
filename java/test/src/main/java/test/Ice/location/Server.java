...
public class Server extends test.TestHelper {
  public void run(String[] args) {
    ...
    try (com.zeroc.Ice.Communicator communicator = initialize(properties)) {
      ...
      registry.addObject(
          adapter.createProxy(com.zeroc.Ice.Util.stringToIdentity("ServerManager")), null);
      ...
      adapter.add(
          new ServerLocator(registry, registryPrx), com.zeroc.Ice.Util.stringToIdentity("locator"));
      adapter.activate();
      serverReady();
