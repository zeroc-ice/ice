...
public class Server extends test.TestHelper
{
    class EchoI implements test.Ice.echo.Test.Echo
    {
        ...
        @Override public void startBatch(com.zeroc.Ice.Current current) { _blob.startBatch(); }

        @Override public void flushBatch(com.zeroc.Ice.Current current) { _blob.flushBatch(); }
