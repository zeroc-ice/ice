...
class TwowaysAMI {
    ...
    static void twowaysAMI(TestHelper helper, MyClassPrx p) {
...

        {
            ...
            Callback cb = new Callback();
            p.opByteBoolLinkedDAsync(di1, di2)
                .whenComplete(
                    (result, ex) -> {
                        test(ex == null);
                        test(result.p3.equals(di1));
...

        {
            ...
            Callback cb = new Callback();
            p.opShortIntLinkedDAsync(di1, di2)
                .whenComplete(
                    (result, ex) -> {
                        test(ex == null);
                        test(result.p3.equals(di1));
...

        {
            ...
            Callback cb = new Callback();
            p.opLongFloatLinkedDAsync(di1, di2)
                .whenComplete(
                    (result, ex) -> {
                        test(ex == null);
                        test(result.p3.equals(di1));
...

        {
            ...
            Callback cb = new Callback();
            p.opStringStringLinkedDAsync(di1, di2)
                .whenComplete(
                    (result, ex) -> {
                        test(ex == null);
                        test(result.p3.equals(di1));
...

        {
            ...
            Callback cb = new Callback();
            p.opStringMyEnumLinkedDAsync(di1, di2)
                .whenComplete(
                    (result, ex) -> {
                        test(ex == null);
                        test(result.p3.equals(di1));
...

        {
            ...
            Callback cb = new Callback();
            p.opMyEnumStringLinkedDAsync(di1, di2)
                .whenComplete(
                    (result, ex) -> {
                        test(ex == null);
                        test(result.p3.equals(di1));
...

        {
            ...
            Callback cb = new Callback();
            p.opMyStructMyEnumLinkedDAsync(di1, di2)
                .whenComplete(
                    (result, ex) -> {
                        test(ex == null);
                        test(result.p3.equals(di1));
