...
{
    public RemoteCommunicatorI(test.TestHelper helper) { _helper = helper; }
    ...
    @Override public void deactivateObjectAdapter(RemoteObjectAdapterPrx adapter, com.zeroc.Ice.Current current)
    {
