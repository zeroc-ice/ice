...
public class AllTests
{
    ...
    {
        LoggerI(java.io.PrintWriter out) { _out = out; }
        ...
        public com.zeroc.Ice.Logger cloneWithPrefix(String prefix) { return this; }
...
catch (Exception ex) { _msg = "unexpected exception:\n" + com.zeroc.IceInternal.Ex.toString(ex); }
}
...
static class InvocationNoHeartbeatTest extends TestCase
{
    ...
    public void runTestCase(RemoteObjectAdapterPrx adapter, TestIntfPrx proxy)
    {
        ...
        catch (com.zeroc.Ice.ConnectionTimeoutException ex)
        {
            ...
            synchronized (this) { test(_heartbeat == 0); }
        }
    }
}
...
static class HeartbeatOnIdleTest extends TestCase
{
    ...
    public void runTestCase(RemoteObjectAdapterPrx adapter, TestIntfPrx proxy)
    {
        ...
        synchronized (this) { test(_heartbeat >= 3); }
    }
}
...
static class SetACMTest extends TestCase
{
    ...
    public void runTestCase(RemoteObjectAdapterPrx adapter, TestIntfPrx proxy)
    {
        ...
        con.setCloseCallback(c -> { f1.complete(null); });
        ...
        con.setCloseCallback(c -> { f2.complete(null); });
        try
        {
            f2.get();
        }
