...
public class AllTests {
  ...
  abstract static class TestCase {
    ...
    public void init() {
      ...
      if (_clientACMTimeout >= 0) {
        initData.properties.setProperty(
            "Ice.ACM.Client.Timeout", Integer.toString(_clientACMTimeout));
      }
      ...
      if (_clientACMHeartbeat >= 0) {
        initData.properties.setProperty(
            "Ice.ACM.Client.Heartbeat", Integer.toString(_clientACMHeartbeat));
      }
    ...
    public void run() {
      TestIntfPrx proxy =
          TestIntfPrx.uncheckedCast(_communicator.stringToProxy(_adapter.getTestIntf().toString()));
  ...
  static class InvocationHeartbeatTest extends TestCase {
    public InvocationHeartbeatTest(
        TestHelper helper, RemoteCommunicatorPrx com, java.io.PrintWriter out) {
  ...
  static class InvocationHeartbeatOnHoldTest extends TestCase {
    public InvocationHeartbeatOnHoldTest(
        TestHelper helper, RemoteCommunicatorPrx com, java.io.PrintWriter out) {
  ...
  static class InvocationNoHeartbeatTest extends TestCase {
    public InvocationNoHeartbeatTest(
        TestHelper helper, RemoteCommunicatorPrx com, java.io.PrintWriter out) {
  ...
  static class InvocationHeartbeatCloseOnIdleTest extends TestCase {
    public InvocationHeartbeatCloseOnIdleTest(
        TestHelper helper, RemoteCommunicatorPrx com, java.io.PrintWriter out) {
  ...
  static class CloseOnIdleAndInvocationTest extends TestCase {
    public CloseOnIdleAndInvocationTest(
        TestHelper helper, RemoteCommunicatorPrx com, java.io.PrintWriter out) {
  ...
  static class ForcefulCloseOnIdleAndInvocationTest extends TestCase {
    public ForcefulCloseOnIdleAndInvocationTest(
        TestHelper helper, RemoteCommunicatorPrx com, java.io.PrintWriter out) {
