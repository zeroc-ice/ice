...
{
    @Override public void print(String message) { _logger.print(message); }

    @Override public void trace(String category, String message) { _logger.trace(category, message); }
    ...
    @Override public com.zeroc.Ice.Logger cloneWithPrefix(String prefix) { return new DummyLogger(); }
