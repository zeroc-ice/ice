...
{
    @Override synchronized public void pauseCall(String opName, com.zeroc.Ice.Current current)
    {
        _pausedCalls.add(opName);
    }

    @Override synchronized public void resumeCall(String opName, com.zeroc.Ice.Current current)
    {
    ...
    @Override public void initializeSocketStatus(int status, com.zeroc.Ice.Current current)
    {
        _configuration.initializeSocketStatus(status);
    }

    @Override public void initializeException(boolean enable, com.zeroc.Ice.Current current)
    {
        _configuration.initializeException(enable ? new com.zeroc.Ice.SocketException() : null);
    }

    @Override public void readReady(boolean enable, com.zeroc.Ice.Current current) { _configuration.readReady(enable); }

    @Override public void readException(boolean enable, com.zeroc.Ice.Current current)
    {
        _configuration.readException(enable ? new com.zeroc.Ice.SocketException() : null);
    }

    @Override public void writeReady(boolean enable, com.zeroc.Ice.Current current)
    {
        _configuration.writeReady(enable);
    }

    @Override public void writeException(boolean enable, com.zeroc.Ice.Current current)
    {
        _configuration.writeException(enable ? new com.zeroc.Ice.SocketException() : null);
    }

    @Override public void buffered(boolean enable, com.zeroc.Ice.Current current) { _configuration.buffered(enable); }
