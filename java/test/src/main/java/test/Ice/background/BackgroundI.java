...
{
    @Override public void op(com.zeroc.Ice.Current current) { _controller.checkCallPause(current); }
    ...
    BackgroundI(BackgroundControllerI controller) { _controller = controller; }
