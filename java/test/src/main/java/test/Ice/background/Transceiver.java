...
{
    @Override public java.nio.channels.SelectableChannel fd() { return _transceiver.fd(); }
    ...
    @Override public void close() { _transceiver.close(); }

    @Override public com.zeroc.IceInternal.EndpointI bind() { return _transceiver.bind(); }
    ...
    @Override public String protocol() { return "test-" + _transceiver.protocol(); }

    @Override public String toString() { return _transceiver.toString(); }

    @Override public String toDetailedString() { return _transceiver.toDetailedString(); }

    @Override public com.zeroc.Ice.ConnectionInfo getInfo() { return _transceiver.getInfo(); }

    @Override public void checkSendSize(com.zeroc.IceInternal.Buffer buf) { _transceiver.checkSendSize(buf); }

    @Override public void setBufferSize(int rcvSize, int sndSize) { _transceiver.setBufferSize(rcvSize, sndSize); }

    public com.zeroc.IceInternal.Transceiver delegate() { return _transceiver; }
