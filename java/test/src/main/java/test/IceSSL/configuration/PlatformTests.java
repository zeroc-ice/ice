...
public class PlatformTests {
  ...
  public static void serverValidatesClientUsingTrustStore(
    ...
    try {
      ...
      try (var serverCommunicator = createServer(helper, serverCertificatePath, trustedStorePath)) {
        try (var clientCommunicator =
  ...
  public static void serverHotCertificateReload(TestHelper helper, String certificatesPath) {
    ...
    try (var serverCommunicator = com.zeroc.Ice.Util.initialize()) {
      ...
      adapter.add(new ServerI(serverCommunicator), com.zeroc.Ice.Util.stringToIdentity("server"));
      adapter.activate();
