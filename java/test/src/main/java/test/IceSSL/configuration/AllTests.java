...
public class AllTests {
    ...
    public static ServerFactoryPrx allTests(TestHelper helper, String defaultDir, String keystoreType) {
        ...
        // encoded before it is fed to the PKCS12 key derivation function: "password_less" uses the two 0x00 bytes
        // of RFC 7292 appendix B.1, "null_password" the zero-length block of appendix B.2 step 3. Java accepts
        // both. See certs/README.md. JKS keystores cannot be password-less: keytool requires at least six
        // characters.
