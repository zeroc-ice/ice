...
public class Client extends test.TestHelper
{
    ...
    public void run(String[] args)
    {
        ...
        initData.dispatcher = (Runnable runnable, com.zeroc.Ice.Connection c) -> { _workQueue.submit(runnable); };
        ...
        try (com.zeroc.Ice.Communicator communicator = initialize(initData))
        {
            ...
            _factory = new com.zeroc.Glacier2.SessionFactoryHelper(initData, new com.zeroc.Glacier2.SessionCallback() {
                ...
                @Override public void disconnected(com.zeroc.Glacier2.SessionHelper session) { test(false); }

                @Override public void connectFailed(com.zeroc.Glacier2.SessionHelper session, Throwable exception)
                {
                    try
                    {
                        throw exception;
                ...
                @Override public void createdCommunicator(com.zeroc.Glacier2.SessionHelper session)
                {
            ...
            _factory = new com.zeroc.Glacier2.SessionFactoryHelper(initData, new com.zeroc.Glacier2.SessionCallback() {
                ...
                @Override public void disconnected(com.zeroc.Glacier2.SessionHelper session)
                {
                    out.println("ok");
                    synchronized (test.Glacier2.sessionHelper.Client.this)
                    {
                ...
                @Override public void connectFailed(com.zeroc.Glacier2.SessionHelper session, Throwable ex)
                {
                    test(false);
                }
    ...
    public static void wakeUp() { me.notify(); }
