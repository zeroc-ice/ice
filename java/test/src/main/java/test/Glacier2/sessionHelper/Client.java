...
public class Client extends test.TestHelper {
    ...
    public void run(String[] args) {
        ...
        try (com.zeroc.Ice.Communicator communicator = initialize(initData)) {
            ...
            _factory =
                    new com.zeroc.Glacier2.SessionFactoryHelper(
                            initData,
                            new com.zeroc.Glacier2.SessionCallback() {
                                @Override
                                ...
                                public void connectFailed(
                                        com.zeroc.Glacier2.SessionHelper session,
                                        Throwable exception) {
                                    try {
                                        throw exception;
                                ...
                                @Override
                                public void createdCommunicator(
                                        com.zeroc.Glacier2.SessionHelper session) {
            ...
            _factory =
                    new com.zeroc.Glacier2.SessionFactoryHelper(
                            ...
                            new com.zeroc.Glacier2.SessionCallback() {
                                ...
                                @Override
                                public void connectFailed(
                                        com.zeroc.Glacier2.SessionHelper session, Throwable ex) {
                                    test(false);
                                }
            ...
            synchronized (this) {
                ...
                com.zeroc.Ice.ObjectPrx base =
                        _session.communicator().stringToProxy("callback:" + getTestEndpoint(0));
                out.println("ok");
