...
TestUtil.clientServerTest(server="test.Ice.exceptions.AMDServer", additionalClientOptions="--Ice.Default.SlicedFormat", additionalServerOptions="--Ice.Default.SlicedFormat")
print("Running test with 1.0 encoding and AMD server.")
TestUtil.clientServerTest(server="test.Ice.exceptions.AMDServer", additionalClientOptions="--Ice.Default.EncodingVersion=1.0", additionalServerOptions="--Ice.Default.EncodingVersion=1.0")
