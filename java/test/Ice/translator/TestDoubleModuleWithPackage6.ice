...
const M2::dmwpEnum dmwpTest6Constant = M2::dmwpE1;
...
sequence<M2::dmwpStruct> dmwpTest6StructSeq;

dictionary<M2::dmwpStruct, M2::dmwpBaseClass> dmwpTest6StructClassSeq;

interface dmwpTest6Interface extends M2::dmwpInterface {};

exception dmwpTest6Exception extends M2::dmwpException
{
    M2::dmwpEnum e1;
    M2::dmwpStruct s1;
...
class dmwpTest6Class extends M2::dmwpBaseClass implements M2::dmwpBaseInterface
{
    M2::dmwpStruct
    dmwpTest6Op1(M2::dmwpEnum i1,
                 M2::dmwpStruct i2,
                 M2::dmwpStructSeq i3,
