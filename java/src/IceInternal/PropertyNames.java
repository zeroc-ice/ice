...
public final class PropertyNames
{
    ...
    {
        new Property("IceMX\\.MetricsView\\.[^\\s]+\\.GroupBy", false, null),
        new Property("IceMX\\.MetricsView\\.[^\\s]+\\.Reaper", false, null),
        new Property("IceMX\\.MetricsView\\.[^\\s]+\\.Accept", false, null),
        new Property("IceMX\\.MetricsView\\.[^\\s]+\\.Reject", false, null),
        new Property("IceMX\\.MetricsView\\.[^\\s]+", false, null),
        null
    };
