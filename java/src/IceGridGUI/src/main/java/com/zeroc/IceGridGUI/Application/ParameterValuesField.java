...
//
@SuppressWarnings("unchecked") public class ParameterValuesField extends JTable
{
    ...
    public void
    set(java.util.List<String> names,
        ...
        final Utils.Resolver resolver)
    {
        ...
        _model.addTableModelListener(new TableModelListener() {
            @Override public void tableChanged(TableModelEvent e) { _editor.updated(); }
        });
        setModel(_model);
