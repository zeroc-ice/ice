...
public class Server extends Communicator {
  ...
  void removeCallbacks() {
    if (_serviceObserver != null) {
      getCoordinator()
          .removeCallback(_serviceObserver.ice_getIdentity().name, _serviceObserver.ice_getFacet());
  ...
  void rebuild(
    ...
    if (variablesChanged
      ...
      if (_instanceDescriptor != null) {
        ...
        _resolver.reset(
            resolver, _instanceDescriptor.parameterValues, templateDescriptor.parameterDefaults);
              ...
              com.zeroc.IceBox.ServiceObserver servant =
                  new com.zeroc.IceBox.ServiceObserver() {
                    ...
                    public void servicesStarted(
                        final String[] services, com.zeroc.Ice.Current current) {
  ...
  private void createAdapters() {
    for (AdapterDescriptor p : _serverDescriptor.adapters) {
      ...
      insertSortedChild(
          new Adapter(this, adapterName, _resolver, adapterId, p, proxy), _adapters, null);
    }
  }
  ...
  private void createService(ServiceInstanceDescriptor descriptor) {
    ...
    if (descriptor.template.length() > 0) {
      ...
      serviceResolver =
          new Utils.Resolver(
              _resolver, descriptor.parameterValues, templateDescriptor.parameterDefaults);
