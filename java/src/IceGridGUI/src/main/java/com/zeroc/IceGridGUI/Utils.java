...
public class Utils {
  ...
  public static void storeWindowBounds(java.awt.Window window, java.util.prefs.Preferences prefs) {
  ...
  public static java.util.prefs.Preferences restoreWindowBounds(
    ...
    if (prefs != null) {
      ...
      locationVisible =
          visibleBounds.contains(x, y) || (maximized && visibleBounds.contains(x + 20, y + 20));
