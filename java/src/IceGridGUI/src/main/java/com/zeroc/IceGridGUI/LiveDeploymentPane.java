...
public class LiveDeploymentPane extends JSplitPane implements Tab
{
    ...
    @Override public void save() { assert false; }

    @Override public void saveToRegistry(boolean restart) { assert false; }

    @Override public void saveToFile() { assert false; }

    @Override public void discardUpdates() { assert false; }
