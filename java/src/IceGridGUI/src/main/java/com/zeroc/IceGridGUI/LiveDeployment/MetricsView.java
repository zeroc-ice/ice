...
class MetricsView extends TreeNode {
  ...
  MetricsView(
      TreeNode parent, String name, com.zeroc.Ice.IceMX.MetricsAdminPrx admin, boolean enabled) {
    super(parent, name);
    _name = name;
    _admin = admin;
                  ...
                  if (ex == null) {
                    SwingUtilities.invokeLater(
                        () -> {
                          ...
                          if (getRoot().getTree().getLastSelectedPathComponent()
                              == MetricsView.this) {
                            //
                        ...
                        () -> {
                          if (ex instanceof com.zeroc.Ice.ObjectNotExistException
                            ...
                            // Server is down.
                              ...
                              instanceof com.zeroc.Ice.CommunicatorDestroyedException)) {
                            ex.printStackTrace();
