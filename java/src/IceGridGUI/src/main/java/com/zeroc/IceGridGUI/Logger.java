...
public class Logger extends com.zeroc.Ice.LoggerI
{
    ...
    @Override public void warning(final String message)
    {
        //
        ...
        SwingUtilities.invokeLater(() -> {
            JOptionPane
                .showMessageDialog(_mainFrame, message, "Warning - IceGrid GUI Logger", JOptionPane.WARNING_MESSAGE);
        });
    }
    ...
    {
        SwingUtilities.invokeLater(() -> {
            JOptionPane.showMessageDialog(_mainFrame, message, "Error - IceGrid GUI Logger", JOptionPane.ERROR_MESSAGE);
        });
    }
