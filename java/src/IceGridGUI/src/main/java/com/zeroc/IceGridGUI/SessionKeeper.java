...
@SuppressWarnings("unchecked") public class SessionKeeper
{
    //
    ...
    private class Session
    {
            ...
            throws java.lang.Throwable
        {
            ...
            if (acmTimeout > 0)
            {
                ...
                _session.ice_getConnection().setCloseCallback(con -> {
                    ...
                    {
                        SwingUtilities.invokeLater(() -> { sessionLost(); });
                    }
                });
            }
        }
        ...
        AdminSessionPrx getSession() { return _session; }

        AdminPrx getAdmin() { return _admin; }

        String getServerAdminCategory() { return _serverAdminCategory; }
        ...
        AdminPrx getRoutedAdmin()
        {
            ...
            if (_routedAdmin == null)
            {
                ...
                //
                com.zeroc.Ice.ObjectAdapter adminRouterAdapter =
                    _coordinator.getCommunicator().createObjectAdapterWithEndpoints(
                        "IceGrid.AdminRouter",
                        "tcp -h localhost");
        ...
        public void registerObservers() throws java.lang.Throwable
        {
            ...
            else
            {
                com.zeroc.Glacier2.RouterPrx router =
                    com.zeroc.Glacier2.RouterPrx.uncheckedCast(_coordinator.getCommunicator().getDefaultRouter());
                ...
                try
                {
                    SwingUtilities.invokeAndWait(() -> {
                        ApplicationObserverI applicationObserverServant =
                            new ApplicationObserverI(_admin.ice_getIdentity().category, _coordinator);

                        ApplicationObserverPrx applicationObserver = ApplicationObserverPrx.uncheckedCast(
                            _adapter.add(applicationObserverServant, _applicationObserverIdentity));

                        AdapterObserverPrx adapterObserver = AdapterObserverPrx.uncheckedCast(
                            _adapter.add(new AdapterObserverI(_coordinator), _adapterObserverIdentity));

                        ObjectObserverPrx objectObserver = ObjectObserverPrx.uncheckedCast(
                            _adapter.add(new ObjectObserverI(_coordinator), _objectObserverIdentity));

                        RegistryObserverPrx registryObserver = RegistryObserverPrx.uncheckedCast(
                            _adapter.add(new RegistryObserverI(_coordinator), _registryObserverIdentity));

                        NodeObserverPrx nodeObserver = NodeObserverPrx.uncheckedCast(
    ...
    public class ConnectionInfo implements Comparable<ConnectionInfo>
    {
        ...
        @Override public int compareTo(ConnectionInfo other) { return _instanceName.compareTo(other._instanceName); }
        ...
        public synchronized String getUUID() { return _uuid; }

        public synchronized void setUUID(String uuid) { this._uuid = uuid; }

        public synchronized String getInstanceName() { return _instanceName; }
        ...
        public synchronized boolean getDefaultEndpoint() { return _defaultEndpoint; }
        ...
        public synchronized boolean getCustomEndpoint() { return _customEndpoint; }
        ...
        public synchronized void setDefaultPort(boolean value) { _defaultPort = value; }

        public synchronized boolean getDefaultPort() { return _defaultPort; }
        ...
        public synchronized boolean getSSL() { return _ssl; }
        ...
        public synchronized void setAuth(AuthType value) { _auth = value; }

        public synchronized AuthType getAuth() { return _auth; }

        public synchronized boolean getDirect() { return _direct; }

        public synchronized void setDirect(boolean direct) { _direct = direct; }

        public synchronized void setConnectToMaster(boolean connectToMaster) { _connectToMaster = connectToMaster; }

        public synchronized boolean getConnectToMaster() { return _connectToMaster; }
        ...
        public boolean getUseX509Certificate() { return _useX509Certificate; }

        public synchronized String getUsername() { return _username; }

        public synchronized void setUsername(String username) { _username = username == null ? null : username.trim(); }

        public synchronized char[] getPassword() { return _password; }

        public synchronized void setPassword(char[] password) { _password = password; }

        private synchronized boolean getStorePassword() { return _storePassword; }

        private synchronized void setStorePassword(boolean value) { _storePassword = value; }

        public synchronized String getAlias() { return _alias; }

        public synchronized void setAlias(String alias) { _alias = alias; }

        private synchronized boolean getStoreKeyPassword() { return _storeKeyPassword; }

        private synchronized void setStoreKeyPassword(boolean value) { _storeKeyPassword = value; }

        public synchronized void setKeyPassword(char[] password) { _keyPassword = password; }

        public synchronized char[] getKeyPassword() { return _keyPassword; }

        public synchronized boolean isDefault() { return _isDefault; }
    ...
    {
        public FocusListener(javax.swing.text.JTextComponent field) { _field = field; }
    ...
    private class ConnectionWizardDialog extends JDialog
    {
        ...
        public void refreshDiscoveryLocators()
        {
            ...
            SwingUtilities.invokeLater(() -> {
                ...
                if (_directDiscoveryLocatorModel.size() > 0 && _directDiscoveryLocatorList.getSelectedIndex() == -1)
                {
...
private void
initialize(String title, final JDialog parent)
{
    setTitle(title);
    ...
    // Connection type panel
    {
        ...
        _directConnection = new JRadioButton(new AbstractAction("Direct Connection") {
            @Override public void actionPerformed(ActionEvent e) { validatePanel(); }
        });
    ...
    // Direct Discovery Locator List
    {
        ...
        _directDiscoveryLocatorList.addMouseListener(new MouseAdapter() {
        ...
        _directDiscoveryLocatorList.addListSelectionListener(new ListSelectionListener() {
            @Override public void valueChanged(ListSelectionEvent event) { validatePanel(); }
        });
        ...
        JPanel discoveryStatus;
        {
            ...
            _discoveryRefresh = new JButton(new AbstractAction("Refresh") {
                @Override public void actionPerformed(ActionEvent e) { refreshDiscoveryLocators(); }
            });
    ...
    // Direct Endpoint panel
    {
        ...
        ButtonGroup group = new ButtonGroup();
        _directDefaultEndpoints = new JRadioButton(new AbstractAction("A hostname and a port number?") {
            @Override public void actionPerformed(ActionEvent e) { validatePanel(); }
        });
    ...
    // Routed Endpoint panel
    {
        ...
        _routedDefaultEndpoints = new JRadioButton(new AbstractAction("A hostname and a port number?") {
            @Override public void actionPerformed(ActionEvent e) { validatePanel(); }
        });
    ...
    // Direct Custom Endpoint panel
    {
        ...
        _directCustomEndpointValue.getDocument().addDocumentListener(new DocumentListener() {
            @Override public void changedUpdate(DocumentEvent e) { validatePanel(); }

            @Override public void removeUpdate(DocumentEvent e) { validatePanel(); }

            @Override public void insertUpdate(DocumentEvent e) { validatePanel(); }
        });
    ...
    // X509Certificate panel
    {
        ...
        builder.append(
            new JLabel("<html><b>Do you want to provide an X.509 certificate for SSL authentication?</b></html>"));
    ...
    // Authentication panel
    {
        ...
        _usernamePasswordAuthButton = new JRadioButton(new AbstractAction("Log in with a username and password") {
            @Override public void actionPerformed(ActionEvent e) { validatePanel(); }
        });
        _usernamePasswordAuthButton.setSelected(true);
    ...
    JComponent buttonBar = new ButtonBarBuilder()
                               .addGlue()
...
boolean
validateWizardStep(WizardStep step)
{
    ...
    switch (step)
    {
        ...
        {
            validated =
                _directDefaultEndpointHost.getText() != null && _directDefaultEndpointHost.getText().length() > 0;
            String port = _directDefaultEndpointPort.getText();
        ...
        {
            validated =
                _directCustomEndpointValue.getText() != null && _directCustomEndpointValue.getText().length() > 0;
            break;
        }
        ...
        {
            validated =
                _routedDefaultEndpointHost.getText() != null && _routedDefaultEndpointHost.getText().length() > 0;
            String port = _routedDefaultEndpointPort.getText();
            if (port != null && port.length() > 0)
            {
                try
        ...
        {
            validated =
                _routedCustomEndpointValue.getText() != null && _routedCustomEndpointValue.getText().length() > 0;
            break;
        }
        case DirectX509CredentialsStep:
        {
...
public void
loadCertificateAliases(JComboBox component)
{
...
private boolean
containsSecureEndpoints(String str)
{
    try
    {
...
private class ConnectionDetailDialog extends JDialog
{
    ConnectionDetailDialog(ConnectionInfo inf)
    {
        ...
        JPanel detailsPane = null;
        {
            ...
            {
                builder.append(new JLabel("<html><b>Hostname:</b></html>"), new JLabel(inf.getHost()));

                builder.append(new JLabel("<html><b>Port:</b></html>"), new JLabel(Integer.toString(inf.getPort())));

                if (inf.getSSL())
                {
                    builder.append(new JLabel("<html><b>Protocol:</b></html>"), new JLabel("SSL"));
                }
                else
                {
                    builder.append(new JLabel("<html><b>Protocol:</b></html>"), new JLabel("TCP"));
                }
                ssl = inf.getSSL();
            }
            else
            {
                builder.append(new JLabel("<html><b>Endpoints:</b></html>"), new JLabel(inf.getEndpoint()));
            ...
            {
                builder.append(new JLabel("<html><b>Authentication mode:</b></html>"), new JLabel("SSL Certificate"));
            }
            ...
            if (ssl)
            {
                ...
                {
                    builder.append(new JLabel("<html><b>Use SSL Client Certificate:</b></html>"), new JLabel("No"));
                }
            }
...
private class ConnectionManagerDialog extends JDialog
{
    ConnectionManagerDialog()
    {
        ...
        JPanel connectionActionPanel = null;
        {
            ...
            _setDefaultConnectionButton.addActionListener(new ActionListener() {
                @Override public void actionPerformed(ActionEvent e) { _connectionListModel.setDefault(); }
            });
        ...
        JPanel savedConfigurationsPanel = null;
        {
            ...
            class ConnectionListRenderer extends DefaultListCellRenderer
            {
                ...
                getListCellRendererComponent(JList list, Object value, int index, boolean selected, boolean hasFocus)
                {
                    ...
                    if (value instanceof ConnectionInfo)
                    {
                        ...
                        ImageIcon icon = Utils.getIcon(
                            conn.isDefault() ? "/icons/16x16/default.png" : "/icons/16x16/transparent.png");
            ...
            _connectionList.addMouseListener(new MouseAdapter() {
                @Override public void mouseClicked(MouseEvent e)
                {
                    if (e.getClickCount() == 2 && e.getButton() == MouseEvent.BUTTON1)
                    {
    ...
    void load()
    {
        ...
        {
            JOptionPane
                .showMessageDialog(this, ex.toString(), "Failed to load saved connections", JOptionPane.ERROR_MESSAGE);
        }
    }
...
//
public boolean
checkCertificateRequirePassword(String alias)
{
    try
    {
...
public boolean
checkCertificatePassword(String alias, char[] password)
{
    try
    {
        java.security.KeyStore keyStore = java.security.KeyStore.getInstance("JKS");
...
public class KeyStorePanel extends JPanel
{
    ...
    public KeyStorePanel() throws java.security.KeyStoreException
    {
        ...
        _tableModel = new AbstractTableModel() {
            @Override public String getColumnName(int col) { return columnNames[col].toString(); }
            ...
            AbstractAction importAction = new AbstractAction("Import") {
                @Override public void actionPerformed(ActionEvent e)
                {
                    ...
                    chooser.setFileFilter(new FileFilter() {
                        ...
                        @Override public String getDescription() { return "PKCS12 Files (*.pfx, *.p12)"; }
                    });
                    ...
                    chooser.setFileFilter(new FileFilter() {
                        ...
                        @Override public String getDescription() { return "PEM Files (*.pem, *.crt)"; }
                    });
                    ...
                    chooser.setFileFilter(new FileFilter() {
                        ...
                        @Override public String getDescription() { return "Java Key Store Files (*.jks)"; }
                    });
                    File keyFile = null;
                    if (chooser.showOpenDialog(KeyStorePanel.this) == JFileChooser.APPROVE_OPTION)
                    {
                        ...
                        final boolean pkcs12 =
                            filePath.toUpperCase().endsWith(".PFX") || filePath.toUpperCase().endsWith(".P12");
                        final boolean pem =
                            filePath.toUpperCase().endsWith(".PEM") || filePath.toUpperCase().endsWith(".CRT");
                            ...
                            while (true)
                            {
                                try
                                {
                                    ...
                                    RequestPasswordResult r =
                                        requestPassword("KeyStore Password - IceGrid GUI", "KeyStore password:");
                                    if (r.accepted)
                                    {
                        ...
                        else if (pem)
                        {
                            try
                            {
                                ...
                                while (i.hasNext())
                                {
                                    ...
                                    final String newAlias = JOptionPane.showInputDialog(
                                        KeyStorePanel.this,
                                        "Certificate Alias",
                                        "Certificate Alias",
        ...
        JComponent buttonBar =
            new ButtonBarBuilder().addButton(_importButton, _viewButton, _removeButton).addGlue().build();
        buttonBar.setBorder(Borders.DIALOG);
        add(buttonBar);
    }
    ...
    public void importKeyStore(java.security.KeyStore keyStore)
        throws java.security.KeyStoreException, java.security.NoSuchAlgorithmException,
               java.security.UnrecoverableKeyException, java.security.cert.CertificateException,
               java.security.GeneralSecurityException, java.io.FileNotFoundException, java.io.IOException
    {
        for (Enumeration<String> aliases = keyStore.aliases(); aliases.hasMoreElements();)
        {
            ...
            if (keyStore.isKeyEntry(alias))
            {
                ...
                while (true)
                {
                    ...
                    {
                        r = requestPassword(
                            "Certificate Password For <" + alias + "> - IceGrid GUI",
                ...
                {
                    newAlias = JOptionPane.showInputDialog(
                        KeyStorePanel.this,
    ...
    public java.util.Vector<String> aliases() { return _aliases; }
...
getSubjectPanel(X509Certificate cert) throws javax.naming.InvalidNameException
{
    ...
    {
        builder.append(new JLabel("<html><b>Common Name (CN):</b></html>"), new JLabel(details.get("CN").toString()));
    }
    else
    {
    ...
    {
        builder.append(new JLabel("<html><b>Organization (O):</b></html>"), new JLabel(details.get("O").toString()));
    }
    else
    {
    ...
    builder.append(new JLabel("<html><b>Serial Number:</b></html>"), new JLabel(cert.getSerialNumber().toString()));

    return builder.getPanel();
}

public static JPanel
getIssuerPanel(X509Certificate cert) throws javax.naming.InvalidNameException
{
    java.util.HashMap<String, Object> details = new java.util.HashMap<>();
...
public static JPanel
getValidityPanel(X509Certificate cert)
{
    FormLayout layout = new FormLayout("right:pref, 2dlu, left:pref:grow", "pref");
    DefaultFormBuilder builder = new DefaultFormBuilder(layout);
    builder.border(Borders.DIALOG);
...
public static JPanel
getFingerprintPanel(X509Certificate cert) throws java.security.GeneralSecurityException
{
    FormLayout layout = new FormLayout("right:pref, 2dlu, left:pref:grow", "pref");
    DefaultFormBuilder builder = new DefaultFormBuilder(layout);
    builder.border(Borders.DIALOG);
    ...
    builder.append(new JLabel("<html><b>SHA-256 Fingerprint:</b></html>"), new JLabel(sha256Fingerprint));
    builder.nextLine();
...
public static JPanel
getSubjectAlternativeNamesPanel(X509Certificate cert) throws java.security.cert.CertificateParsingException
{
    FormLayout layout = new FormLayout("right:pref, 2dlu, left:pref:grow", "pref");
    DefaultFormBuilder builder = new DefaultFormBuilder(layout);
    builder.border(Borders.DIALOG);
...
public class CertificateManagerDialog extends JDialog
{
    ...
    boolean load()
    {
        try
        {
            ...
            _authorityCertificatesPanel.load(_coordinator.getDataDirectory() + File.separator + "AuthorityCerts.jks");
        }
        catch (java.lang.Exception ex)
        {
    ...
    java.util.Vector<String> myCertsAliases() { return _identityCertificatesPanel.aliases(); }

    void setActiveTab(int index) { _tabs.setSelectedIndex(index); }
...
SessionKeeper(Coordinator coordinator) { _coordinator = coordinator; }
...
certificateManager(Component parent)
{
...
private void
login(final JDialog parent, final ConnectionInfo info)
{
    if (_authDialog != null)
    {
        _authDialog.dispose();
    ...
    if (info.getAuth() == SessionKeeper.AuthType.UsernamePasswordAuthType)
    {
        class UsernamePasswordAuthDialog extends AuthDialog
        {
            UsernamePasswordAuthDialog()
            {
                ...
                JComponent buttonBar =
                    new ButtonBarBuilder().addGlue().addButton(okButton, cancelButton).addGlue().build();
                buttonBar.setBorder(Borders.DIALOG);
                contentPane.add(buttonBar);
    ...
    final ConnectionInfo info)
{
    ...
    {
        JOptionPane.showMessageDialog(parent, ex.toString(), "Error saving connection", JOptionPane.ERROR_MESSAGE);
    }
    ...
    _coordinator.getExecutor().submit(() -> {
        try
        {
            ...
            SwingUtilities.invokeAndWait(() -> { _session = session; });
            try
            {
                ...
                while (true)
                {
                    try
                    {
                        SwingUtilities.invokeAndWait(() -> {
                            ...
                            JOptionPane.showMessageDialog(
                                parent,
                                "Could not register observers: " + e.toString(),
                                "Login failed",
                                JOptionPane.ERROR_MESSAGE);
                        });
                        break;
...
public void
permissionDenied(final JDialog parent, final ConnectionInfo info, final String msg)
{
    if (_authDialog != null)
    {
        _authDialog.dispose();
