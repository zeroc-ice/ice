...
public class SessionKeeper {
    ...
    com.zeroc.Ice.ObjectPrx addCallback(com.zeroc.Ice.Object servant, String name, String facet) {
      if (_adminCallbackCategory == null) {
        ...
        return _adapter.addFacet(
            servant, new com.zeroc.Ice.Identity(name, _adminCallbackCategory), facet);
      }
    }
    ...
    com.zeroc.Ice.Object removeCallback(String name, String facet) {
      if (_adminCallbackCategory == null || _adapter == null) {
        ...
        return _adapter.removeFacet(
            new com.zeroc.Ice.Identity(name, _adminCallbackCategory), facet);
      }
    }
  ...
  public class ConnectionInfo implements Comparable<ConnectionInfo> {
    ...
    public synchronized void load() {
      ...
      if (_prefs
          .get("auth", AuthType.X509CertificateAuthType.toString())
  ...
  private class ConnectionWizardDialog extends JDialog {
                  ...
                  synchronized (SessionKeeper.this) {
                    try {
                      if (_discoveryPlugin == null) {
                        ...
                        _discoveryPlugin =
                            (Plugin) f.create(communicator, "IceGridAdmin.Discovery", null);
                        _discoveryPlugin.initialize();
                      }

                      final List<com.zeroc.Ice.LocatorPrx> locators =
    ...
    private void initialize(String title, final JDialog parent) {
      ...
      // Direct Instance Panel
      {
        ...
        builder.append(
            new JLabel("You need to connect to a Master Registry to change definitions."));
      ...
      // X509Certificate panel
      {
        ...
        builder.append(
            new JLabel(
                "<html><b>Do you want to provide an X.509 certificate for SSL"
                    + " authentication?</b></html>"));
      ...
      // Direct X509 credentials panel
      {
        ...
        JPanel panel;
        {
          ...
          builder.append(
              "", new JLabel("<html><p>Your X.509 certificate for SSL authentication.</p></html>"));
      ...
      // Direct Username password credentials panel
      {
        ...
        _cardPanel.add(
            builder.getPanel(), WizardStep.DirectUsernamePasswordCredentialsStep.toString());
      }
      ...
      // Routed Username password credentials panel
      {
        ...
        _cardPanel.add(
            builder.getPanel(), WizardStep.RoutedUsernamePasswordCredentialsStep.toString());
      }
      ...
      AbstractAction backAction =
          new AbstractAction("< Back") {
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              _cardLayout.show(
                  _cardPanel, _wizardSteps.elementAt(_wizardSteps.size() - 1).toString());
                ...
                case DirectDefaultEndpointStep:
                  {
                    if (_directDefaultEndpointSSL.isSelected()) {
                      ...
                      _cardLayout.show(
                          _cardPanel, WizardStep.DirectUsernamePasswordCredentialsStep.toString());
                ...
                case RoutedDefaultEndpointStep:
                  {
                    if (_routedDefaultEndpointSSL.isSelected()) {
                      ...
                      _cardLayout.show(
                          _cardPanel, WizardStep.RoutedUsernamePasswordCredentialsStep.toString());
                ...
                case X509CertificateStep:
                  {
                    if (_x509CertificateYesButton.isSelected()) {
                      if (_directConnection.isSelected()) {
                        loadCertificateAliases(_directCertificateAliases);
                        _cardLayout.show(
                            _cardPanel, WizardStep.DirectX509CredentialsStep.toString());
                        _wizardSteps.push(WizardStep.DirectX509CredentialsStep);
                      } else {
                        loadCertificateAliases(_routedCertificateAliases);
                        _cardLayout.show(
                            _cardPanel, WizardStep.RoutedX509CredentialsStep.toString());
  ...
  private boolean containsSecureEndpoints(String str) {
    try {
      for (com.zeroc.Ice.Endpoint endpoint :
    ...
    ConnectionDetailDialog(ConnectionInfo inf) {
      ...
      JPanel detailsPane = null;
      {
        ...
        if (inf.getDefaultEndpoint()) {
          ...
          builder.append(
              new JLabel("<html><b>Port:</b></html>"), new JLabel(Integer.toString(inf.getPort())));
          ...
          builder.append(
              new JLabel("<html><b>Endpoints:</b></html>"), new JLabel(inf.getEndpoint()));
        ...
        if (ssl) {
          if (inf.getUseX509Certificate()) {
            builder.append(
                new JLabel("<html><b>Use SSL Client Certificate:</b></html>"), new JLabel("Yes"));
          } else {
            builder.append(
                new JLabel("<html><b>Use SSL Client Certificate:</b></html>"), new JLabel("No"));
          }
        }
  ...
  private class ConnectionManagerDialog extends JDialog {
      ...
      JPanel savedConfigurationsPanel = null;
      {
        ...
        class ConnectionListRenderer extends DefaultListCellRenderer {
          ...
          public Component getListCellRendererComponent(
            ...
            JLabel label =
                (JLabel) super.getListCellRendererComponent(list, value, index, selected, hasFocus);
    ...
    void load() {
      ...
      try {
        ...
        JOptionPane.showMessageDialog(
            this, ex.toString(), "Failed to load saved connections", JOptionPane.ERROR_MESSAGE);
      }
    }
  ...
  public boolean checkCertificateRequirePassword(String alias) {
    try {
      ...
      keyStore.load(
          new FileInputStream(_coordinator.getDataDirectory() + File.separator + "MyCerts.jks"),
          null);
                ...
                chooser.setFileFilter(
                    new FileFilter() {
                      ...
                      public boolean accept(File f) {
                        ...
                        if (f != null
                            && (f.getName().toUpperCase().endsWith(".PFX")
                ...
                chooser.setFileFilter(
                    new FileFilter() {
                      ...
                      public boolean accept(File f) {
                        ...
                        if (f != null
                            && (f.getName().toUpperCase().endsWith(".PEM")
                    ...
                    while (true) {
                      try {
                        ...
                        RequestPasswordResult r =
                            requestPassword(
                                "KeyStore Password - IceGrid GUI", "KeyStore password:");
                        if (r.accepted) {
  ...
  public static JPanel getValidityPanel(X509Certificate cert) {
    ...
    builder.nextLine();
    builder.append(
        new JLabel("<html><b>Issued On:</b></html>"), new JLabel(cert.getNotBefore().toString()));
    builder.append(
        new JLabel("<html><b>Expires On:</b></html>"), new JLabel(cert.getNotAfter().toString()));
    builder.nextLine();
  ...
  public static JPanel getFingerprintPanel(X509Certificate cert)
    ...
    builder.append(
        new JLabel("<html><b>SHA-256 Fingerprint:</b></html>"), new JLabel(sha256Fingerprint));
    builder.nextLine();
            ...
            () -> {
              try {
                final Session session =
                    new Session(adminSession, acmTimeout, !info.getDirect(), parent);
                SwingUtilities.invokeAndWait(
                    () -> {
                      _session = session;
                    });
