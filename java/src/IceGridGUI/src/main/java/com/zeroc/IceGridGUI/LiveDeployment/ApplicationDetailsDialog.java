...
class ApplicationDetailsDialog extends JDialog {
  ...
  void showDialog(ApplicationInfo info) {
    ...
    _createTime.setText(
        java.text.DateFormat.getDateTimeInstance().format(new java.util.Date(info.createTime)));
    _createUser.setText(info.createUser);
    _updateTime.setText(
        java.text.DateFormat.getDateTimeInstance().format(new java.util.Date(info.updateTime)));
