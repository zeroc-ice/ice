...
class RegistryObserverI implements RegistryObserver
{
    ...
    @Override public void registryInit(final RegistryInfo[] registryInfos, com.zeroc.Ice.Current current)
    {
        if (_trace)
        {
            ...
            else
            {
                ...
                _coordinator.traceObserver(
                    "registryInit for registr" + (registryInfos.length == 1 ? "y" : "ies") + names);
            }
        }
    ...
    @Override public void registryUp(final RegistryInfo registryInfo, com.zeroc.Ice.Current current)
    {
        if (_trace)
        {
    ...
    @Override public void registryDown(final String registryName, com.zeroc.Ice.Current current)
    {
        if (_trace)
        {
