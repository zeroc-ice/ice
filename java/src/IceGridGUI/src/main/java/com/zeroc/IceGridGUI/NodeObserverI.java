...
class NodeObserverI implements NodeObserver {
  ...
  public void updateServer(
      final String node, final ServerDynamicInfo updatedInfo, com.zeroc.Ice.Current current) {
    if (_trace) {
  ...
  public void updateAdapter(
      final String node, final AdapterDynamicInfo updatedInfo, com.zeroc.Ice.Current current) {
    if (_trace) {
      _coordinator.traceObserver(
