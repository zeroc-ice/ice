...
class AdminRouter implements com.zeroc.Ice.Blobject
{
    @Override public com.zeroc.Ice.Object.Ice_invokeResult ice_invoke(byte[] inParams, com.zeroc.Ice.Current current)
    {
        if (_admin == null)
        {
            ...
            current.operation.equals("ice_id") || current.operation.equals("ice_ids") ||
            current.operation.equals("ice_isA") || current.operation.equals("ice_ping") ||
    ...
    AdminRouter(AdminPrx admin) { _admin = admin; }
