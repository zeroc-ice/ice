    ...
    WriteMessageDialog(final Root root)
    {
        ...
        ActionListener okListener = new ActionListener() {
            @Override public void actionPerformed(ActionEvent e)
            {
                ...
                {
                    com.zeroc.Ice.Identity adminId = new com.zeroc.Ice.Identity(_target, c.getServerAdminCategory());

                    final com.zeroc.Ice.ProcessPrx process =
                        com.zeroc.Ice.ProcessPrx.uncheckedCast(admin.ice_identity(adminId).ice_facet("Process"));
