  ...
  public void paste() {
    ...
    if (descriptor instanceof Adapter.AdapterCopy) {
      ...
      _adapters.newAdapter(
          Adapter.copyDescriptor(copy.descriptor), new java.util.HashMap<>(copy.parentProperties));
  ...
  class Adapters extends ChildList<AdapterDescriptor> {
    ...
    */
    ...
    private void newAdapter(
        AdapterDescriptor descriptor, java.util.Map<String, String> parentProperties) {
      ...
      Adapter adapter =
          new Adapter(Communicator.this, descriptor.name, descriptor, parentProperties, true);
      try {
    ...
    TreeNode createChild(ServiceInstanceDescriptor descriptor) throws UpdateFailedException {
      ...
      if (descriptor.descriptor == null) {
        ...
        if (Communicator.this instanceof PlainServer) {
          ...
          serviceResolver =
              new Utils.Resolver(
                  getResolver(), descriptor.parameterValues, templateDescriptor.parameterDefaults);
        ...
        if (t == null) {
          if (getRoot().getServiceTemplates().getChildCount() == 0) {
            JOptionPane.showMessageDialog(
                ...
                "You need to create a service template before you can create a service from a"
                    + " template.",
                "No Service Template",
