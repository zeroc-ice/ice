...
public class GraphView extends JFrame implements MetricsFieldContext, Coordinator.IGraphView {
  ...
  private void storePreferences() {
    ...
    for (int i = _columnNames.length - 1; i >= 0; --i) {
      ...
      preferences.putInt(
          "colWidth" + Integer.toString(i), _legendTable.getColumnModel().getColumn(i).getWidth());
    }
                ...
                if (metrics == null) {
                  ...
                  try {
                    ...
                    row.series
                        .peek()
                        .getData()
                        .add(new XYChart.Data<Number, Number>(timestamp, value));
  ...
  static class DecimalRenderer extends DefaultListCellRenderer {
    ...
    public Component getListCellRendererComponent(
      ...
      Component c =
          _renderer.getListCellRendererComponent(list, value, index, isSelected, cellHasFocus);
