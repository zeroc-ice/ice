...
public class GraphView extends JFrame implements MetricsFieldContext, Coordinator.IGraphView
{
    ...
    private void addData(final MetricsViewInfo info, final Map<String, com.zeroc.Ice.IceMX.Metrics[]> data,
                        ...
                        for(Map.Entry<String, MetricsRow> k : j.getValue().entrySet())
                        {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    // this is usually because it needs two values to calculate the average.
                                    if(value == null)
                                    {
                                        continue;
                                    }
