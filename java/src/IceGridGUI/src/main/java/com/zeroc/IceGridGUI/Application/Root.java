    ...
    if (_file == null && !_live) {
      int confirm =
          JOptionPane.showConfirmDialog(
              ...
              "You are about to remove application '" + _id + "'. " + "Do you want to proceed?",
              "Remove Confirmation",
        ...
        new Runnable() {
          ...
          private void handleFailure(String prefix, String title, String message) {
            ...
            if (isSelected()) {
              _coordinator
                  .getSaveAction()
                  .setEnabled(isLive() && _coordinator.connectedToMaster() || hasFile());
            ...
            JOptionPane.showMessageDialog(
                _coordinator.getMainFrame(), message, title, JOptionPane.ERROR_MESSAGE);
          }
                ...
                if (updateDescriptor != null) {
                  ...
                  if (restart) {
                    ...
                    r =
                        _coordinator
                            .getAdmin()
                            .updateApplicationWithoutRestartAsync(updateDescriptor);
                  }
                        ...
                        if (ex == null) {
                          ...
                          SwingUtilities.invokeLater(
                              () -> {
                                ...
                                if (ex instanceof com.zeroc.Ice.UserException) {
                                  handleFailure(
                                      prefix, "Sync failed", "IceGrid exception: " + ex.toString());
                                } else {
                                  handleFailure(
                                      prefix,
                                      "Sync failed",
  ...
  public boolean update(ApplicationUpdateDescriptor desc) {
    ...
    try {
      ...
      _serverTemplates.update(
          desc.serverTemplates, desc.removeServerTemplates, desc.serviceTemplates.keySet());
