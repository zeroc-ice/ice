...
public class Root extends ListTreeNode {
    ...
    // Called when a server-template is deleted, to remove all corresponding instances.
    void removeServerInstances(String templateId) {
        _nodes.removeServerInstances(templateId);
    }

    // Called when a service-template is deleted, to remove all corresponding instances.
