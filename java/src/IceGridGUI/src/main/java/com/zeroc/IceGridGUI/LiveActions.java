...
public class LiveActions
{
    class SendSignal extends AbstractAction
    {
        ...
        @Override public void actionPerformed(ActionEvent e) { _target.signal(_name); }
    ...
    LiveActions()
    {
        _array[TreeNode.START] = new AbstractAction("Start", Utils.getIcon("/icons/16x16/start.png")) {
            @Override public void actionPerformed(ActionEvent e) { _target.start(); }
        };
        ...
        _array[TreeNode.STOP] = new AbstractAction("Stop", Utils.getIcon("/icons/16x16/stop.png")) {
            @Override public void actionPerformed(ActionEvent e) { _target.stop(); }
        };
        ...
        _array[TreeNode.ENABLE] = new AbstractAction("Enable", Utils.getIcon("/icons/16x16/enable.png")) {
            @Override public void actionPerformed(ActionEvent e) { _target.enable(); }
        };
        ...
        _array[TreeNode.DISABLE] = new AbstractAction("Disable", Utils.getIcon("/icons/16x16/disable.png")) {
            @Override public void actionPerformed(ActionEvent e) { _target.disable(); }
        };
        ...
        _array[TreeNode.WRITE_MESSAGE] = new AbstractAction("Write Message") {
            @Override public void actionPerformed(ActionEvent e) { _target.writeMessage(); }
        };
        ...
        _array[TreeNode.RETRIEVE_ICE_LOG] = new AbstractAction("Retrieve Ice log") {
            @Override public void actionPerformed(ActionEvent e) { _target.retrieveIceLog(); }
        };
        ...
        _array[TreeNode.RETRIEVE_STDOUT] = new AbstractAction("Retrieve stdout") {
            @Override public void actionPerformed(ActionEvent e) { _target.retrieveOutput(true); }
        };
        ...
        _array[TreeNode.RETRIEVE_STDERR] = new AbstractAction("Retrieve stderr") {
            @Override public void actionPerformed(ActionEvent e) { _target.retrieveOutput(false); }
        };
        ...
        _array[TreeNode.RETRIEVE_LOG_FILE] = new AbstractAction("Retrieve log file") {
            @Override public void actionPerformed(ActionEvent e) { _target.retrieveLogFile(); }
        };
        ...
        _array[TreeNode.SHUTDOWN_NODE] = new AbstractAction("Shutdown") {
            @Override public void actionPerformed(ActionEvent e) { _target.shutdownNode(); }
        };

        _array[TreeNode.SHUTDOWN_REGISTRY] = new AbstractAction("Shutdown") {
            @Override public void actionPerformed(ActionEvent e) { _target.shutdownRegistry(); }
        };

        _array[TreeNode.PATCH_SERVER] = new AbstractAction("Patch Distribution") {
            @Override public void actionPerformed(ActionEvent e) { _target.patchServer(); }
        };

        _array[TreeNode.ADD_OBJECT] = new AbstractAction("Add Well-known Object") {
            @Override public void actionPerformed(ActionEvent e) { _target.addObject(); }
        };

        _array[TreeNode.OPEN_DEFINITION] = new AbstractAction("Open Definition") {
            @Override public void actionPerformed(ActionEvent e) { _target.openDefinition(); }
        };

        _array[TreeNode.ENABLE_METRICS_VIEW] = new AbstractAction("Enable Metrics View") {
            @Override public void actionPerformed(ActionEvent e) { _target.enableMetricsView(true); }
        };

        _array[TreeNode.DISABLE_METRICS_VIEW] = new AbstractAction("Disable Metrics View") {
            @Override public void actionPerformed(ActionEvent e) { _target.enableMetricsView(false); }
        };

        _array[TreeNode.START_ALL_SERVERS] = new AbstractAction("Start All Servers") {
            @Override public void actionPerformed(ActionEvent e) { _target.startAllServers(); }
        };

        _array[TreeNode.STOP_ALL_SERVERS] = new AbstractAction("Stop All Servers") {
            @Override public void actionPerformed(ActionEvent e) { _target.stopAllServers(); }
        };
    }
