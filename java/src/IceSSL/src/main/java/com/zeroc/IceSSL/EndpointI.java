...
final class EndpointI extends com.zeroc.IceInternal.EndpointI
{
    ...
    @Override public void streamWriteImpl(com.zeroc.Ice.OutputStream s) { _delegate.streamWriteImpl(s); }
    ...
    //
    @Override public com.zeroc.IceInternal.Transceiver transceiver() { return null; }
        ...
        final com.zeroc.IceInternal.EndpointI_connectors callback)
    {
        ...
        com.zeroc.IceInternal.EndpointI_connectors cb = new com.zeroc.IceInternal.EndpointI_connectors() {
            @Override public void connectors(java.util.List<com.zeroc.IceInternal.Connector> connectors)
            {
    ...
    @Override synchronized public int hashCode() { return _delegate.hashCode(); }

    @Override public String options() { return _delegate.options(); }
    ...
    @Override protected boolean checkOption(String option, String argument, String endpoint) { return false; }
