...
/**
 * An application can customize the certificate verification process by implementing the
...
public interface CertificateVerifier {
   ...
   * @return <code>true</code> if the connection should be accepted; <code>false</code>, otherwise.
   */
