...
{
    public UnknownUserException() { super(); }

    public UnknownUserException(Throwable cause) { super(cause); }

    public UnknownUserException(String unknown) { super(unknown); }

    public UnknownUserException(String unknown, Throwable cause) { super(unknown, cause); }

    public String ice_id() { return "::Ice::UnknownUserException"; }
