...
/**
 * This exception is raised if a system error occurred in the server or client process. There are
 * many possible causes for such a system exception. For details on the cause, {@link
