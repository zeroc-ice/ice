...
public enum ACMClose {
  ...
  CloseOnIdle(1),
  /**
   * Forcefully closes a connection that has been idle for the configured timeout period, but only
   * if the connection has pending invocations.
   */
  CloseOnInvocation(2),
  /** Combines the behaviors of CloseOnIdle and CloseOnInvocation. */
  CloseOnInvocationAndIdle(3),
  /**
   * Forcefully closes a connection that has been idle for the configured timeout period, regardless
   * of whether the connection has pending invocations or dispatch.
   */
