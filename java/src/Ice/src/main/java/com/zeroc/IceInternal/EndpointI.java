...
public abstract class EndpointI implements com.zeroc.Ice.Endpoint, java.lang.Comparable<EndpointI> {
  ...
  public abstract void connectors_async(
      com.zeroc.Ice.EndpointSelectionType selType, EndpointI_connectors callback);
