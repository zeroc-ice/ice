...
{
    public FacetNotExistException() { super(); }

    public FacetNotExistException(Throwable cause) { super(cause); }

    public FacetNotExistException(Identity id, String facet, String operation) { super(id, facet, operation); }
    ...
    public String ice_id() { return "::Ice::FacetNotExistException"; }
