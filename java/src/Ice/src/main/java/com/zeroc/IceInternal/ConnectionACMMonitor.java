...
class ConnectionACMMonitor implements ACMMonitor {
  ...
  @Override
  public synchronized void add(com.zeroc.Ice.ConnectionI connection) {
  ...
  @Override
  public synchronized void remove(com.zeroc.Ice.ConnectionI connection) {
  ...
  @Override
  public void reap(com.zeroc.Ice.ConnectionI connection) {
    _parent.reap(connection);
  }

  @Override
  public ACMMonitor acm(
  ...
  @Override
  public com.zeroc.Ice.ACM getACM() {
