...
// invocation observer.
//
public abstract class OutgoingAsyncBaseI<T> extends InvocationFutureI<T>
  ...
  @Override
  public final void attachRemoteObserver(
      com.zeroc.Ice.ConnectionInfo info, com.zeroc.Ice.Endpoint endpt, int requestId) {
  ...
  protected OutgoingAsyncBaseI(
      com.zeroc.Ice.Communicator com, Instance instance, String op, com.zeroc.Ice.OutputStream os) {
    super(com, instance, op);
    _os = os;
  }
