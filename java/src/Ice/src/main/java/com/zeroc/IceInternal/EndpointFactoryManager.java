...
public final class EndpointFactoryManager {
    ...
    public synchronized EndpointI create(String str, boolean oaEndpoint) {
        ...
        if (factory != null) {
            ...
            if (!v.isEmpty()) {
                com.zeroc.Ice.EndpointParseException ex =
                        new com.zeroc.Ice.EndpointParseException();
        ...
        if (protocol.equals("opaque")) {
            ...
            if (factory != null) {
                ...
                com.zeroc.Ice.OutputStream os =
                        new com.zeroc.Ice.OutputStream(
                                _instance, Protocol.currentProtocolEncoding, false);
