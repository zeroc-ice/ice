...
public final class RouterInfo
{
    ...
    @Override public int hashCode() { return _router.hashCode(); }

    public com.zeroc.Ice.RouterPrx getRouter()
    {
        //
    ...
    public void getClientEndpoints(final GetClientEndpointsCallback callback)
    {
        ...
        synchronized (this) { clientEndpoints = _clientEndpoints; }
    ...
    public boolean addProxy(final com.zeroc.Ice.ObjectPrx proxy, final AddProxyCallback callback)
    {
        ...
        _router.addProxiesAsync(new com.zeroc.Ice.ObjectPrx[] {proxy})
            .whenComplete((com.zeroc.Ice.ObjectPrx[] evictedProxies, Throwable ex) -> {
                if (ex != null)
                {
                    if (ex instanceof com.zeroc.Ice.LocalException)
                    {
    ...
    public synchronized void setAdapter(com.zeroc.Ice.ObjectAdapter adapter) { _adapter = adapter; }

    public synchronized com.zeroc.Ice.ObjectAdapter getAdapter() { return _adapter; }

    public synchronized void clearCache(Reference ref) { _identities.remove(ref.getIdentity()); }

    private synchronized EndpointI[] setClientEndpoints(com.zeroc.Ice.ObjectPrx clientProxy, boolean hasRoutingTable)
    {
