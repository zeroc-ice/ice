...
public final class RouterInfo {
    ...
    public void getClientEndpoints(final GetClientEndpointsCallback callback) {
        ...
        _router.getClientProxyAsync()
                .whenComplete(
                        (com.zeroc.Ice.Router.GetClientProxyResult r, Throwable ex) -> {
                            if (ex != null) {
    ...
    public EndpointI[] getServerEndpoints() {
        ...
        if (serverProxy == null) {
            throw new com.zeroc.Ice.NoEndpointException(
                    "Router::getServerProxy returned a null proxy.");
        }
    ...
    public boolean addProxy(final Reference reference, final AddProxyCallback callback) {
        ...
        _router.addProxiesAsync(
                        new com.zeroc.Ice.ObjectPrx[] {new com.zeroc.Ice._ObjectPrxI(reference)})
                .whenComplete(
    ...
    public synchronized void setAdapter(com.zeroc.Ice.ObjectAdapter adapter) {
        _adapter = adapter;
    }

    public synchronized com.zeroc.Ice.ObjectAdapter getAdapter() {
        return _adapter;
    }
        ...
        if (_clientEndpoints == null) {
            ...
            _clientEndpoints =
                    clientProxy == null
                            ...
                            : ((com.zeroc.Ice._ObjectPrxI) clientProxy)
                                    ._getReference()
                                    .getEndpoints();
        }
        return _clientEndpoints;
