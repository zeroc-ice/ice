 ...
 */
public abstract class EndpointI implements Endpoint, java.lang.Comparable<EndpointI> {
    ...
    // is available.
    //
    public abstract void connectors_async(EndpointSelectionType selType, EndpointI_connectors callback);
