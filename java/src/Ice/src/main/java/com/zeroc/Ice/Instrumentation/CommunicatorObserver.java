...
public interface CommunicatorObserver {
  /**
   * This method should return an observer for the given endpoint information and connector. The Ice
   * run-time calls this method for each connection establishment attempt.
   *
   * @param endpt The endpoint.
   * @param connector The description of the connector. For IP transports, this is typically the IP
   ...
   * implementing this interface can use this object to get the Ice run-time to re-obtain observers
