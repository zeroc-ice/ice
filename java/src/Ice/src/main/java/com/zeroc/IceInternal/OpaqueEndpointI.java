...
final class OpaqueEndpointI extends EndpointI
{
    ...
    //
    @Override public void streamWrite(com.zeroc.Ice.OutputStream s)
    {
    ...
    @Override public void streamWriteImpl(com.zeroc.Ice.OutputStream s) { assert (false); }
    ...
    @Override public com.zeroc.Ice.EndpointInfo getInfo()
    {
        return new com.zeroc.Ice.OpaqueEndpointInfo(null, -1, false, _rawEncoding, _rawBytes) {
            ...
            @Override public boolean secure() { return false; }
        };
    }
    ...
    //
    @Override public String protocol() { return "opaque"; }
    ...
    //
    @Override public EndpointI timeout(int t) { return this; }

    @Override public String connectionId() { return ""; }

    //
    // Return a new endpoint with a different connection id.
    //
    @Override public EndpointI connectionId(String connectionId) { return this; }

    //
    // Return true if the endpoints support bzip2 compress, or false
    // otherwise.
    //
    @Override public boolean compress() { return false; }
    ...
    //
    @Override public EndpointI compress(boolean compress) { return this; }
    ...
    //
    @Override public boolean equivalent(EndpointI endpoint) { return false; }
