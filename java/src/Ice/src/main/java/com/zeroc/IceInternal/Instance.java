...
public final class Instance implements java.util.function.Function<String, Class<?>> {
  ...
  public synchronized com.zeroc.Ice.ObjectPrx createAdmin(
      com.zeroc.Ice.ObjectAdapter adminAdapter, com.zeroc.Ice.Identity adminIdentity) {
      ...
      if (_adminAdapter != null) {
        ...
        adminIdentity =
            new com.zeroc.Ice.Identity(
                "admin", _initData.properties.getProperty("Ice.Admin.InstanceName"));
  ...
  public synchronized java.util.Map<String, com.zeroc.Ice.Object> findAllAdminFacets() {
    ...
    if (_adminAdapter == null) {
      ...
      java.util.Map<String, com.zeroc.Ice.Object> result =
          _adminAdapter.findAllFacets(_adminIdentity);
  ...
  public Class<?> apply(String typeId) {
    ...
    // 2. Check if the application has defined any package prefixes for the top-level module (e.g.:
    // "M").
  ...
  public void initialize(
    ...
    try {
      ...
      if (_initData.logger == null) {
        ...
        if (properties.getIcePropertyAsInt("Ice.UseSyslog") > 0
          ...
          if (_initData.logger instanceof com.zeroc.Ice.LoggerI) {
            _initData.logger =
                new com.zeroc.Ice.LoggerI(properties.getIceProperty("Ice.ProgramName"), "");
          }
        }
      }
      ...
      _implicitContext =
          com.zeroc.Ice.ImplicitContextI.create(properties.getProperty("Ice.ImplicitContext"));
      ...
      _endpointFactoryManager.add(
          new WSEndpointFactory(wsProtocol, com.zeroc.Ice.TCPEndpointType.value));

      ProtocolInstance wssProtocol =
          new ProtocolInstance(this, com.zeroc.Ice.WSSEndpointType.value, "wss", true);
      _endpointFactoryManager.add(
          new WSEndpointFactory(wssProtocol, com.zeroc.Ice.SSLEndpointType.value));
      ...
      if (properties.getPropertyAsInt("Ice.ThreadInterruptSafe") > 0 || Util.isAndroid()) {
        _queueExecutor =
            new QueueExecutor(properties, Util.createThreadName(properties, "Ice.BackgroundIO"));
  ...
  public String[] finishSetup(String[] args, com.zeroc.Ice.Communicator communicator) {
    ...
    if (_referenceFactory.getDefaultRouter() == null) {
      com.zeroc.Ice.RouterPrx router =
          com.zeroc.Ice.RouterPrx.uncheckedCast(communicator.propertyToProxy("Ice.Default.Router"));
      if (router != null) {
        _referenceFactory = _referenceFactory.setDefaultRouter(router);
      }
    }
  ...
  private void setServerProcessProxy(
      com.zeroc.Ice.ObjectAdapter adminAdapter, com.zeroc.Ice.Identity adminIdentity) {
    ...
    if (locator != null && !serverId.isEmpty()) {
      com.zeroc.Ice.ProcessPrx process =
          com.zeroc.Ice.ProcessPrx.uncheckedCast(admin.ice_facet("Process"));
      try {
        //
          ...
          new HashMap<String, String[]>() {
            {
              ...
              put(
                  "IceMX",
                  new String[] {"com.zeroc.Ice", "com.zeroc.Glacier2", "com.zeroc.IceStorm"});
