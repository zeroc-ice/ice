...
public final class Instance implements java.util.function.Function<String, Class<?>> {
    ...
    public void initialize(
        ...
        try {
                ...
                if (!_oneOffDone) {
                    ...
                    if (!stdOut.isEmpty()) {
                        ...
                        try {
                            ...
                            throw new com.zeroc.Ice.FileException(
                                    "cannot append to '" + stdOut + "'", ex);
                        }
                ...
                if (properties.getIcePropertyAsInt("Ice.UseSyslog") > 0
                    ...
                    _initData.logger =
                            new com.zeroc.Ice.LoggerI(
                                    properties.getIceProperty("Ice.ProgramName"), logFile);
                } else {
            ...
            _implicitContext =
                    com.zeroc.Ice.ImplicitContextI.create(
                            properties.getProperty("Ice.ImplicitContext"));
            ...
            com.zeroc.Ice.SSL.Instance sslInstance =
                    new com.zeroc.Ice.SSL.Instance(
                            _sslEngine, com.zeroc.Ice.SSLEndpointType.value, "ssl");
            _endpointFactoryManager.add(
                    new com.zeroc.Ice.SSL.EndpointFactoryI(
                            sslInstance, com.zeroc.Ice.TCPEndpointType.value));
    ...
    public String[] finishSetup(String[] args, com.zeroc.Ice.Communicator communicator) {
        ...
        com.zeroc.Ice.PluginManagerI pluginManagerImpl =
                (com.zeroc.Ice.PluginManagerI) _pluginManager;
