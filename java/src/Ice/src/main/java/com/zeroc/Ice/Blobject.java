...
public interface Blobject extends com.zeroc.Ice.Object {
   ...
   *     <code>false</code> and the <code>outParams</code> member to the encoded user exception. If
   *     the operation raises an Ice run-time exception, it must throw it directly.
   * @throws UserException A user exception can be raised directly and the run time will marshal it.
   */
