...
public final class ReferenceFactory {
    ...
    public Reference create(
            com.zeroc.Ice.Identity ident, com.zeroc.Ice.ConnectionI fixedConnection) {
        if (ident.name.isEmpty() && ident.category.isEmpty()) {
            return null;
        }
    ...
    public Reference create(String s, String propertyPrefix) {
                ...
                case 'f':
                    {
                        if (argument == null) {
                            throw new ProxyParseException(
                                    "no argument provided for -f option in `" + s + "'");
                        }
                        ...
                        try {
                            ...
                            throw new ProxyParseException(
                                    "invalid facet in `" + s + "': " + ex.getMessage());
                        }
                ...
                case 'e':
                    {
                        if (argument == null) {
                            throw new ProxyParseException(
                                    "no argument provided for -e option in `" + s + "'");
                        }
                ...
                case 'p':
                    {
                        if (argument == null) {
                            throw new ProxyParseException(
                                    "no argument provided for -p option in `" + s + "'");
                        }
        ...
        if (s.charAt(beg) == ':') {
            ...
            if (end != s.length() && StringUtil.findFirstNotOf(s, delim, end) != -1) {
                ProxyParseException e = new ProxyParseException();
                e.str =
                        "invalid trailing characters after `"
                                + s.substring(0, end + 1)
                                + "' in `"
                                + s
                                + "'";
            ...
            try {
                ...
                throw new ProxyParseException(
                        "invalid adapter id in `" + s + "': " + ex.getMessage());
            }
            if (adapter.isEmpty()) {
    ...
    public com.zeroc.Ice.RouterPrx getDefaultRouter() {
        return _defaultRouter;
    }

    public ReferenceFactory setDefaultLocator(com.zeroc.Ice.LocatorPrx defaultLocator) {
    ...
    public com.zeroc.Ice.LocatorPrx getDefaultLocator() {
    ...
    private Reference create(
        ...
        if (_defaultLocator != null) {
            if (!((com.zeroc.Ice._ObjectPrxI) _defaultLocator)
                    ._getReference()
                    .getEncoding()
                    .equals(encoding)) {
                locatorInfo =
        ...
        com.zeroc.Ice.EndpointSelectionType endpointSelection =
                defaultsAndOverrides.defaultEndpointSelection;
        ...
        if (propertyPrefix != null && !propertyPrefix.isEmpty()) {
            ...
            if (locator != null) {
                if (!((com.zeroc.Ice._ObjectPrxI) locator)
                        ._getReference()
                        .getEncoding()
                        .equals(encoding)) {
                    locatorInfo =
