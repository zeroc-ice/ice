...
{
    public Reference create(com.zeroc.Ice.Identity ident, String facet, Reference tmpl, EndpointI[] endpoints)
    {
    ...
    public Reference create(com.zeroc.Ice.Identity ident, String facet, Reference tmpl, String adapterId)
    {
        if (ident.name.length() == 0 && ident.category.length() == 0)
        {
            return null;
    ...
    public com.zeroc.Ice.RouterPrx getDefaultRouter() { return _defaultRouter; }
    ...
    public com.zeroc.Ice.LocatorPrx getDefaultLocator() { return _defaultLocator; }
