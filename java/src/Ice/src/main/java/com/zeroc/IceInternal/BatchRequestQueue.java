...
public class BatchRequestQueue {
  ...
  public BatchRequestQueue(Instance instance, boolean datagram) {
    ...
    if (_maxSize > 0 && datagram) {
      int udpSndSize =
          initData.properties.getPropertyAsIntWithDefault("Ice.UDP.SndSize", 65535 - _udpOverhead);
  ...
  public synchronized void prepareBatchRequest(com.zeroc.Ice.OutputStream os) {
    if (_exception != null) {
  ...
  public void finishBatchRequest(
      com.zeroc.Ice.OutputStream os, com.zeroc.Ice.ObjectPrx proxy, String operation) {
    //
  ...
  public synchronized void abortBatchRequest(com.zeroc.Ice.OutputStream os) {
  ...
  public synchronized SwapResult swap(com.zeroc.Ice.OutputStream os) {
  ...
  public synchronized void destroy(com.zeroc.Ice.LocalException ex) {
    _exception = ex;
  }
