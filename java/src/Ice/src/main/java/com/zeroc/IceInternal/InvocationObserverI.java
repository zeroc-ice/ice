...
public class InvocationObserverI
    extends com.zeroc.Ice.IceMX.ObserverWithDelegate<
        com.zeroc.Ice.IceMX.InvocationMetrics, com.zeroc.Ice.Instrumentation.InvocationObserver>
  ...
  public static final class RemoteInvocationHelper extends MetricsHelper<RemoteMetrics> {
    ...
    RemoteInvocationHelper(
        com.zeroc.Ice.ConnectionInfo con, com.zeroc.Ice.Endpoint endpt, int requestId, int size) {
      super(_attributes);
      _connectionInfo = con;
      _endpoint = endpt;
    ...
    public com.zeroc.Ice.ConnectionInfo getConnectionInfo() {
      return _connectionInfo;
    }

    public com.zeroc.Ice.Endpoint getEndpoint() {
      return _endpoint;
    }
  ...
  public com.zeroc.Ice.Instrumentation.RemoteObserver getRemoteObserver(
      com.zeroc.Ice.ConnectionInfo con, com.zeroc.Ice.Endpoint edpt, int requestId, int sz) {
  ...
  public com.zeroc.Ice.Instrumentation.CollocatedObserver getCollocatedObserver(
      com.zeroc.Ice.ObjectAdapter adapter, int requestId, int sz) {
