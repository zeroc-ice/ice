...
public final class Options
{
    ...
    {
        BadQuote(String message) { super(message); }

        public static final long serialVersionUID = 0L;
    }

    static public String[] split(String line) throws BadQuote
    {
        final String IFS = " \t\n";
                ...
                case NormalState:
                {
                    switch (c)
                    {
                        ...
                        case '$':
                        {
                            ...
                            {
                                state =
                                    ANSIQuoteState; // Bash uses $'<text>' to allow ANSI escape sequences within <text>.
                                ++i;
                            }
                            else
                            {
                            ...
                            switch (c = line.charAt(++i))
                            {
                                ...
                                case '7':
                                {
                                    ...
                                    for (j = i; j < i + 3 && j < line.length() &&
                                                octalDigits.indexOf(c = line.charAt(j)) != -1;
                                         ++j)
                                    {
                                        us = (short)(us * 8 + c - '0');
                                    }
