...
public interface Communicator extends java.lang.AutoCloseable {
   ...
   */
  java.util.Map<java.lang.String, java.lang.String> proxyToProperty(
      ObjectPrx proxy, String property);
  ...
  ObjectAdapter createObjectAdapter(
      String name, com.zeroc.Ice.SSL.SSLEngineFactory sslEngineFactory);
  ...
  ObjectAdapter createObjectAdapterWithEndpoints(
      String name, String endpoints, com.zeroc.Ice.SSL.SSLEngineFactory sslEngineFactory);
   ...
   * Ice.Admin.Enpoints is set. The identity of the Admin object created by getAdmin is {value of
