...
/**
 * Class to support thread notification hooks. Applications using thread notifications hooks
 * instantiate a <code>ThreadHookPlugin</code> with a thread start and threaed stop Runnable and
...
public class ThreadHookPlugin implements Plugin {
   ...
   * this method to perform any initialization that might be required by custom thread notification
   * hooks.
   */
  @Override
   ...
   * this method to perform any finalization that might be required by custom thread notification
   * hooks.
   */
  @Override
  public void destroy() {}
