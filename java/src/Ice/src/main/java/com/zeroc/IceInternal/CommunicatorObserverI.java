...
public class CommunicatorObserverI implements com.zeroc.Ice.Instrumentation.CommunicatorObserver
{
    ...
    static public final class DispatchHelper extends MetricsHelper<DispatchMetrics>
    {
        ...
        @Override public void initMetrics(DispatchMetrics v) { v.size += _size; }
        ...
        public String getMode() { return _current.requestId == 0 ? "oneway" : "twoway"; }
        ...
        public int getRequestId() { return _current.requestId; }

        public String getParent() { return _current.adapter.getName(); }
        ...
        public com.zeroc.Ice.Connection getConnection() { return _current.con; }
        ...
        public com.zeroc.Ice.Current getCurrent() { return _current; }

        public String getIdentity() { return _current.adapter.getCommunicator().identityToString(_current.id); }
    ...
    static public final class InvocationHelper extends MetricsHelper<InvocationMetrics>
    {
        ...
        public com.zeroc.Ice.ObjectPrx getProxy() { return _proxy; }
    ...
    static public final class EndpointHelper extends MetricsHelper<Metrics>
    {
        ...
        public String getEndpoint() { return _endpoint.toString(); }
    ...
    @Override public com.zeroc.Ice.Instrumentation.Observer getEndpointLookupObserver(com.zeroc.Ice.Endpoint endpt)
    {
    ...
    @Override
    public com.zeroc.Ice.Instrumentation.DispatchObserver getDispatchObserver(com.zeroc.Ice.Current c, int size)
    {
    ...
    @Override public void setObserverUpdater(final com.zeroc.Ice.Instrumentation.ObserverUpdater updater)
    {
        if (updater == null)
        {
    ...
    final private ObserverFactoryWithDelegate<Metrics, ObserverWithDelegateI, com.zeroc.Ice.Instrumentation.Observer>
        _connects;
    final private ObserverFactoryWithDelegate<Metrics, ObserverWithDelegateI, com.zeroc.Ice.Instrumentation.Observer>
        _endpointLookups;
}
