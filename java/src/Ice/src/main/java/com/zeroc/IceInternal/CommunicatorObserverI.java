...
public class CommunicatorObserverI implements com.zeroc.Ice.Instrumentation.CommunicatorObserver {
    ...
    public static final class InvocationHelper extends MetricsHelper<InvocationMetrics> {
        ...
        InvocationHelper(
                com.zeroc.Ice.ObjectPrx proxy, String op, java.util.Map<String, String> ctx) {
            super(_attributes);
            _proxy = proxy;
            _operation = op;
            _context = ctx;
        ...
        private static final com.zeroc.Ice.Endpoint[] emptyEndpoints =
                new com.zeroc.Ice.Endpoint[0];
    }
