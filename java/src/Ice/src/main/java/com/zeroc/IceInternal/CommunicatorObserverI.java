...
public class CommunicatorObserverI implements com.zeroc.Ice.Instrumentation.CommunicatorObserver {
  ...
  static void addConnectionAttributes(MetricsHelper.AttributeResolver r, Class<?> cl)
    ...
    r.add(
        "localPort", cl.getDeclaredMethod("getConnectionInfo"), cli.getDeclaredField("localPort"));
    r.add(
        "remoteHost",
        cl.getDeclaredMethod("getConnectionInfo"),
    ...
    r.add(
        "mcastPort", cl.getDeclaredMethod("getConnectionInfo"), cli.getDeclaredField("mcastPort"));
  ...
  public static class ConnectionHelper extends MetricsHelper<ConnectionMetrics> {
    ...
    private com.zeroc.Ice.IPConnectionInfo getIPConnectionInfo() {
  ...
  public static final class DispatchHelper extends MetricsHelper<DispatchMetrics> {
    ...
    private final com.zeroc.Ice.Current _current;
  ...
  public static final class InvocationHelper extends MetricsHelper<InvocationMetrics> {
    ...
    private final com.zeroc.Ice.ObjectPrx _proxy;
    private final String _operation;
    private final java.util.Map<String, String> _context;
    private String _id;

    private static final com.zeroc.Ice.Endpoint[] emptyEndpoints = new com.zeroc.Ice.Endpoint[0];
  }
  ...
  public static final class ThreadHelper extends MetricsHelper<ThreadMetrics> {
    ...
    private final com.zeroc.Ice.Instrumentation.ThreadState _state;
  }
  ...
  public CommunicatorObserverI(com.zeroc.Ice.InitializationData initData) {
    ...
    _dispatch =
        new ObserverFactoryWithDelegate<
            DispatchMetrics, DispatchObserverI, com.zeroc.Ice.Instrumentation.DispatchObserver>(
    ...
    _threads =
        new ObserverFactoryWithDelegate<
            ThreadMetrics, ThreadObserverI, com.zeroc.Ice.Instrumentation.ThreadObserver>(
            _metrics, "Thread", ThreadMetrics.class);
    _connects =
        new ObserverFactoryWithDelegate<
            Metrics, ObserverWithDelegateI, com.zeroc.Ice.Instrumentation.Observer>(
    ...
    try {
      _invocations.registerSubMap(
          "Remote", RemoteMetrics.class, InvocationMetrics.class.getDeclaredField("remotes"));
      _invocations.registerSubMap(
          "Collocated",
  ...
  public com.zeroc.Ice.Instrumentation.Observer getConnectionEstablishmentObserver(
      com.zeroc.Ice.Endpoint endpt, String connector) {
    if (_connects.isEnabled()) {
      try {
        ...
        return _connects.getObserver(
            new EndpointHelper(endpt, connector), ObserverWithDelegateI.class, delegate);
      } catch (Exception ex) {
        _metrics
            .getLogger()
    ...
    if (_connections.isEnabled()) {
      try {
        ...
        ConnectionObserverI o =
            observer instanceof ConnectionObserverI ? (ConnectionObserverI) observer : null;
        if (_delegate != null) {
          delegate =
              _delegate.getConnectionObserver(c, e, s, o != null ? o.getDelegate() : observer);
        }
  ...
  public com.zeroc.Ice.Instrumentation.ThreadObserver getThreadObserver(
    ...
    if (_threads.isEnabled()) {
      try {
        ...
        if (_delegate != null) {
          delegate =
              _delegate.getThreadObserver(parent, id, s, o != null ? o.getDelegate() : observer);
        }
    ...
    if (_invocations.isEnabled()) {
      try {
        ...
        return _invocations.getObserver(
            new InvocationHelper(prx, operation, ctx), InvocationObserverI.class, delegate);
      } catch (Exception ex) {
        _metrics
            .getLogger()
            .error("unexpected exception trying to obtain observer:\n" + Ex.toString(ex));
  ...
  public com.zeroc.Ice.Instrumentation.DispatchObserver getDispatchObserver(
      com.zeroc.Ice.Current c, int size) {
  ...
  private final com.zeroc.Ice.Instrumentation.CommunicatorObserver _delegate;
  private final ObserverFactoryWithDelegate<
          ConnectionMetrics, ConnectionObserverI, com.zeroc.Ice.Instrumentation.ConnectionObserver>
      _connections;
  private final ObserverFactoryWithDelegate<
          DispatchMetrics, DispatchObserverI, com.zeroc.Ice.Instrumentation.DispatchObserver>
      _dispatch;
  private final ObserverFactoryWithDelegate<
          InvocationMetrics, InvocationObserverI, com.zeroc.Ice.Instrumentation.InvocationObserver>
      _invocations;
  private final ObserverFactoryWithDelegate<
          ThreadMetrics, ThreadObserverI, com.zeroc.Ice.Instrumentation.ThreadObserver>
      _threads;
