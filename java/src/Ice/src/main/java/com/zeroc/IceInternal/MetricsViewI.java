...
public class MetricsViewI
{
    ...
    public java.util.Map<String, com.zeroc.Ice.MX.Metrics[]>
    getMetrics()
    {
        java.util.Map<String, com.zeroc.Ice.MX.Metrics[]> metrics = new java.util.HashMap<>();
    ...
    public com.zeroc.Ice.MX.MetricsFailures[]
    ...
    public <T extends com.zeroc.Ice.MX.Metrics> MetricsMap<T>
