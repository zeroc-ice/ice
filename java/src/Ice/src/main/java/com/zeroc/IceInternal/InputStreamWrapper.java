...
public class InputStreamWrapper extends java.io.InputStream
{
    ...
    @Override public int read(byte[] b) throws java.io.IOException { return read(b, 0, b.length); }

    @Override public int read(byte[] b, int offset, int count) throws java.io.IOException
    {
        try
        {
    ...
    @Override public int available() { return _buf.remaining(); }

    @Override public void mark(int readlimit) { _markPos = _buf.position(); }
