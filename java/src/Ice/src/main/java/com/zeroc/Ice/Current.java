 ...
 * <code>Current</code> as its implicit final parameter. <code>Current</code> is mostly used for Ice
 * services. Most applications ignore this parameter.
 */
public class Current implements java.lang.Cloneable {
  ...
  /**
   * Information about the connection over which the current method invocation was received. If the
   * invocation is direct due to collocation optimization, this value is set to null.
   */
