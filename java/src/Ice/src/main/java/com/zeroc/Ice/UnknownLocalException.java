...
{
    public UnknownLocalException() { super(); }

    public UnknownLocalException(Throwable cause) { super(cause); }

    public UnknownLocalException(String unknown) { super(unknown); }

    public UnknownLocalException(String unknown, Throwable cause) { super(unknown, cause); }

    public String ice_id() { return "::Ice::UnknownLocalException"; }
