...
public final class ObserverHelper {
    ...
    public static InvocationObserver get(com.zeroc.Ice.ObjectPrx proxy, String op) {
        return get(proxy, op, null);
    }

    public static InvocationObserver get(
            com.zeroc.Ice.ObjectPrx proxy, String op, java.util.Map<String, String> context) {
        CommunicatorObserver obsv =
                ((com.zeroc.Ice._ObjectPrxI) proxy)
                        ._getReference()
                        .getInstance()
                        .initializationData()
                        .observer;
