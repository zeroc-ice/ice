...
public final class InitializationData implements Cloneable {
   ...
   * compact ID resolver in <code>InitializationData</code> The parameter id represents the compact
   * ID; the returned value is the type ID such as <code>"::Module::Class"</code>, or an empty
   * string if the compact ID is unknown.
   */
