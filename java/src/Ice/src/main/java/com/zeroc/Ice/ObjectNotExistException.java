...
{
    public ObjectNotExistException() { super(); }

    public ObjectNotExistException(Throwable cause) { super(cause); }

    public ObjectNotExistException(Identity id, String facet, String operation) { super(id, facet, operation); }
    ...
    public String ice_id() { return "::Ice::ObjectNotExistException"; }
