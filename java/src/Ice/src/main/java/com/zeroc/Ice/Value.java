...
public abstract class Value implements java.lang.Cloneable, java.io.Serializable {
  ...
  /**
   * The Ice run time invokes this method prior to marshaling an object's data members. This allows
   * a subclass to override this method in order to validate its data members.
   */
