                ...
                case OperationNotExist:
                    {
                        ...
                        com.zeroc.Ice.RequestFailedException ex =
                                switch (replyStatus) {
                                    ...
                                    case FacetNotExist ->
                                            new com.zeroc.Ice.FacetNotExistException();
                ...
                case UnknownUserException:
                    {
                        ...
                        com.zeroc.Ice.UnknownException ex =
                                switch (replyStatus) {
                                    ...
                                    case UnknownLocalException ->
                                            new com.zeroc.Ice.UnknownLocalException();
        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    _proxy._updateRequestHandler(
                            _handler, null); // Clear request handler and always retry.
                } catch (com.zeroc.Ice.Exception ex) {
                    if (_childObserver != null) {
