...
public class MetricsMap<T extends com.zeroc.Ice.IceMX.Metrics>
{
    public class Entry
    {
        ...
        public <S extends com.zeroc.Ice.IceMX.Metrics> MetricsMap<S>.Entry
    ...
    private boolean
    match(String attribute, java.util.regex.Pattern regex, com.zeroc.Ice.IceMX.MetricsHelper<T> helper, boolean reject)
    {
        String value;
        try
        {
