...
public class MetricsMap<T extends com.zeroc.Ice.IceMX.Metrics> {
  public class Entry {
    Entry(T obj) {
      _object = obj;
    }
    ...
    public <S extends com.zeroc.Ice.IceMX.Metrics> MetricsMap<S>.Entry getMatching(
        String mapName, com.zeroc.Ice.IceMX.MetricsHelper<S> helper, Class<S> cl) {
      SubMap<S> m;
      synchronized (MetricsMap.this) {
    ...
    private com.zeroc.Ice.IceMX.MetricsFailures getFailures() {
      ...
      com.zeroc.Ice.IceMX.MetricsFailures f = new com.zeroc.Ice.IceMX.MetricsFailures();
      f.id = _object.id;
    ...
    @Override
    @SuppressWarnings("unchecked")
    public com.zeroc.Ice.IceMX.Metrics clone() {
  ...
  static class SubMapCloneFactory<S extends com.zeroc.Ice.IceMX.Metrics> {
  ...
  static class SubMapFactory<S extends com.zeroc.Ice.IceMX.Metrics> {
    SubMapFactory(Class<S> cl, java.lang.reflect.Field field) {
      _class = cl;
      _field = field;
    }

    SubMapCloneFactory<S> createCloneFactory(
        String subMapPrefix, com.zeroc.Ice.Properties properties) {
  ...
  @SuppressWarnings("unchecked")
  public <S extends com.zeroc.Ice.IceMX.Metrics> SubMap<S> createSubMap(
  ...
  private java.util.Map<String, java.util.regex.Pattern> parseRule(
      com.zeroc.Ice.Properties properties, String name) {
    ...
    for (java.util.Map.Entry<String, String> e : rules.entrySet()) {
      pats.put(
          e.getKey().substring(name.length() + 1), java.util.regex.Pattern.compile(e.getValue()));
    }
    return pats;
  }
  ...
  private boolean match(
      ...
      com.zeroc.Ice.IceMX.MetricsHelper<T> helper,
      boolean reject) {
    String value;
    try {
