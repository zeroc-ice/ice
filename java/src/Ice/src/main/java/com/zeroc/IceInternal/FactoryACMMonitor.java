...
class FactoryACMMonitor implements ACMMonitor {
  ...
  @Override
  public void add(com.zeroc.Ice.ConnectionI connection) {
  ...
  @Override
  public void remove(com.zeroc.Ice.ConnectionI connection) {
    if (_config.timeout == 0) {
      return;
    }
  ...
  @Override
  public synchronized void reap(com.zeroc.Ice.ConnectionI connection) {
    _reapedConnections.add(connection);
  }

  @Override
  public synchronized ACMMonitor acm(
  ...
  private java.util.List<com.zeroc.Ice.ConnectionI> _reapedConnections =
