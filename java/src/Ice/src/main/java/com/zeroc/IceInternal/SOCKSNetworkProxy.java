...
public final class SOCKSNetworkProxy implements NetworkProxy
{
    ...
    private SOCKSNetworkProxy(java.net.InetSocketAddress address) { _address = address; }
    ...
    @Override public NetworkProxy resolveHost(int protocolSupport)
    {
        assert (_host != null);
        return new SOCKSNetworkProxy(
            Network.getAddresses(_host, _port, protocolSupport, com.zeroc.Ice.EndpointSelectionType.Random, false, true)
                .get(0));
    }
    ...
    @Override public String getName() { return "SOCKS"; }

    @Override public int getProtocolSupport() { return Network.EnableIPv4; }
