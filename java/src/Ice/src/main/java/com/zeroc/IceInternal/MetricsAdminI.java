...
public class MetricsAdminI
    implements com.zeroc.Ice.IceMX.MetricsAdmin,
  ...
  @Override
  public synchronized com.zeroc.Ice.IceMX.MetricsAdmin.GetMetricsViewNamesResult
  ...
  @Override
  public synchronized com.zeroc.Ice.IceMX.MetricsAdmin.GetMetricsViewResult getMetricsView(
      String viewName, com.zeroc.Ice.Current current)
      throws com.zeroc.Ice.IceMX.UnknownMetricsView {
  ...
  @Override
  public synchronized com.zeroc.Ice.IceMX.MetricsFailures[] getMapMetricsFailures(
      String viewName, String mapName, com.zeroc.Ice.Current current)
      throws com.zeroc.Ice.IceMX.UnknownMetricsView {
    MetricsViewI view = getMetricsView(viewName);
    if (view != null) {
  ...
  @Override
  public synchronized com.zeroc.Ice.IceMX.MetricsFailures getMetricsFailures(
      String viewName, String mapName, String id, com.zeroc.Ice.Current current)
      throws com.zeroc.Ice.IceMX.UnknownMetricsView {
    MetricsViewI view = getMetricsView(viewName);
    if (view != null) {
  ...
  public <T extends com.zeroc.Ice.IceMX.Metrics> void registerMap(
  ...
  public synchronized <S extends com.zeroc.Ice.IceMX.Metrics> void registerSubMap(
  ...
  public <T extends com.zeroc.Ice.IceMX.Metrics> java.util.List<MetricsMap<T>> getMaps(
  ...
  private final java.util.Map<String, MetricsMapFactory<?>> _factories = new java.util.HashMap<>();
