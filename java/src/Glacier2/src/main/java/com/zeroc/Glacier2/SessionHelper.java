...
public class SessionHelper
{
     ...
     */
    synchronized public com.zeroc.Ice.Communicator communicator() { return _communicator; }
     ...
     **/
    synchronized public String categoryForClient() throws SessionNotExistException
    {
        if (_router == null)
        {
        ...
        throws SessionNotExistException
    {
        ...
        return internalObjectAdapter().add(
            servant,
            new com.zeroc.Ice.Identity(java.util.UUID.randomUUID().toString(), _category));
    }
     ...
     */
    synchronized public SessionPrx session() { return _session; }
     ...
     */
    synchronized public boolean isConnected() { return _connected; }
     ...
     * @throws SessionNotExistException No session exists.
     */
    synchronized public com.zeroc.Ice.ObjectAdapter objectAdapter() throws SessionNotExistException
    {
    ...
    //
    private com.zeroc.Ice.ObjectAdapter internalObjectAdapter() throws SessionNotExistException
    {
        if (_router == null)
        {
            throw new SessionNotExistException();
    ...
    {
        SessionPrx connect(RouterPrx router) throws CannotCreateSessionException, PermissionDeniedException;
    }
    ...
    private void connected(RouterPrx router, SessionPrx session)
    {
        ...
        synchronized (this)
        {
            ...
            _shutdownHook = new Thread("Shutdown hook") {
                @Override public void run() { SessionHelper.this.destroy(); }
            };
    ...
    {
        com.zeroc.Ice.Communicator communicator = null;
        synchronized (this) { communicator = _communicator; }
    ...
    private void connectImpl(final ConnectStrategy factory)
    {
        ...
        new Thread(() -> {
            try
            {
                synchronized (SessionHelper.this) { _communicator = com.zeroc.Ice.Util.initialize(_initData); }
            }
            catch (final com.zeroc.Ice.LocalException ex)
            {
                synchronized (SessionHelper.this) { _destroy = true; }
            ...
            if (_communicator.getDefaultRouter() == null)
            {
                ...
                try
                {
                    finder = com.zeroc.Ice.RouterFinderPrx.uncheckedCast(_communicator.stringToProxy(_finderStr));
                ...
                catch (Exception ex)
                {
                    ...
                    _communicator.setDefaultRouter(com.zeroc.Ice.RouterPrx.uncheckedCast(finder.ice_identity(ident)));
                }
            }
