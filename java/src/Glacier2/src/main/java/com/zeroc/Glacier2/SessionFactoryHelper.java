...
public class SessionFactoryHelper
{
        ...
        throws InitializationException
    {
        if (callback == null)
        {
            throw new InitializationException(
                "Attempt to create a SessionFactoryHelper with a null "
        ...
        {
            throw new InitializationException(
                "Attempt to create a SessionFactoryHelper with a null Properties "
                + "argument");
        }
     ...
     */
    synchronized public void setRouterIdentity(com.zeroc.Ice.Identity identity) { _identity = identity; }
     ...
     */
    synchronized public com.zeroc.Ice.Identity getRouterIdentity() { return _identity; }
     ...
     */
    synchronized public void setRouterHost(String hostname) { _routerHost = hostname; }
     ...
     */
    synchronized public String getRouterHost() { return _routerHost; }
     ...
     */
    @Deprecated public void setSecure(boolean secure) { setProtocol(secure ? "ssl" : "tcp"); }
     ...
     */
    @Deprecated public boolean getSecure() { return getProtocol().equals("ssl"); }
     ...
     * @return The protocol.
     */
    synchronized public String getProtocol() { return _protocol; }
     ...
     */
    synchronized public void setTimeout(int timeoutMillisecs) { _timeout = timeoutMillisecs; }
     ...
     * @return The timeout.
     */
    synchronized public int getTimeout() { return _timeout; }
     ...
     */
    synchronized public void setPort(int port) { _port = port; }
     ...
     * @return The port.
     */
    synchronized public int getPort() { return getPortInternal(); }

    private int getPortInternal()
    {
        return _port == 0
            ? ((_protocol.equals("ssl") || _protocol.equals("wss")) ? GLACIER2_SSL_PORT : GLACIER2_TCP_PORT)
            : _port;
    }
     ...
     */
    synchronized public InitializationData getInitializationData() { return _initData; }
     ...
     */
    synchronized public void setConnectContext(final java.util.Map<String, String> context) { _context = context; }
     ...
     */
    synchronized public void setUseCallbacks(boolean useCallbacks) { _useCallbacks = useCallbacks; }
     ...
     */
    synchronized public boolean getUseCallbacks() { return _useCallbacks; }
