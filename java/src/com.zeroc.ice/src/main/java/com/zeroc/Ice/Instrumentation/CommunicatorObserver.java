...
public interface CommunicatorObserver {
     ...
     * Ice runtime calls this method for each connection establishment attempt.
     *
    ...
    /**
     * This method should return an observer for the given endpoint information. The Ice runtime
    ...
    /**
     * This method should return a connection observer for the given connection. The Ice runtime
    ...
    /**
     * This method should return a thread observer for the given thread. The Ice runtime calls this
    ...
    /**
     * This method should return an invocation observer for the given invocation. The Ice runtime
    ...
    /**
     * This method should return a dispatch observer for the given dispatch. The Ice runtime calls
    ...
    /**
     * The Ice runtime calls this method when the communicator is initialized. The add-in
     * implementing this interface can use this object to get the Ice runtime to re-obtain
