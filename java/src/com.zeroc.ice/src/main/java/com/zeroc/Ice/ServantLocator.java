...
/**
 * An application-provided class that an object adapter uses to locate servants that are not in its active servant map.
 *
...
public interface ServantLocator {
     ...
     * @return an instance of {@link ServantLocator.LocateResult}
     * @throws UserException The implementation can throw any exception, including {@code UserException}.
