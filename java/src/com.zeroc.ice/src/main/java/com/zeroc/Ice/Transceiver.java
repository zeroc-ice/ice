...
public interface Transceiver {
     ...
     *     {@code null} if the transceiver doesn't use a selectable channel
     */
     ...
     * data is available to be read or written by this transceiver. A transceiver implementation
     * typically uses this callback when it buffers data read from the selectable channel if it itself
