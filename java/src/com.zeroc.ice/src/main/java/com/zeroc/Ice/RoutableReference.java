...
class RoutableReference extends Reference {
    ...
    public Map<String, String> toProperty(String prefix) {
        ...
        // property's unit.
        properties.put(prefix + ".InvocationTimeout", Long.toString(getInvocationTimeout().toMillis()));
        properties.put(prefix + ".LocatorCacheTimeout", Long.toString(_locatorCacheTimeout.toSeconds()));
