...
/**
 * {@code BlobjectAsync} is the base class for asynchronous dynamic dispatch servants. A server
...
public interface BlobjectAsync extends Object {
     ...
     *     directly from {@code ice_invokeAsync}, or complete the future by setting the <code>
     *     returnValue
     *     </code> member to {@code false} and the {@code outParams} member to the encoded
     *     user exception.
