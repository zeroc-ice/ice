...
/**
 * BlobjectAsync is the base class for asynchronous dynamic dispatch servants. A server
 * application derives a concrete servant class that implements the {@link BlobjectAsync#ice_invokeAsync}
...
public interface BlobjectAsync extends Object {
     ...
     *     instance of {@code Ice_invokeResult}. If the operation completed successfully, set
     *     the {@code returnValue} member to {@code true} and the {@code outParams}
     *     member to the encoded results. If the operation raises a user exception, you can throw it
     *     directly from {@code ice_invokeAsync}, or complete the future by setting the {@code returnValue}
