...
set ICE_HOME=C:\Program Files\ZeroC\Ice-3.8.50
```
...
* icebox-3.8.50.jar
* icebt-3.8.50.jar
* icediscovery-3.8.50.jar
* icegrid-3.8.50.jar
* icegridgui.jar
* icelocatordiscovery-3.8.50.jar
* icepatch2-3.8.50.jar
* icessl-3.8.50.jar
* icestorm-3.8.50.jar
...
```shell
export ICE_HOME=/opt/Ice-3.8.50 (For local build)
