...
/**
 * An ant task for slice2wsdl. The task minimizes regeneration by
 * creating a tag file whose timestamp represents the last time
 * the corresponding Slice file was generated.
 *
 * Attributes:
 *
 *   translator - The pathname of the translator (default: "slice2wsdl").
 ...
 *
 *    <project ...>
 *        <taskdef name="slice2wsdl" classname="Slice2WsdlTask" />
 *        <property name="slice.dir" value="../include/slice"/>
 *        <target name="generate">
 *            <mkdir dir="tags" />
 *            <slice2wsdl tagdir="tags" outputdir="out" package="com.foo">
 *                <includepath>
 ...
 *    </project>
 *
 * The <taskdef> element installs the slice2wsdl task.
 */
public class Slice2WsdlTask extends org.apache.tools.ant.Task
{
    public
    Slice2WsdlTask()
    {
        _translator = new File("slice2wsdl");
        _tagDir = new File(".");
        _outputDir = null;
        _package = null;
        _includePath = null;
        ...
        throws BuildException
    {
		...
		for(int j = 0; j < outDir.length(); j++)
		{
			...
			{
				fixedOutDir = fixedOutDir.append(outDir.charAt(j));
			}
		}
                newCmd.append(fixedOutDir.toString());
                //
                // Execute
                //
                log(_translator.toString() + " " + newCmd);
                ExecTask task = (ExecTask)project.createTask("exec");
                task.setFailonerror(true);
                Argument arg = task.createArg();
                arg.setLine(newCmd.toString());
