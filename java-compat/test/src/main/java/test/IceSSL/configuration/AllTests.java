...
public class AllTests {
  ...
  private static Ice.InitializationData createClientProps(
  ...
  private static Ice.InitializationData createClientProps(
      Ice.Properties defaultProperties,
      String defaultDir,
      String defaultHost,
      String ks,
      String ts) {
  ...
  public static ServerFactoryPrx allTests(test.TestHelper helper, String testDir) {
    ...
    out.flush();
    {
      Ice.InitializationData initData =
          createClientProps(defaultProperties, defaultDir, defaultHost);
    ...
    out.flush();
    {
      ...
      //
      initData =
          createClientProps(defaultProperties, defaultDir, defaultHost, "c_rsa_ca1", "cacert1");
      comm = Ice.Util.initialize(args, initData);
      fact = ServerFactoryPrxHelper.checkedCast(comm.stringToProxy(factoryRef));
      test(fact != null);
      ...
      if (defaultHost.equals("127.0.0.1")) {
        ...
        {
          initData =
              createClientProps(defaultProperties, defaultDir, "localhost", "c_rsa_ca1", "cacert1");
          ...
          d =
              createServerProps(
                  defaultProperties, defaultDir, "localhost", "s_rsa_ca1_cn1", "cacert1");
          server = fact.createServer(d);
          try {
            server.ice_ping();
          } catch (Ice.LocalException ex) {
        ...
        //
        {
          ...
          d =
              createServerProps(
                  defaultProperties, defaultDir, "localhost", "s_rsa_ca1_cn2", "cacert1");
          server = fact.createServer(d);
          try {
            server.ice_ping();
            test(false);
        ...
        //
        {
          ...
          d =
              createServerProps(
                  defaultProperties, defaultDir, "localhost", "s_rsa_ca1_cn3", "cacert1");
          server = fact.createServer(d);
          try {
            server.ice_ping();
          } catch (Ice.LocalException ex) {
        ...
        //
        {
          ...
          d =
              createServerProps(
                  defaultProperties, defaultDir, "localhost", "s_rsa_ca1_cn4", "cacert1");
          server = fact.createServer(d);
          try {
            server.ice_ping();
            test(false);
        ...
        //
        {
          ...
          d =
              createServerProps(
                  defaultProperties, defaultDir, "localhost", "s_rsa_ca1_cn5", "cacert1");
          server = fact.createServer(d);
          try {
            server.ice_ping();
            test(false);
        ...
        //
        {
          ...
          d =
              createServerProps(
                  defaultProperties, defaultDir, defaultHost, "s_rsa_ca1_cn6", "cacert1");
          server = fact.createServer(d);
          try {
            server.ice_ping();
          } catch (Ice.LocalException ex) {
        ...
        //
        {
          ...
          d =
              createServerProps(
                  defaultProperties, defaultDir, defaultHost, "s_rsa_ca1_cn7", "cacert1");
          server = fact.createServer(d);
          try {
            server.ice_ping();
            test(false);
        ...
        //
        {
          ...
          d =
              createServerProps(
                  defaultProperties, defaultDir, defaultHost, "s_rsa_ca1_cn8", "cacert1");
          server = fact.createServer(d);
          try {
            server.ice_ping();
            test(false);
        ...
        //
        {
          ...
          try {
            ...
            IceSSL.ConnectionInfo info =
                (IceSSL.ConnectionInfo) server.ice_getConnection().getInfo();
            test(info.verified);
          } catch (Ice.LocalException ex) {
            ex.printStackTrace();
            test(false);
    ...
    out.flush();
    {
      ...
      //
      initData =
          createClientProps(defaultProperties, defaultDir, defaultHost, "c_rsa_cai2", "cacert1");
      initData.properties.setProperty("IceSSL.VerifyPeer", "1");
      initData.properties.setProperty("IceSSL.VerifyDepthMax", "4");
      comm = Ice.Util.initialize(initData);
    ...
    {
      initData =
          createClientProps(defaultProperties, defaultDir, defaultHost, "c_rsa_ca1", "cacerts");
      Ice.Communicator comm = Ice.Util.initialize(args, initData);
      ServerFactoryPrx fact = ServerFactoryPrxHelper.checkedCast(comm.stringToProxy(factoryRef));
      test(fact != null);
