...
/// <summary>Implements <see cref="SliceLoader" /> by combining multiple SliceLoader instances.</summary>
public sealed class CompositeSliceLoader : SliceLoader
{
    ...
    /// <summary>Adds a <see cref="SliceLoader" /> instance to this <see cref="CompositeSliceLoader" />.</summary>
