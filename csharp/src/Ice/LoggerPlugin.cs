...
namespace ZeroC.Ice
{
    /// <summary>Class to support custom loggers. Applications using a custom logger instantiate a LoggerPlugin with a
    /// custom logger and return the instance from their PluginFactory implementation.</summary>
    public class LoggerPlugin : IPlugin
    {
        /// <summary>Installs a custom logger for a communicator.</summary>
        ...
        public LoggerPlugin(Communicator communicator, ILogger logger) => communicator.Logger = logger;
