...
namespace Ice
{
    ...
    public class OutgoingVoidRequest
    {
    ...
    public class OutgoingVoidRequestWithEmptyParamList : OutgoingVoidRequest
    {
        private readonly string _operationName;
        private readonly bool _idempotent;

        public OutgoingVoidRequestWithEmptyParamList(string operationName, bool idempotent)
        {
            _operationName = operationName;
            _idempotent = idempotent;
        }
    ...
    public sealed class OutgoingVoidRequestWithParam<TParamList> : OutgoingVoidRequest
    {
        private readonly string _operationName;
        private readonly bool _idempotent;
        private readonly FormatType? _format;
        ...
        public OutgoingVoidRequestWithParam(
    ...
    public sealed class OutgoingVoidRequestWithStructParam<TParamList>
        : OutgoingVoidRequest where TParamList : struct
    {
        private readonly string _operationName;
        private readonly bool _idempotent;
        private readonly FormatType? _format;
        ...
        public OutgoingVoidRequestWithStructParam(
            string operationName,
            bool idempotent,
            FormatType? format,
            OutputStreamStructWriter<TParamList> writer)
