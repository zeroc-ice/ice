...
namespace ZeroC.Ice
{
    ...
    /// return to wait for the receivale of the response for twoway requests. This interface has two concrete
    ...
    internal interface IRequestHandler
    {
        ...
        /// the receival of the response).</summary>
        ...
        /// be used to wait for the receival of the response.</returns>
