...
namespace Ice
{
    public sealed class OpaqueEndpoint : Endpoint
    {
        ...
        public override IReadOnlyList<Endpoint> ExpandHost(out Endpoint? publishedEndpoint)
        {
            publishedEndpoint = null;
            return new Endpoint[] { this };
        }

        public override IReadOnlyList<Endpoint> ExpandIfWildcard() => new Endpoint[] { this };
