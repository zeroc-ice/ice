...
namespace Ice
{
    public static class Proxy
    {
        public static IObjectPrx Clone(this IObjectPrx prx,
                                       ...
                                       bool? secure = null)
        {
            // TODO: add proxy factory to return a typed proxy
            ...
            return ReferenceEquals(clone, prx.IceReference) ? prx : new ObjectPrx(clone);
        }
                                     ...
                                     bool? secure = null) where Prx : IObjectPrx
        {
            ...
            // Reference.Clone never returns a new reference == to itself.
            return ReferenceEquals(clone, prx.IceReference) ? prx : (Prx)prx.Clone(clone);
        }
