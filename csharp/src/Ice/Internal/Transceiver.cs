...
public interface Transceiver
{
    ...
    /// <param name="messageFullyWritten">When <see langword="true" />, the operation has written or is in the process
    /// of writing the remainder of the message; otherwise, <see langword="false"/>.</param>
