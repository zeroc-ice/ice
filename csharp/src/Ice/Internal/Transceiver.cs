...
public interface Transceiver
{
    ...
    /// <param name="messageWritten">When <see langword="true" />, the operation has written or is in the process
    /// of writing the message; otherwise, <see langword="false"/>.</param>
    ...
    bool startWrite(Buffer buf, AsyncCallback callback, object state, out bool messageWritten);
    ...
    /// <param name="incoming"><see langword="true"/> for an incoming connection, <see langword="false"/> for an
    /// outgoing connection.</param>
