// Copyright (c) ZeroC, Inc. All rights reserved.// Generated by makeprops.py from file ./config/PropertyNames.xml, Wed May  1 14:40:59 2024
...
public sealed class PropertyNames
{
    ...
    public static Property[] IceGridAdminProps =
    {
             ...
             new Property(@"^IceGridAdmin\.Discovery\.Locator\.Connection\.InactivityTimeout$", false, null),
    ...
    public static Property[] IceGridProps =
    {
             ...
             new Property(@"^IceGrid\.Registry\.AdminSessionManager\.Connection\.CloseTimeout$", false, null),
             new Property(@"^IceGrid\.Registry\.AdminSessionManager\.Connection\.ConnectTimeout$", false, null),
             new Property(@"^IceGrid\.Registry\.AdminSessionManager\.Connection\.EnableIdleCheck$", false, null),
             new Property(@"^IceGrid\.Registry\.AdminSessionManager\.Connection\.IdleTimeout$", false, null),
             new Property(@"^IceGrid\.Registry\.AdminSessionManager\.Connection\.InactivityTimeout$", false, null),
             ...
             new Property(@"^IceGrid\.Registry\.SessionManager\.Connection\.InactivityTimeout$", false, null),
