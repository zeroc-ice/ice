...
public sealed class PropertyNames
{
    ...
    new(@"Ice.Admin.PublishedHost", false, "", false),
    ...
    new(@"Ice.Admin.MaxConnections", false, "0", false),
    ...
    new(@"IceDiscovery.Multicast.PublishedHost", false, "", false),
    ...
    new(@"IceDiscovery.Multicast.MaxConnections", false, "0", false),
    ...
    new(@"IceDiscovery.Reply.PublishedHost", false, "", false),
    ...
    new(@"IceDiscovery.Reply.MaxConnections", false, "0", false),
    ...
    new(@"IceDiscovery.Locator.PublishedHost", false, "", false),
    ...
    new(@"IceDiscovery.Locator.MaxConnections", false, "0", false),
    ...
    new(@"IceLocatorDiscovery.Reply.PublishedHost", false, "", false),
    ...
    new(@"IceLocatorDiscovery.Reply.MaxConnections", false, "0", false),
    ...
    new(@"IceLocatorDiscovery.Locator.PublishedHost", false, "", false),
    ...
    new(@"IceLocatorDiscovery.Locator.MaxConnections", false, "0", false),
