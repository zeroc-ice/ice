    ...
    public class TwowaysAMI
    {
        ...
        internal static void twowaysAMI(TestHelper helper, Test.IMyClassPrx p)
        {
            ...
            if (p.GetConnection() != null)
            {
                ...
                TestHelper.Assert(global::Test.Collections.Equals(p3.opContextAsync().Result, communicator.CurrentContext));
                ...
                TestHelper.Assert(global::Test.Collections.Equals(p3.opContextAsync().Result, prxContext));

                communicator.CurrentContext = ctx;
                TestHelper.Assert(global::Test.Collections.Equals(p3.opContextAsync().Result, combined));
            ...
            Func<Task> task = async () =>
            {
...

                {
                    ...
                    TestHelper.Assert(global::Test.Collections.Equals(r.p2, p1) && global::Test.Collections.Equals(r.ReturnValue, p1));
                }
