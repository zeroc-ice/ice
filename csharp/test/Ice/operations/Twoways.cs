    ...
    public class Twoways
    {
        internal static void twoways(TestHelper helper, IMyClassPrx p)
        {
...

            {
                ...
                TestHelper.Assert(Proxy.IdentityFacetComparer.Equals(c1!, p));
                TestHelper.Assert(!Proxy.IdentityFacetComparer.Equals(c2!, p));
                TestHelper.Assert(Proxy.IdentityFacetComparer.Equals(r!, p));
