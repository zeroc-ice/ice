    ...
    namespace dictMapping
    {
        namespace AMD
        {
            public sealed class MyClassI : Test.MyClass
            {
                ...
                public Task<Test.MyClass_OpNDRResult>
