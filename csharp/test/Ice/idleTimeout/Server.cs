...
public class Server : global::Test.TestHelper
{
    public override void run(string[] args)
    {
        ...
        ObjectAdapter adapterDefaultMax = communicator.createObjectAdapter("TestAdapterDefaultMax");
        ...
        ObjectAdapter adapterNoIdleTimeout = communicator.createObjectAdapter("TestAdapterNoIdleTimeout");
