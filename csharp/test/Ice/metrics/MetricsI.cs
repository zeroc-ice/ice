...
public sealed class MetricsI : MetricsDisp_
{
    ...
    public override void fail(Ice.Current current)
    {
        current.con.abort();
    }

    public override void opWithUserException(Ice.Current current)
    {
        throw new UserEx();
    }

    public override void opWithRequestFailedException(Ice.Current current)
    {
        throw new Ice.ObjectNotExistException();
    }

    public override void opWithLocalException(Ice.Current current)
    {
        throw new Ice.SyscallException(message: null);
    }

    public override void opWithUnknownException(Ice.Current current)
    {
