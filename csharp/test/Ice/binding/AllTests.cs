        ...
        public class AllTests : global::Test.AllTests
        {
            ...
            public static void allTests(global::Test.TestHelper helper)
            {
                ...
                output.Flush();
                {
                    ...
                    var obj = createTestIntfPrx(adapters);
                    test(getAdapterNameWithAMI(obj) == "AdapterAMI12");
                ...
                output.Flush();
                {
                    ...
                    test(getAdapterNameWithAMI(obj) == "AdapterAMI52");
                ...
                output.Flush();
                {
                    ...
                    // one after the other.
                    //
                    for(i = 0; i < nRetry && getAdapterNameWithAMI(obj) == "AdapterAMI61"; i++) ;
                    test(i == nRetry);
                    com.deactivateObjectAdapter(adapters[0]);
                    for(i = 0; i < nRetry && getAdapterNameWithAMI(obj) == "AdapterAMI62"; i++) ;
                    test(i == nRetry);
                    com.deactivateObjectAdapter(adapters[1]);
                    for(i = 0; i < nRetry && getAdapterNameWithAMI(obj) == "AdapterAMI63"; i++) ;
                    test(i == nRetry);
                    com.deactivateObjectAdapter(adapters[2]);
                    ...
                    for(i = 0; i < nRetry && getAdapterNameWithAMI(obj) == "AdapterAMI66"; i++) ;
                    test(i == nRetry);
                    adapters.Add(com.createObjectAdapter("AdapterAMI65", endpoints[1].ToString()));
                    for(i = 0; i < nRetry && getAdapterNameWithAMI(obj) == "AdapterAMI65"; i++) ;
                    test(i == nRetry);
                    adapters.Add(com.createObjectAdapter("AdapterAMI64", endpoints[0].ToString()));
                    for(i = 0; i < nRetry && getAdapterNameWithAMI(obj) == "AdapterAMI64"; i++) ;
                    test(i == nRetry);
