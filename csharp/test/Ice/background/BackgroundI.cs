...
{
    public override void op(Ice.Current current) => _controller.checkCallPause(current);

    public override void opWithPayload(byte[] seq, Ice.Current current) => _controller.checkCallPause(current);
