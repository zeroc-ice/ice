...
- Removed dependency on the Ice Builder Visual Studio Extension for C# source
builds.
...
- Fixed a bug that caused the code generated by `slice2matlab` to throw a type
  conversion exception. This affected classes or structs containing an array mapped
  to an structure array.
