...
local interface Communicator
{
    ...
    /// @return The dispatch queue associated wih this Communicator's client thread pool.
    ...
    /// @return The dispatch queue associated wih the Communicator's server thread pool.
    ["cpp:const", "swift:nonnull", "cpp:type:dispatch_queue_t", "swift:type:Dispatch.DispatchQueue"]
