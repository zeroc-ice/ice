...
module Ice
{
    ...
    // A dispatch exception is a remote exception that reports an error during the server-side dispatch of request. It
    // is usually thrown by Ice but can also be thrown by application code.
