...
# ADD LINK32 IceStorm.lib Ice.lib IceUtil.lib stlport_vc6.lib /nologo /subsystem:console /incremental:yes /machine:I386 /out:".\subscriber.exe" /libpath:"$(ICE_HOME)/lib"
...
# ADD LINK32 IceStormd.lib Iced.lib IceUtild.lib stlport_vc6.lib /nologo /subsystem:console /debug /machine:I386 /out:".\subscriber.exe" /pdbtype:sept /libpath:"$(ICE_HOME)/lib"
