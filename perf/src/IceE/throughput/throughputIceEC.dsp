...
# ADD CPP /nologo /MD /W3 /WX /GR /GX /O2 /I "." /I "$(ICEE_HOME)/include" /I "../../../include" /I "$(ICE_HOME)/include/stlport" /D "NDEBUG" /D "_ICEE" /D "_CONSOLE" /D "ICEE_USE_ARRAY_MAPPING" /FD /c
# SUBTRACT CPP /Fr /YX
...
# ADD LINK32 icee.lib stlport_vc6.lib /nologo /subsystem:console /incremental:yes /machine:I386 /out:"client.exe" /libpath:"$(ICEE_HOME)/lib"
...
# ADD CPP /nologo /MDd /W3 /WX /Gm /GR /GX /Zi /Od /I "." /I "$(ICEE_HOME)/include" /I "../../../include" /I "$(ICE_HOME)/include/stlport" /D "_DEBUG" /D "_ICEE" /D "_CONSOLE" /D "ICEE_USE_ARRAY_MAPPING" /FD /GZ /c
# SUBTRACT CPP /Fr /YX
...
# ADD LINK32 iceed.lib stlport_vc6.lib /nologo /subsystem:console /debug /machine:I386 /out:"client.exe" /pdbtype:sept /libpath:"$(ICEE_HOME)/lib"
