...
Ice/Communicator.php: "$(slicedir)/Ice/Communicator.ice" "$(slicedir)/Ice/LoggerF.ice" "$(slicedir)/Ice/InstrumentationF.ice" "$(slicedir)/Ice/ObjectAdapterF.ice" "$(slicedir)/Ice/ObjectFactoryF.ice" "$(slicedir)/Ice/RouterF.ice" "$(slicedir)/Ice/LocatorF.ice" "$(slicedir)/Ice/PluginF.ice" "$(slicedir)/Ice/ImplicitContextF.ice" "$(slicedir)/Ice/Current.ice" "$(slicedir)/Ice/ConnectionF.ice" "$(slicedir)/Ice/Identity.ice" "$(slicedir)/Ice/Version.ice" "$(slicedir)/Ice/Properties.ice" "$(slicedir)/Ice/PropertiesAdmin.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
...
Ice/PropertiesAdmin.php: "$(slicedir)/Ice/PropertiesAdmin.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
Ice/Properties.php: "$(slicedir)/Ice/Properties.ice" "$(slicedir)/Ice/PropertiesAdmin.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
...
IceStorm/IceStorm.php: "$(slicedir)/IceStorm/IceStorm.ice" "$(slicedir)/Ice/Identity.ice" "$(slicedir)/Ice/SliceChecksumDict.ice" "$(slicedir)/IceStorm/Metrics.ice" "$(slicedir)/Ice/Metrics.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
