...
By default, Ice for PHP is installed to `/opt/Ice-3.8.0`. To change the installation location, set the `prefix` Makefile
variable:
...
include_path=${include_path}":/opt/Ice-3.8.0/php"
```
