...
bool createProxy(zval*, const Ice::ObjectPrxPtr&, const CommunicatorInfoPtr&);
bool createProxy(zval*, const Ice::ObjectPrxPtr&, const ProxyInfoPtr&, const CommunicatorInfoPtr&);
