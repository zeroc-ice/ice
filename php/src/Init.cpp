...
ZEND_BEGIN_ARG_INFO_EX(Ice_defineException_arginfo, 1, ZEND_RETURN_VALUE, static_cast<zend_ulong>(4))
ZEND_ARG_INFO(0, id)
ZEND_ARG_INFO(0, name)
ZEND_ARG_INFO(0, base)
ZEND_ARG_INFO(0, members)
...
#define ICEPHP_OPERATION_FUNCTIONS ZEND_FE(IcePHP_defineOperation, Ice_defineOperation_arginfo)
...
zend_function_entry ice_functions[] = {
    ICEPHP_COMMUNICATOR_FUNCTIONS ICEPHP_OPERATION_FUNCTIONS ICEPHP_PROPERTIES_FUNCTIONS ICEPHP_TYPE_FUNCTIONS
        ICEPHP_UTIL_FUNCTIONS{0, 0, 0}};

zend_module_entry ice_module_entry = {STANDARD_MODULE_HEADER, "ice",
                                      ice_functions,          ZEND_MINIT(ice),
                                      ZEND_MSHUTDOWN(ice),    ZEND_RINIT(ice),
                                      ZEND_RSHUTDOWN(ice),    ZEND_MINFO(ice),
...
extern "C" int
initIceGlobals(zend_ice_globals* g)
{
    g->communicatorMap = 0;
