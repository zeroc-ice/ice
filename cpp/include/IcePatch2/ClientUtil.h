...
namespace IcePatch2
{
    ...
    public:
        ...
        /// @param remove Whether to delete files that exist locally, but not on the server. A negative or zero value
        /// prevents removal of files. A value of 1 enables removal and causes the client to halt with an error if
        /// removal of a file fails. A value of 2 or greater also enables removal, but causes the client to silently
