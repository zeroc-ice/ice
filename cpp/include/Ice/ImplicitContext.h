...
namespace Ice
{
    ...
    public:
        ...
        /// is associated with the key. {@link #containsKey} allows you to distinguish between an empty-string value and
        /// no value at all.
        /// @param key The key.
        ...
        /// Marshals the underlying context plus the given context. Entries in the given context overwrite entries in
        ...
        /// Combines the underlying context plus the given context. Entries in the given context overwrite entries in
        /// the underlying context.
