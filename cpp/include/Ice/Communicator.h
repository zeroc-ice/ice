...
namespace Ice
{
    ...
    public:
        ...
        /// convenience function. Calling this operation with an empty name will result in a UUID being generated for
        /// the name.
        /// @param name The object adapter name.
        ...
        /// disable the default router, null can be used. Note that this operation has no effect on existing proxies.
        ...
        /// is set and the provided object adapter has a {@link Locator}, createAdmin registers the Admin's Process
        /// facet with the {@link Locator}'s {@link LocatorRegistry}. createAdmin must only be called once; subsequent
        /// calls raise InitializationException.
