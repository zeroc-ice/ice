...
public:
     ...
     */
    virtual RemoteObserverPtr getRemoteObserver(const Ice::ConnectionInfoPtr& con, const Ice::EndpointPtr& endpt, int requestId, int size) = 0;
     ...
     */
    virtual CollocatedObserverPtr getCollocatedObserver(const Ice::ObjectAdapterPtr& adapter, int requestId, int size) = 0;
};
...
public:
     ...
     */
    virtual InvocationObserverPtr getInvocationObserver(const Ice::ObjectPrxPtr& prx, const ::std::string& operation, const ::Ice::Context& ctx) = 0;
