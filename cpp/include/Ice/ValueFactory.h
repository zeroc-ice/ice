...
namespace Ice
{
    ...
    public:
         ...
         * factory is found that can create an instance, the run time throws NoValueFactoryException. If the value uses
         * the "compact" format, Ice immediately raises NoValueFactoryException. The following order is used to locate a
