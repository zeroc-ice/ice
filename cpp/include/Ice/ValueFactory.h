...
namespace Ice
{
    ...
    public:
        ...
        /// <li>If no instance has been created, the Ice run-time looks for the default factory, which is registered
        /// with an empty type ID.</li> <li>If no instance has been created by any of the preceding steps, the Ice
        /// run-time looks for a factory generated by the Slice compiler.</li>
        /// </ol>
