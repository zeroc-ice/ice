...
namespace Ice
{
    ...
    /**
     * Create a new value for a given value type. The type is the absolute Slice type ID. For example, the Slice type
     * ID for an interface <code>Bar</code> in the module <code>Foo</code> is <code>"::Foo::Bar"</code>.
     * Note that the leading "<code>::</code>" is required.
     * @param type The value type.
     * @return The value created for the given type, or null if the factory is unable to create the value.
    ...
    public:
         ...
         * found, or because all factories returned null, the behavior of the Ice run time depends on the format with
         ...
         * factory generated by the Slice compiler.</li>
         * </ol>
         ...
         */
        virtual ValueFactoryFunc find(std::string_view id) const noexcept = 0;
    };
