...
public:
     ...
     * @see #setProperty
     */
    virtual std::string getProperty(std::string_view key) noexcept = 0;
     ...
     * @see #setProperty
     */
    virtual std::string getPropertyWithDefault(std::string_view key, std::string_view value) noexcept = 0;
     ...
     * @see #setProperty
     */
    virtual int getPropertyAsInt(std::string_view key) noexcept = 0;
     ...
     * @see #setProperty
     */
    virtual int getPropertyAsIntWithDefault(std::string_view key, int value) noexcept = 0;
     ...
     * @see #setProperty
     */
    virtual StringSeq getPropertyAsList(std::string_view key) noexcept = 0;
     ...
     * @see #setProperty
     */
    virtual StringSeq getPropertyAsListWithDefault(std::string_view key, const StringSeq& value) noexcept = 0;
     ...
     */
    virtual PropertyDict getPropertiesForPrefix(std::string_view prefix) noexcept = 0;
     ...
     */
    virtual StringSeq parseCommandLineOptions(std::string_view prefix, const StringSeq& options) = 0;
     ...
     */
    virtual void load(std::string_view file) = 0;

    /**
     * Create a copy of this property set.
     * @return A copy of this property set.
     */
    virtual std::shared_ptr<Properties> clone() noexcept = 0;
};
