...
namespace Ice
{
    ...
    public:
        ...
        /// is not set, an empty list is returned. The strings in the list can contain whitespace and commas if they are
        ...
        /// <code>--<em>prefix</em>.</code> are converted into properties. If the prefix is empty, all options that
        /// begin with <code>--</code> are converted to properties.
        ...
        /// Parse a sequence of options into a map of key value pairs starting with a prefix. The options are expected
        /// to be of the form <code>--<em>key</em>=<em>value</em></code>.
