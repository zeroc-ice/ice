...
template<typename R> class PromiseOutgoing;
...
protected:
    ...
    ::std::future<R> _makePromiseOutgoing(bool sync, Obj obj, Fn fn, Args&&... args) const
    {
        auto outAsync = ::std::make_shared<::IceInternal::PromiseOutgoing<R>>(*this, sync);
