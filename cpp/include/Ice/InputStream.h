...
namespace IceInternal::Ex
{
    ...
    ICE_API void throwMemoryLimitException(const char* file, int line, size_t, int32_t);
...
namespace Ice
{
    ...
    private:
        ...
        protected:
            EncapsDecoder(InputStream* stream, Encaps* encaps, int32_t classGraphDepthMax)
                : _stream(stream),
                  _encaps(encaps),
            ...
            InputStream* _stream;
            Encaps* _encaps;
            const int32_t _classGraphDepthMax;
            int32_t _classGraphDepth{0};
        ...
        {
        public:
            EncapsDecoder10(InputStream* stream, Encaps* encaps, int32_t classGraphDepthMax)
        ...
        {
        public:
            EncapsDecoder11(InputStream* stream, Encaps* encaps, int32_t classGraphDepthMax)
                : EncapsDecoder(stream, encaps, classGraphDepthMax),
