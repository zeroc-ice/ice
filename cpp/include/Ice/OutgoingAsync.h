...
namespace IceInternal
{
    ...
    private:
        virtual bool handleSent(bool, bool) override { return false; }
        ...
        virtual void handleInvokeSent(bool, OutgoingAsyncBase*) const override { assert(false); }

        virtual void handleInvokeException(std::exception_ptr, OutgoingAsyncBase*) const override { assert(false); }
