...
namespace Ice
{
    ...
    public:
         ...
         * throw any user exception. If it does, that exception is marshaled back to the client. If the Slice definition
         * for the corresponding operation includes that user exception, the client receives that user exception;
         ...
         * @see #locate
         */
        virtual void finished(const Current& curr,
