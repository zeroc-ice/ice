...
allTests(Test::TestHelper* helper)
{
    ...
    auto prx =
        communicator->stringToProxy("test:" + helper->getTestEndpoint(1) + ":" + helper->getTestEndpoint(1, "udp"));
    test(prx);
    ...
    {
        auto clc = Ice::checkedCast<Test::MyClassPrx>(cl->ice_getConnection()->createProxy(cl->ice_getIdentity()));
        clc->ice_ping();
