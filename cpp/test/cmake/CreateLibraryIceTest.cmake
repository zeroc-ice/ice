# CreateLibraryIceTest - creates a test that uses a Test ice file
#
# params: 
...
function(CreateLibraryIceTest test_name include_dirs output_dir test_sources ice_files lib_target lib_name test_deps)
	...
	foreach(slice IN LISTS ice_files)
		...
		list(APPEND GENERATED_LIBICE_HEADERS 
			${output_dir}/${test_name}/${slice_name}.h
		)

		list(APPEND GENERATED_LIBICE_SOURCES 
	...
	target_sources(${lib_target} 
		PRIVATE 
			${test_sources}
			${GENERATED_LIBICE_HEADERS}
			${GENERATED_LIBICE_SOURCES}
	)
