# CreateAMDExecutableIceTest - creates a test that uses a Test ice file
#
# params: 
# test_name - the directory name of test/<name>
# include_dirs - include directories needed by target
...
function(CreateAMDExecutableIceTest test_name include_dirs output_dir test_sources ice_files exe_target output_name test_deps)
	...
	foreach(slice IN LISTS ice_files)
		...
		list(APPEND GENERATED_AMDEXEICE_HEADERS 
			${output_dir}/${test_name}/${slice_name}.h
		)

		list(APPEND GENERATED_AMDEXEICE_SOURCES 
	...
	target_sources(${exe_target} 
		PRIVATE 
			${test_sources}
			${GENERATED_AMDEXEICE_HEADERS}
			${GENERATED_AMDEXEICE_SOURCES}
	)
