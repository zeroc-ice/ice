# CreateOpenSSLExecutableIceTest - creates a test that uses a Test ice file
#
# params: 
...
function(CreateOpenSSLExecutableIceTest test_name include_dirs output_dir test_sources ice_files exe_target output_name test_deps)
	...
	foreach(slice IN LISTS ice_files)
		...
		list(APPEND GENERATED_OPENSSLEXEICE_HEADERS
			${output_dir}/${test_name}/${slice_name}.h
		)

		list(APPEND GENERATED_OPENSSLEXEICE_SOURCES 
	...
	target_sources(${exe_target} 
		PRIVATE 
			${test_sources}
			${GENERATED_OPENSSLEXEICE_HEADERS}
			${GENERATED_OPENSSLEXEICE_SOURCES}
	)
