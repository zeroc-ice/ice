# CreateExecutableIceTest - creates a test that uses a Test ice file
#
# params: 
...
function(CreateExecutableIceTest test_name include_dirs output_dir test_sources ice_files exe_target output_name test_deps)
	...
	foreach(slice IN LISTS ice_files)
		...
		list(APPEND GENERATED_EXEICE_HEADERS
			${output_dir}/${test_name}/${slice_name}.h
		)

		list(APPEND GENERATED_EXEICE_SOURCES 
	...
	target_sources(${exe_target} 
		PRIVATE 
			${test_sources}
			${GENERATED_EXEICE_HEADERS}
			${GENERATED_EXEICE_SOURCES}
	)
