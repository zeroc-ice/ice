# CreateExecutableImplIceTest - creates a test that uses a Test ice file
#
# params: 
...
function(CreateExecutableImplIceTest test_name include_dirs output_dir test_sources ice_files exe_target output_name test_deps)
	...
	list(APPEND ICE_SLICE_PARAMS ${COMPILE_SLICES_CPP_PARAMETERS} ${test_name} "--impl-c++11")

	foreach(slice IN LISTS ice_files)
		get_filename_component(slice_name ${slice} NAME_WE)

		list(APPEND GENERATED_EXEIMPLICE_HEADERS 
			${output_dir}/${test_name}/${slice_name}.h
			${output_dir}/${test_name}/${slice_name}I.h
		)

		list(APPEND GENERATED_EXEIMPLICE_SOURCES 
			${output_dir}/${test_name}/${slice_name}.cpp
			${output_dir}/${test_name}/${slice_name}I.cpp
		)
	...
	target_sources(${exe_target} 
		PRIVATE 
			${test_sources}
			${GENERATED_EXEIMPLICE_HEADERS}
			${GENERATED_EXEIMPLICE_SOURCES}
	)
