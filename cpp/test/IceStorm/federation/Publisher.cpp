...
Publisher::run(int argc, char** argv)
{
    ...
    optional<EventPrx> eventFed1 = uncheckedCast<EventPrx>(fed1->getPublisher()->ice_oneway());
    optional<EventPrx> eventFed2 = uncheckedCast<EventPrx>(fed2->getPublisher()->ice_oneway());
    optional<EventPrx> eventFed3 = uncheckedCast<EventPrx>(fed3->getPublisher()->ice_oneway());
