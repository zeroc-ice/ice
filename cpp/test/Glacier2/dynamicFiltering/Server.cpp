...
public:
    ...
    [[nodiscard]] std::optional<Ice::ObjectPrx> findObjectById(Identity id, const Current&) const override
    {
    ...
    [[nodiscard]] std::optional<LocatorRegistryPrx> getRegistry(const Current&) const override { return _registryPrx; }
