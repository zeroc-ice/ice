...
public:
    ...
    virtual void opOptionalExceptionAsync(std::optional<int>,
    ...
    virtual void opDerivedExceptionAsync(std::optional<int>,
                                         std::optional<::std::string>,
                                         std::optional<::std::shared_ptr<::Test::OneOptional>>,
                                         ::std::function<void()>,
                                         ::std::function<void(::std::exception_ptr)>,
    ...
    virtual void opRequiredExceptionAsync(std::optional<int>,
                                          std::optional<::std::string>,
                                          std::optional<::std::shared_ptr<::Test::OneOptional>>,
                                          ::std::function<void()>,
                                          ::std::function<void(::std::exception_ptr)>,
    ...
    virtual void
    opByteAsync(std::optional<::Ice::Byte>,
    ...
    virtual void
    opLongAsync(std::optional<std::int64_t>,
    ...
    virtual void opMyInterfaceProxyAsync(std::optional<::Test::MyInterfacePrx>,
                                         ::std::function<void(const std::optional<::Test::MyInterfacePrx>&,
                                                              const std::optional<::Test::MyInterfacePrx>&)>,
                                         ::std::function<void(::std::exception_ptr)>,
                                         const Ice::Current&) override;

    virtual void
    opByteSeqAsync(std::optional<::std::pair<const ::Ice::Byte*, const ::Ice::Byte*>>,
                   ::std::function<void(const std::optional<::std::pair<const ::Ice::Byte*, const ::Ice::Byte*>>&,
    ...
    virtual void opBoolSeqAsync(std::optional<::std::pair<const bool*, const bool*>>,
                                ::std::function<void(const std::optional<::std::pair<const bool*, const bool*>>&,
    ...
    virtual void opShortSeqAsync(std::optional<::std::pair<const short*, const short*>>,
                                 ::std::function<void(const std::optional<::std::pair<const short*, const short*>>&,
                                                      const std::optional<::std::pair<const short*, const short*>>&)>,
                                 ::std::function<void(::std::exception_ptr)>,
                                 const Ice::Current&) override;

    virtual void opIntSeqAsync(std::optional<::std::pair<const int*, const int*>>,
                               ::std::function<void(const std::optional<::std::pair<const int*, const int*>>&,
                                                    const std::optional<::std::pair<const int*, const int*>>&)>,
                               ::std::function<void(::std::exception_ptr)>,
                               const Ice::Current&) override;

    virtual void
    opLongSeqAsync(std::optional<::std::pair<const std::int64_t*, const std::int64_t*>>,
                   ::std::function<void(const std::optional<::std::pair<const std::int64_t*, const std::int64_t*>>&,
    ...
    virtual void opFloatSeqAsync(std::optional<::std::pair<const float*, const float*>>,
                                 ::std::function<void(const std::optional<::std::pair<const float*, const float*>>&,
                                                      const std::optional<::std::pair<const float*, const float*>>&)>,
                                 ::std::function<void(::std::exception_ptr)>,
                                 const Ice::Current&) override;

    virtual void
    opDoubleSeqAsync(std::optional<::std::pair<const double*, const double*>>,
                     ::std::function<void(const std::optional<::std::pair<const double*, const double*>>&,
    ...
    virtual void opSmallStructSeqAsync(
        ...
        ::std::function<
            void(const std::optional<::std::pair<const ::Test::SmallStruct*, const ::Test::SmallStruct*>>&,
    ...
    virtual void opFixedStructSeqAsync(
        ...
        ::std::function<
            void(const std::optional<::std::pair<const ::Test::FixedStruct*, const ::Test::FixedStruct*>>&,
    ...
    virtual void opIntOneOptionalDictAsync(std::optional<::Test::IntOneOptionalDict>,
                                           ::std::function<void(const std::optional<::Test::IntOneOptionalDict>&,
                                                                const std::optional<::Test::IntOneOptionalDict>&)>,
                                           ::std::function<void(::std::exception_ptr)>,
                                           const Ice::Current&) override;
    ...
    virtual void sendOptionalClassAsync(bool,
                                        std::optional<::std::shared_ptr<::Test::OneOptional>>,
                                        ::std::function<void()>,
                                        ::std::function<void(::std::exception_ptr)>,
                                        const Ice::Current&) override;
