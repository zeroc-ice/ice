...
namespace
{
    ...
    public:
        ...
        virtual Ice::ObjectPrxPtr getClientProxy(optional<bool>&, const Ice::Current&) const { return nullopt; }
        ...
        virtual Ice::ObjectProxySeq addProxies(Ice::ObjectProxySeq, const Ice::Current&)
        {
