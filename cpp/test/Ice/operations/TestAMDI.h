...
public:
    ...
    virtual void opShortIntLongAsync(
        short,
        int,
        std::int64_t,
    ...
    virtual void opFloatDoubleAsync(
        float,
        double,
    ...
    virtual void opFloatDoubleSAsync(
        Test::FloatS,
        Test::DoubleS,
    ...
    virtual void opFloatDoubleSSAsync(
        Test::FloatSS,
        Test::DoubleSS,
    ...
    virtual void opLongFloatDAsync(
        Test::LongFloatD,
        Test::LongFloatD,
    ...
    virtual void opStringStringDAsync(
        Test::StringStringD,
        Test::StringStringD,
    ...
    virtual void opStringMyEnumDAsync(
        Test::StringMyEnumD,
        Test::StringMyEnumD,
    ...
    virtual void opMyEnumStringDAsync(
        Test::MyEnumStringD,
        Test::MyEnumStringD,
    ...
    virtual void opMyStructMyEnumDAsync(
    ...
    virtual void opByteBoolDSAsync(
        Test::ByteBoolDS,
        Test::ByteBoolDS,
    ...
    virtual void opShortIntDSAsync(
        Test::ShortIntDS,
        Test::ShortIntDS,
    ...
    virtual void opLongFloatDSAsync(
        Test::LongFloatDS,
        Test::LongFloatDS,
    ...
    virtual void opStringStringDSAsync(
        Test::StringStringDS,
        Test::StringStringDS,
    ...
    virtual void opStringMyEnumDSAsync(
        Test::StringMyEnumDS,
        Test::StringMyEnumDS,
    ...
    virtual void opMyEnumStringDSAsync(
        Test::MyEnumStringDS,
        Test::MyEnumStringDS,
    ...
    virtual void opMyStructMyEnumDSAsync(
    ...
    virtual void opByteByteSDAsync(
        Test::ByteByteSD,
        Test::ByteByteSD,
    ...
    virtual void opBoolBoolSDAsync(
        Test::BoolBoolSD,
        Test::BoolBoolSD,
    ...
    virtual void opShortShortSDAsync(
        Test::ShortShortSD,
        Test::ShortShortSD,
    ...
    virtual void opLongLongSDAsync(
        Test::LongLongSD,
        Test::LongLongSD,
    ...
    virtual void opStringFloatSDAsync(
        Test::StringFloatSD,
        Test::StringFloatSD,
    ...
    virtual void opStringDoubleSDAsync(
        Test::StringDoubleSD,
        Test::StringDoubleSD,
    ...
    virtual void opStringStringSDAsync(
        Test::StringStringSD,
        Test::StringStringSD,
    ...
    virtual void opMyEnumMyEnumSDAsync(
        Test::MyEnumMyEnumSD,
        Test::MyEnumMyEnumSD,
    ...
    virtual void opIntSAsync(
        Test::IntS,
        ::std::function<void(const Test::IntS&)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opByteSOnewayAsync(
        Test::ByteS,
        ::std::function<void()>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opByteSOnewayCallCountAsync(
        ::std::function<void(int)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opContextAsync(
    ...
    virtual void opByte1Async(
        Ice::Byte,
        ::std::function<void(Ice::Byte)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opShort1Async(
        std::int16_t,
        ::std::function<void(std::int16_t)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opInt1Async(
        std::int32_t,
        ::std::function<void(std::int32_t)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opLong1Async(
        std::int64_t,
    ...
    virtual void opDouble1Async(
        double,
        ::std::function<void(double)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opString1Async(
        std::string,
        ::std::function<void(::std::string_view)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opStringS1Async(
        Test::StringS,
        ::std::function<void(const Test::StringS&)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opByteBoolD1Async(
        Test::ByteBoolD,
        ::std::function<void(const Test::ByteBoolD&)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opStringS2Async(
        Test::StringS,
        ::std::function<void(const Test::StringS&)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opByteBoolD2Async(
        Test::ByteBoolD,
        ::std::function<void(const Test::ByteBoolD&)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opMyStruct1Async(
        Test::MyStruct1,
        ::std::function<void(const Test::MyStruct1&)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opMyClass1Async(
        ::std::shared_ptr<Test::MyClass1>,
        ::std::function<void(const ::std::shared_ptr<Test::MyClass1>&)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opStringLiteralsAsync(
        ::std::function<void(const Test::StringS&)>,
        ::std::function<void(std::exception_ptr)>,
        const Ice::Current&);

    virtual void opWStringLiteralsAsync(
