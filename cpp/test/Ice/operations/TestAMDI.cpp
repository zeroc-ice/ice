...
void
MyDerivedClassI::opByteSOnewayAsync(
    Test::ByteS,
...
void
MyDerivedClassI::opIdempotentAsync(
    function<void()> response,
    function<void(exception_ptr)>,
    const Ice::Current& current)
{
...
void
MyDerivedClassI::opNonmutatingAsync(
    function<void()> response,
    function<void(exception_ptr)>,
    const Ice::Current& current)
{
...
MyDerivedClassI::opWStringLiteralsAsync(
    function<void(const Test::WStringS&)> response,
    function<void(exception_ptr)>,
    const Ice::Current&)
{
    Test::WStringS data;
