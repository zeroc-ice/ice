...
allTests(Test::TestHelper* helper)
{
    ...
    cout << "testing process facet... " << flush;
    {
        ...
        ProcessPrx proc = obj->ice_facet<ProcessPrx>("Process");
        proc->shutdown();
        com->waitForShutdown();
        com->destroy();
    }
    ...
    cout << "testing properties facet... " << flush;
    {
        ...
        optional<RemoteCommunicatorPrx> com = factory->createCommunicator(props);
        optional<ObjectPrx> obj = com->getAdmin();
        PropertiesAdminPrx pa = obj->ice_facet<PropertiesAdminPrx>("Properties");
        //
    ...
    cout << "testing logger facet... " << flush;
    {
        ...
        optional<ObjectPrx> obj = com->getAdmin();
        LoggerAdminPrx logger = obj->ice_facet<LoggerAdminPrx>("Logger");
        string prefix;
        ...
        RemoteLoggerPrx myProxy = adapter->addWithUUID<RemoteLoggerPrx>(remoteLogger);
    ...
    cout << "testing custom facet... " << flush;
    {
        ...
        optional<RemoteCommunicatorPrx> com = factory->createCommunicator(props);
        optional<ObjectPrx> obj = com->getAdmin();
        Test::TestFacetPrx tf = obj->ice_facet<Test::TestFacetPrx>("TestFacet");
        tf->op();
        com->destroy();
    }
    cout << "ok" << endl;
