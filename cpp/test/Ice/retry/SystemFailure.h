...
public:
    ...
    virtual std::string ice_id() const { return "SystemFailure"; }

    virtual IceUtil::Exception* ice_cloneImpl() const { return new SystemFailure(*this); }

    virtual void ice_throw() const { throw SystemFailure(*this); }
};
