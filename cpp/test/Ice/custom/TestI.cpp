...
Test::DoubleSeq
TestIntfI::opDoubleArray(std::pair<const double*, const double*> inSeq, Test::DoubleSeq& outSeq, const Ice::Current&)
{
...
Test::BoolSeq
TestIntfI::opBoolArray(std::pair<const bool*, const bool*> inSeq, Test::BoolSeq& outSeq, const Ice::Current&)
{
...
Test::ByteList
TestIntfI::opByteArray(std::pair<const Ice::Byte*, const Ice::Byte*> inSeq, Test::ByteList& outSeq, const Ice::Current&)
{
...
std::deque<bool>
TestIntfI::opBoolSeq(std::deque<bool> inSeq, std::deque<bool>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
std::list<bool>
TestIntfI::opBoolList(std::list<bool> inSeq, std::list<bool>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
std::deque<::Ice::Byte>
TestIntfI::opByteSeq(std::deque<::Ice::Byte> inSeq, std::deque<::Ice::Byte>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
std::list<::Ice::Byte>
TestIntfI::opByteList(std::list<::Ice::Byte> inSeq, std::list<::Ice::Byte>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
MyByteSeq
TestIntfI::opMyByteSeq(MyByteSeq inSeq, MyByteSeq& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
TestIntfI::opStringSeq(std::deque<::std::string> inSeq, std::deque<::std::string>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
std::list<::std::string>
TestIntfI::opStringList(std::list<::std::string> inSeq, std::list<::std::string>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
TestIntfI::opFixedSeq(std::deque<::Test::Fixed> inSeq, std::deque<::Test::Fixed>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
std::list<::Test::Fixed>
TestIntfI::opFixedList(std::list<::Test::Fixed> inSeq, std::list<::Test::Fixed>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
TestIntfI::opVariableSeq(std::deque<::Test::Variable> inSeq, std::deque<::Test::Variable>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
TestIntfI::opVariableList(std::list<::Test::Variable> inSeq, std::list<::Test::Variable>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
std::deque<::Test::E>
TestIntfI::opESeq(std::deque<::Test::E> inSeq, std::deque<::Test::E>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
std::list<::Test::E>
TestIntfI::opEList(std::list<::Test::E> inSeq, std::list<::Test::E>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
TestIntfI::opDPrxSeq(std::deque<::Test::DPrxPtr> inSeq, std::deque<::Test::DPrxPtr>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
TestIntfI::opDPrxList(std::list<::Test::DPrxPtr> inSeq, std::list<::Test::DPrxPtr>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
std::deque<::Test::CPtr>
TestIntfI::opCSeq(std::deque<::Test::CPtr> inSeq, std::deque<::Test::CPtr>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
...
std::list<::Test::CPtr>
TestIntfI::opCList(std::list<::Test::CPtr> inSeq, std::list<::Test::CPtr>& outSeq, const Ice::Current&)
{
    outSeq = inSeq;
    return inSeq;
}
