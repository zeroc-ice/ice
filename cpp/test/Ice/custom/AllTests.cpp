...
allTests(const Ice::CommunicatorPtr& communicator)
{
    ...
    cout << "testing custom bool sequences... " << flush;
    ...
    cout << "testing custom byte sequences... " << flush;
    ...
    cout << "testing custom string sequences... " << flush;
    ...
    cout << "testing custom fixed struct sequences... " << flush;
    ...
    cout << "testing custom variable struct sequences... " << flush;
    ...
    cout << "testing custom dictionary sequences... " << flush;
    ...
    cout << "testing custom enumuration sequences... " << flush;
    ...
    cout << "testing custom proxy sequences... " << flush;
