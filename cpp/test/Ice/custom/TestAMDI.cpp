...
TestIntfI::opDoubleArrayAsync(
    std::pair<const double*, const double*> in,
...
TestIntfI::opBoolArrayAsync(
    std::pair<const bool*, const bool*> in,
...
TestIntfI::opByteArrayAsync(
    std::pair<const Ice::Byte*, const Ice::Byte*> in,
    std::function<void(
...
TestIntfI::opVariableArrayAsync(
    std::pair<const Test::Variable*, const Test::Variable*> in,
...
TestIntfI::opDPrxSeqAsync(
    std::deque<Test::DPrxPtr> in,
    std::function<void(const std::deque<Test::DPrxPtr>&, const std::deque<Test::DPrxPtr>&)> response,
    std::function<void(std::exception_ptr)>,
    const Ice::Current&)
{
    response(in, in);
...
TestIntfI::opVarDictAsync(
    Test::CustomMap<std::string, int32_t> in,
    std::function<void(const Test::CustomMap<int64_t, int64_t>&, const Test::CustomMap<std::string, int32_t>&)>
        response,
    std::function<void(std::exception_ptr)>,
    const Ice::Current&)
{
