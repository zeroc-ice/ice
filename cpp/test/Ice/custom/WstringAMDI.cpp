...
void
Test1::WstringClassI::opString_async(std::wstring in,
...
void
Test1::WstringClassI::opStruct_async(Test1::WstringStruct in,
...
void
Test1::WstringClassI::throwExcept_async(std::wstring in,
                                        std::function<void ()>,
...
void
Test2::WstringClassI::opString_async(std::wstring in,
                                     std::function<void (const std::wstring&, const std::wstring&)> response,
                                     std::function<void (std::exception_ptr)>, const Ice::Current&)
{
    response(in, in);
...
void
Test2::WstringClassI::opStruct_async(Test2::WstringStruct in,
...
void
Test2::WstringClassI::throwExcept_async(std::wstring in,
                                        std::function<void ()>,
                                        std::function<void (std::exception_ptr)> error, const Ice::Current&)
