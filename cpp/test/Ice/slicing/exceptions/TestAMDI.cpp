...
void
TestI::knownIntermediateAsKnownIntermediateAsync(
    function<void()>,
...
void
TestI::knownMostDerivedAsKnownIntermediateAsync(
    function<void()>,
    function<void(exception_ptr)> error,
    const ::Ice::Current&)
{
...
void
TestI::knownMostDerivedAsKnownMostDerivedAsync(
    function<void()>,
    function<void(exception_ptr)> error,
    const ::Ice::Current&)
{
...
void
TestI::unknownMostDerived2AsBaseCompactAsync(
    function<void()>,
    function<void(exception_ptr)> error,
    const ::Ice::Current&)
{
...
void
TestI::knownPreservedAsKnownPreservedAsync(function<void()>, function<void(exception_ptr)> error, const ::Ice::Current&)
{
    try
    {
        KnownPreservedDerived ex;
...
void
TestI::relayKnownPreservedAsBaseAsync(
    RelayPrxPtr r,
    function<void()>,
    function<void(exception_ptr)> error,
    const ::Ice::Current& c)
...
void
TestI::relayKnownPreservedAsKnownPreservedAsync(
    RelayPrxPtr r,
    function<void()>,
    function<void(exception_ptr)> error,
    const ::Ice::Current& c)
...
void
TestI::unknownPreservedAsKnownPreservedAsync(
    function<void()>,
    function<void(exception_ptr)> error,
    const ::Ice::Current&)
{
...
void
TestI::relayUnknownPreservedAsBaseAsync(
    RelayPrxPtr r,
    function<void()>,
    function<void(exception_ptr)> error,
    const ::Ice::Current& c)
...
void
TestI::relayUnknownPreservedAsKnownPreservedAsync(
    RelayPrxPtr r,
    function<void()>,
    function<void(exception_ptr)> error,
    const ::Ice::Current& c)
