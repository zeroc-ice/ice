...
Client::run(int argc, char* argv[])
{
    ...
    Test::MyObjectPrxPtr prx = Ice::uncheckedCast<Test::MyObjectPrxPtr>(oa->addWithUUID(interceptor));
    Test::MyObjectPrxPtr prxForAMD = Ice::uncheckedCast<Test::MyObjectPrxPtr>(oa->addWithUUID(amdInterceptor));
    ...
    interceptor->clear();
    prx = Ice::uncheckedCast<Test::MyObjectPrxPtr>(prx->ice_collocationOptimized(false));
    runTest(prx, interceptor);

    cout << "Now with AMD" << endl;
    amdInterceptor->clear();
    prxForAMD = Ice::uncheckedCast<Test::MyObjectPrxPtr>(prxForAMD->ice_collocationOptimized(false));
    runAmdTest(prxForAMD, amdInterceptor);
#ifndef _WIN32
    //
