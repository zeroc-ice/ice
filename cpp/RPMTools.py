...
transforms = [ ('file', 'lib/Ice.jar', 'lib/Ice-%version%/Ice.jar' ),
	       ...
	       ('dir', 'python', 'lib/python2.4/site-packages'),
	       ('file', 'lib/IcePy.so', 'lib/python2.4/site-packages/IcePy.so'),
	       ('file', 'lib/IcePy.so.%version%', 'lib/python2.4/site-packages/IcePy.so.%version%'),
...
fileLists = [
    ...
    Subpackage('python',
	       ...
	       iceDescription,
	       '',
               [('lib', 'lib/python2.4/site-packages/IcePy.so.VERSION'), 
	        ('lib', 'lib/python2.4/site-packages/IcePy.so'), 
		('dir', 'lib/python2.4/site-packages/')]),
