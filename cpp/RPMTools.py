...
transforms = [ ('file', 'ice.ini', 'etc/php.d/ice.ini'),
	       ...
	       ('dir', 'config', 'usr/share/Ice-%version%/config'),
...
fileLists = [
    Package('ice',
	    ...
	    'Provides: ice-%{_arch}',
	     ...
	     ('xdir', 'share/Ice-%version%/config'),
	     ('file', 'share/Ice-%version%/config/templates.xml'),
	     ('exe', 'share/Ice-%version%/config/convertssl.py'),
             ('exe', 'share/Ice-%version%/config/upgradeicegrid.py'),
             ('file', 'share/Ice-%version%/config/icegrid-slice.3.1.ice.gz')]),
    Subpackage('c++-devel',
               'ice = %version%',
