...
# ADD LINK32 libeay32.lib ssleay32.lib /nologo /subsystem:console /machine:I386 /out:"../../bin/glacier.exe" /libpath:"../../../lib"
...
# ADD LINK32 libeay32.lib ssleay32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../bin/glacier.exe" /pdbtype:sept /libpath:"../../../lib"
# SUBTRACT LINK32 /nodefaultlib
