...
namespace IceStorm
{
    ...
    namespace Instrumentation
    {
         ...
         * This interface can be used by add-ins imlementing the TopicManagerObserver interface to update the obsevers
         * of observed objects.
         */
        class ObserverUpdater
        {
         ...
         * observeable objects. This interface should be implemented by add-ins that wish to observe IceStorm objects in
