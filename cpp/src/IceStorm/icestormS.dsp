...
# ADD CPP /nologo /MD /W3 /WX /GR /GX /Zi /O2 /I ".." /I "../../include" /D "ICE_STORM_SERVICE_API_EXPORTS" /D "_USRDLL" /D "_CONSOLE" /D "NDEBUG" /D "WIN32_LEAN_AND_MEAN" /FD /c
# SUBTRACT CPP /Fr /YX
...
# ADD LINK32 /nologo /dll /incremental:yes /debug /machine:I386 /out:"Release/icestormservice30.dll" /implib:"Release/icestormservice.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icestormservice.lib ..\..\lib	copy $(OutDir)\icestormservice30.dll ..\..\bin	copy $(OutDir)\icestormservice30.pdb ..\..\bin
