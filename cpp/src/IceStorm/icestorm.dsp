...
# ADD LINK32 /nologo /dll /machine:I386 /out:"Release/icestorm15.dll" /implib:"Release/icestorm.lib"
# SUBTRACT LINK32 /pdb:none /debug /nodefaultlib
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icestorm.lib ..\..\lib	copy $(OutDir)\icestorm15.dll ..\..\bin
...
# ADD LINK32 /nologo /dll /debug /machine:I386 /out:"Debug/icestorm15d.dll" /implib:"Debug/icestormd.lib"
# SUBTRACT LINK32 /pdb:none /nodefaultlib
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icestormd.lib ..\..\lib	copy $(OutDir)\icestorm15d.pdb ..\..\bin	copy $(OutDir)\icestorm15d.dll ..\..\bin
# End Special Build Tool
