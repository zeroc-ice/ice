...
# ADD CPP /nologo /MD /W3 /WX /GR /GX /Zi /O2 /I ".." /I "../../include" /D "_USRDLL" /D "ICE_STORM_API_EXPORTS" /D "_CONSOLE" /D "NDEBUG" /D "WIN32_LEAN_AND_MEAN" /FD /c
# SUBTRACT CPP /Fr /YX
...
# ADD LINK32 /nologo /dll /incremental:yes /debug /machine:I386 /out:"Release/icestorm30.dll" /implib:"Release/icestorm.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icestorm.lib ..\..\lib	copy $(OutDir)\icestorm30.dll ..\..\bin	copy $(OutDir)\icestorm30.pdb ..\..\bin
...
# ADD LINK32 /nologo /dll /debug /machine:I386 /out:"Debug/icestorm30d.dll" /implib:"Debug/icestormd.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icestormd.lib ..\..\lib	copy $(OutDir)\icestorm30d.pdb ..\..\bin	copy $(OutDir)\icestorm30d.dll ..\..\bin
# End Special Build Tool
