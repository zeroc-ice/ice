...
GroupNodeInfo::GroupNodeInfo(int i, LogUpdate l, Ice::ObjectPrxPtr o) : id(i), llu(l), observer(std::move(o)) {}
...
void
NodeI::ready(int j, string gn, Ice::ObjectPrxPtr coordinator, int max, int64_t generation, const Ice::Current&)
{
    lock_guard<recursive_mutex> lg(_mutex);
