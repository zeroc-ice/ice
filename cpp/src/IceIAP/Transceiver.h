...
class iAPTransceiver final
    ...
    enum State { StateNeedConnect, StateConnectPending, StateConnected };
  ...
  public:
    ...
    IceInternal::SocketOperation
        registerWithRunLoop(IceInternal::SocketOperation) final;
    IceInternal::SocketOperation
    unregisterFromRunLoop(IceInternal::SocketOperation, bool) final;
    void closeStreams() final;

    IceInternal::NativeInfoPtr getNativeInfo() final;

    IceInternal::SocketOperation initialize(IceInternal::Buffer &,
                                            IceInternal::Buffer &) final;
