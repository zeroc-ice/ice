...
# ADD LINK32 /nologo /dll /machine:I386 /out:"Release/icebox15.dll" /implib:"Release/icebox.lib"
# SUBTRACT LINK32 /pdb:none /debug /nodefaultlib
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icebox.lib ..\..\lib	copy $(OutDir)\icebox15.dll ..\..\bin
...
# ADD LINK32 /nologo /dll /debug /machine:I386 /out:"Debug/icebox15d.dll" /implib:"Debug/iceboxd.lib"
# SUBTRACT LINK32 /pdb:none /nodefaultlib
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\iceboxd.lib ..\..\lib	copy $(OutDir)\icebox15d.pdb ..\..\bin	copy $(OutDir)\icebox15d.dll ..\..\bin
# End Special Build Tool
