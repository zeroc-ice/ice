...
# ADD LINK32 /nologo /dll /incremental:yes /machine:I386 /out:"Release/icebox30.dll" /implib:"Release/icebox.lib" /FIXED:no
...
# ADD LINK32 /nologo /dll /debug /machine:I386 /out:"Debug/icebox30d.dll" /implib:"Debug/iceboxd.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\iceboxd.lib ..\..\lib	copy $(OutDir)\icebox30d.pdb ..\..\bin	copy $(OutDir)\icebox30d.dll ..\..\bin
# End Special Build Tool
