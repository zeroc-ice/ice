...
# ADD LINK32 /nologo /dll /machine:I386 /out:"Release/icepack15.dll" /implib:"Release/icepack.lib"
# SUBTRACT LINK32 /pdb:none /debug /nodefaultlib
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icepack.lib ..\..\lib	copy $(OutDir)\icepack15.dll ..\..\bin
...
# ADD LINK32 /nologo /dll /debug /machine:I386 /out:"Debug/icepack15d.dll" /implib:"Debug/icepackd.lib"
# SUBTRACT LINK32 /pdb:none /nodefaultlib
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icepackd.lib ..\..\lib	copy $(OutDir)\icepack15d.pdb ..\..\bin	copy $(OutDir)\icepack15d.dll ..\..\bin
# End Special Build Tool
