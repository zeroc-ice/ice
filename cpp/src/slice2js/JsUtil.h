...
namespace Slice
{
    ...
    public:
        ...
        static std::string
        importPrefix(const TypePtr&, const ContainedPtr&, const std::vector<std::pair<std::string, std::string>>&);

        static std::string importPrefix(
            const ContainedPtr&,
            const ContainedPtr&,
        ...
        void
        writeOptionalMarshalUnmarshalCode(::IceUtilInternal::Output&, const TypePtr&, const std::string&, int, bool);
