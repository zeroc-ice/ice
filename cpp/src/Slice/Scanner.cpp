...
YY_FATAL_ERROR( "flex scanner jammed" );
	YY_BREAK
#line 5776 "src/Slice/Scanner.cpp"
...
void initScanner()
{
    // Ensure the scanner starts at line number 1.
    yylineno = 1;
...
{
    cerr << msg << endl
         << "\tfile = " << unit->currentFile()
         << ", line = " << to_string(yylineno)
         << ", column = " << to_string(yycolno) << endl
