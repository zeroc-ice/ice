...
# ADD CPP /nologo /MD /W3 /WX /GR /GX /Zi /O2 /I ".." /I "../../include" /I "dummyinclude" /D "_USRDLL" /D "SLICE_API_EXPORTS" /D "_CONSOLE" /D "NDEBUG" /D "WIN32_LEAN_AND_MEAN" /FD /c
# SUBTRACT CPP /Fr /YX
...
# ADD LINK32 /nologo /dll /incremental:yes /debug /machine:I386 /out:"Release/slice30.dll" /implib:"Release/slice.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\slice.lib ..\..\lib	copy $(OutDir)\slice30.dll ..\..\bin	copy $(OutDir)\slice30.pdb ..\..\bin
...
# ADD LINK32 /nologo /dll /debug /machine:I386 /out:"Debug/slice30d.dll" /implib:"Debug/sliced.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\sliced.lib ..\..\lib	copy $(OutDir)\slice30d.pdb ..\..\bin	copy $(OutDir)\slice30d.dll ..\..\bin
# End Special Build Tool
