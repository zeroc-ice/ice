...
# ADD LINK32 libdb42.lib /nologo /dll /machine:I386 /out:"Release/freeze15.dll" /implib:"Release/freeze.lib"
# SUBTRACT LINK32 /pdb:none /debug /nodefaultlib
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\freeze.lib ..\..\lib	copy $(OutDir)\freeze15.dll ..\..\bin
...
# ADD LINK32 libdb42d.lib /nologo /dll /debug /machine:I386 /out:"Debug/freeze15d.dll" /implib:"Debug/freezed.lib"
# SUBTRACT LINK32 /pdb:none /nodefaultlib
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\freezed.lib ..\..\lib	copy $(OutDir)\freeze15d.pdb ..\..\bin	copy $(OutDir)\freeze15d.dll ..\..\bin
# End Special Build Tool
