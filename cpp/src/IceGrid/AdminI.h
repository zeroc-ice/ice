...
public:
    ...
    Ice::ObjectPrx getServerAdmin(std::string, const Ice::Current&) const override;
    ...
    void addObject(Ice::ObjectPrx, const ::Ice::Current&) override;
    void updateObject(Ice::ObjectPrx, const ::Ice::Current&) override;
    void addObjectWithType(Ice::ObjectPrx, std::string, const ::Ice::Current&) override;
    ...
    Ice::ObjectPrx getNodeAdmin(std::string, const Ice::Current&) const override;
    ...
    Ice::ObjectPrx getRegistryAdmin(std::string, const Ice::Current&) const override;
