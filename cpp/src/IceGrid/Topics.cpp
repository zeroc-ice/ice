...
{
    RegistryObserverPrx registryObserver = uncheckedCast<RegistryObserverPrx>(observer);
...
{
    NodeObserverPrx nodeObserver = uncheckedCast<NodeObserverPrx>(observer);
...
{
    ApplicationObserverPrx applicationObserver = uncheckedCast<ApplicationObserverPrx>(observer);
...
{
    AdapterObserverPrx adapterObserver = uncheckedCast<AdapterObserverPrx>(observer);
...
{
    ObjectObserverPrx objectObserver = uncheckedCast<ObjectObserverPrx>(observer);
