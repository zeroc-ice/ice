...
# ADD CPP /nologo /MD /W3 /WX /GR /GX /Zi /O2 /I ".." /I "../../include" /D "_USRDLL" /D "ICE_GRID_API_EXPORTS" /D "_CONSOLE" /D "NDEBUG" /D "WIN32_LEAN_AND_MEAN" /FD /c
# SUBTRACT CPP /Fr /YX
...
# ADD LINK32 /nologo /dll /incremental:yes /debug /machine:I386 /out:"Release/icegrid30.dll" /implib:"Release/icegrid.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icegrid.lib ..\..\lib	copy $(OutDir)\icegrid30.dll ..\..\bin	copy $(OutDir)\icegrid30.pdb ..\..\bin
