...
Parser::writeMessage(const list<string>& args, int fd)
{
    ...
    try
    {
        ...
        ProcessPrx process = serverAdmin->ice_facet<ProcessPrx>("Process");
...
Parser::propertiesServer(const list<string>& args, bool single)
{
    ...
    try
    {
        ...
        Ice::PropertiesAdminPrx propAdmin = serverAdmin->ice_facet<Ice::PropertiesAdminPrx>("Properties");
...
Parser::startService(const list<string>& args)
{
    ...
    try
    {
        ...
        IceBox::ServiceManagerPrx manager = admin->ice_facet<IceBox::ServiceManagerPrx>("IceBox.ServiceManager");
...
Parser::showLog(const string& id, const string& reader, bool tail, bool follow, int lineCount)
{
    ...
    Ice::LoggerAdminPrx loggerAdmin = admin->ice_facet<Ice::LoggerAdminPrx>("Logger");
    if (follow)
    {
        ...
        Ice::RemoteLoggerPrx prx = adapter->add<Ice::RemoteLoggerPrx>(servant, ident);
        adapter->activate();
