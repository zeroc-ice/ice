# Microsoft Developer Studio Project File - Name="XMLTransform" - Package Owner=<4>
...
# ADD CPP /nologo /MD /W3 /WX /GR /GX /O2 /I "." /I ".." /I "../../include" /D "NDEBUG" /D "_USRDLL" /D "XML_TRANSFORM_API_EXPORTS" /D "_CONSOLE" /D "_UNICODE" /FD /c
# SUBTRACT CPP /Fr /YX
...
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\xmltransform.lib ..\..\lib	copy $(OutDir)\xmltransform11.dll ..\..\bin
...
# ADD CPP /nologo /MDd /W3 /WX /Gm /GR /GX /Zi /Od /I "." /I ".." /I "../../include" /D "_DEBUG" /D "_USRDLL" /D "XML_TRANSFORM_API_EXPORTS" /D "_CONSOLE" /D "_UNICODE" /FD /GZ /c
# SUBTRACT CPP /Fr /YX
...
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\xmltransformd.lib ..\..\lib	copy $(OutDir)\xmltransform11d.pdb ..\..\bin	copy $(OutDir)\xmltransform11d.dll ..\..\bin
# End Special Build Tool
