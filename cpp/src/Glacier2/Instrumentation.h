...
namespace Glacier2
{
    namespace Instrumentation
    {
         ...
         * This interface can be used by add-ins imlementing the RouterObserver interface to update the obsevers of
         * observed objects.
         */
        class ObserverUpdater
        {
        ...
        /**
         * The router observer interface used by Glacier2 to obtain and update observers for its observeable objects.
