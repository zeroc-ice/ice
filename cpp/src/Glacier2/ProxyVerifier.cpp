...
namespace Glacier2
{
    ...
    public:
        ...
        bool check(const ObjectPrxPtr& prx) const override
        {
    ...
    //
    static bool match(const vector<ProxyRule*>& rules, const ObjectPrxPtr& proxy)
    {
    ...
    public:
        ...
        bool check(const ObjectPrxPtr& p) const override
        {
