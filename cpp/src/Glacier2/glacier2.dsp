...
# ADD CPP /nologo /MD /W3 /WX /GR /GX /Zi /O2 /I ".." /I "../../include" /D "_USRDLL" /D "GLACIER2_API_EXPORTS" /D "_CONSOLE" /D "NDEBUG" /D "WIN32_LEAN_AND_MEAN" /FD /c
# SUBTRACT CPP /Fr /YX
...
# ADD LINK32 /nologo /dll /incremental:yes /debug /machine:I386 /out:"Release/glacier230.dll" /implib:"Release/glacier2.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\glacier2.lib ..\..\lib	copy $(OutDir)\glacier230.dll ..\..\bin	copy $(OutDir)\glacier230.pdb ..\..\bin
...
# ADD LINK32 /nologo /dll /debug /machine:I386 /out:"Debug/glacier230d.dll" /implib:"Debug/glacier2d.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
