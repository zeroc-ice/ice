...
# ADD CPP /nologo /MD /W3 /WX /GR /GX /Zi /O2 /I "." /I ".." /I "../../include" /D "_USRDLL" /D "ICE_PATCH2_API_EXPORTS" /D "_CONSOLE" /D "NDEBUG" /D "WIN32_LEAN_AND_MEAN" /FD /c
# SUBTRACT CPP /Fr /YX
...
# ADD LINK32 libeay32.lib ssleay32.lib libbz2.lib /nologo /dll /incremental:yes /debug /machine:I386 /out:"Release/icepatch230.dll" /implib:"Release/icepatch2.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icepatch2.lib ..\..\lib	copy $(OutDir)\icepatch230.dll ..\..\bin	copy $(OutDir)\icepatch230.pdb ..\..\bin
...
# ADD LINK32 libeay32.lib ssleay32.lib libbz2d.lib /nologo /dll /debug /machine:I386 /out:"Debug/icepatch230d.dll" /implib:"Debug/icepatch2d.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icepatch2d.lib ..\..\lib	copy $(OutDir)\icepatch230d.pdb ..\..\bin	copy $(OutDir)\icepatch230d.dll ..\..\bin
# End Special Build Tool
