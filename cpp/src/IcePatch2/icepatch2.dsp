...
# ADD LINK32 libeay32.lib ssleay32.lib libbz2.lib /nologo /dll /incremental:yes /machine:I386 /out:"Release/icepatch30.dll" /implib:"Release/icepatch2.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none /debug /nodefaultlib
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icepatch2.lib ..\..\lib	copy $(OutDir)\icepatch30.dll ..\..\bin
...
# ADD LINK32 libeay32.lib ssleay32.lib libbz2d.lib /nologo /dll /debug /machine:I386 /out:"Debug/icepatch30d.dll" /implib:"Debug/icepatch2d.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icepatch2d.lib ..\..\lib	copy $(OutDir)\icepatch30d.pdb ..\..\bin	copy $(OutDir)\icepatch30d.dll ..\..\bin
# End Special Build Tool
