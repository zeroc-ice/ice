    ...
    class CsDocCommentFormatter : public DocCommentFormatter
    {
        ...
        formatLink(const string& rawLink, const ContainedPtr& source, const SyntaxTreeBasePtr& target) const final
        {
            ...
            else
            {
                ...
                // reference but (a) the source Slice file does not include this type and (b) there is no cs:identifier
                // or other identifier renaming.
        ...
        [[nodiscard]] bool useXmlEscaping() const final { return true; }
    };
...
{
    CsDocCommentFormatter formatter;
