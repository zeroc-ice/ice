...
Slice::IceRpc::ProxyVisitor::visitInterfaceDefEnd(const InterfaceDefPtr& p)
{
    ...
    _out << sp;
    _out << nl << "/// <inheritdoc/>";
    _out << nl << "public IceRpc.Ice.IceEncodeOptions? EncodeOptions { get; init; }";
    _out << sp;
    _out << nl << "/// <inheritdoc/>";
    ...
    _out << nl << "IceRpc.Ice.IceEncodeOptions? encodeOptions = null)";
    _out.dec();
    _out << sb;
...
Slice::IceRpc::ProxyVisitor::writeProxyRequestClass(const InterfaceDefPtr& interface)
{
    ...
    for (const auto& operation : interface->operations())
    {
        ...
        else
        {
            ...
            _out.inc();
            _out << nl << "encodeOptions?.PipeOptions ?? IceRpc.Ice.IceEncodeOptions.Default.PipeOptions);";
            _out.dec();
...
Slice::IceRpc::ProxyVisitor::writeProxyResponseClass(const InterfaceDefPtr& interface)
{
    ...
    for (const auto& operation : interface->operations())
    {
        ...
        _out << nl << "IceRpc.Ice.IIceProxy sender,";
