...
bool
SchannelCertificateI::operator==(const Ice::SSL::Certificate& r) const
{
...
{
    return Ice::SSL::Schannel::Certificate::load(file);
}

Ice::SSL::CertificatePtr
Ice::SSL::Certificate::decode(const std::string& encoding)
{
    return Ice::SSL::Schannel::Certificate::decode(encoding);
}
