...
#undef g2
    ...
    public:
        ...
        virtual bool verify(const Ice::SSL::CertificatePtr&) const;
...
bool
OpenSSLCertificateI::operator==(const Ice::SSL::Certificate& r) const
{
...
bool
OpenSSLCertificateI::verify(const Ice::SSL::CertificatePtr& cert) const
{
