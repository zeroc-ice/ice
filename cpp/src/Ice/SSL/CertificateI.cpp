...
//
const CertificateOID Ice::SSL::certificateOIDS[] = {
    {"2.5.4.3", "CN"},
    {"2.5.4.4", "SN"},
...
const int Ice::SSL::certificateOIDSSize = sizeof(Ice::SSL::certificateOIDS) / sizeof(CertificateOID);
...
bool
CertificateI::operator!=(const Ice::SSL::Certificate& other) const
{
