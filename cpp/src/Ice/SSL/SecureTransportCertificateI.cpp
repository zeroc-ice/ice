...
namespace
{
    ...
    class SecureTransportCertificateI final : public Ice::SSL::SecureTransport::Certificate,
                                              public Ice::SSL::CertificateI
    {
    public:
...
bool
SecureTransportCertificateI::operator==(const Ice::SSL::Certificate& r) const
{
...
bool
SecureTransportCertificateI::verify(const Ice::SSL::CertificatePtr& cert) const
{
    bool valid = false;
...
Ice::SSL::SecureTransport::CertificatePtr
Ice::SSL::SecureTransport::Certificate::create(SecCertificateRef cert)
{
    return make_shared<SecureTransportCertificateI>(cert);
}

Ice::SSL::SecureTransport::CertificatePtr
Ice::SSL::SecureTransport::Certificate::load(const std::string& file)
{
    string resolved;
...
Ice::SSL::SecureTransport::CertificatePtr
Ice::SSL::SecureTransport::Certificate::decode(const std::string& encoding)
{
#ifdef ICE_USE_SECURE_TRANSPORT_IOS
...
Ice::SSL::CertificatePtr
Ice::SSL::Certificate::load(const std::string& file)
{
    return Ice::SSL::SecureTransport::Certificate::load(file);
}

Ice::SSL::CertificatePtr
Ice::SSL::Certificate::decode(const std::string& encoding)
{
    return Ice::SSL::SecureTransport::Certificate::decode(encoding);
}
