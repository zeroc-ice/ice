...
IceInternal::addDefaultPluginFactories(vector<Ice::PluginFactory>& pluginFactories)
{
    ...
    if (find_if(
            ...
            pluginFactories.end(),
            [](const Ice::PluginFactory& factory) { return factory.pluginName == "IceUDP"; }) == pluginFactories.end())
    {
    ...
    if (find_if(
            pluginFactories.begin(),
            pluginFactories.end(),
            [](const Ice::PluginFactory& factory) { return factory.pluginName == "IceWS"; }) == pluginFactories.end())
    {
