...
{
    IceInternal::Property("IceMX.MetricsView.*.GroupBy", false, 0),
    IceInternal::Property("IceMX.MetricsView.*.Reaper", false, 0),
    IceInternal::Property("IceMX.MetricsView.*.Accept", false, 0),
    IceInternal::Property("IceMX.MetricsView.*.Reject", false, 0),
    IceInternal::Property("IceMX.MetricsView.*", false, 0),
};
