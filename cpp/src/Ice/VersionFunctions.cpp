...
IceInternal::stringToMajorMinor(string_view s, uint8_t& major, uint8_t& minor)
{
    ...
    {
        throw VersionParseException(__FILE__, __LINE__, "malformed version value `" + str + "'");
    }
    ...
    {
        throw VersionParseException(__FILE__, __LINE__, "invalid major version value `" + str + "'");
    }
    ...
    {
        throw VersionParseException(__FILE__, __LINE__, "invalid minor version value `" + str + "'");
    }

    if (majVersion < 1 || majVersion > 255 || minVersion < 0 || minVersion > 255)
    {
        throw VersionParseException(__FILE__, __LINE__, "range error in version `" + str + "'");
    }
