...
namespace IceInternal
{
    ...
    public:
        ...
        [[nodiscard]] int32_t messageSizeMax() const { return _messageSizeMax; }
        [[nodiscard]] int32_t batchAutoFlushSize() const { return _batchAutoFlushSize; }
        [[nodiscard]] int32_t classGraphDepthMax() const { return _classGraphDepthMax; }
