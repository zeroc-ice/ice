...
# ADD LINK32 /nologo /dll /machine:I386 /out:"Release/helloservice100.dll" /libpath:"../../../lib"
# SUBTRACT LINK32 /pdb:none /debug /nodefaultlib
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\helloservice100.* .
...
# ADD LINK32 /nologo /dll /debug /machine:I386 /out:"Debug/helloservice100d.dll" /pdbtype:sept /libpath:"../../../lib"
# SUBTRACT LINK32 /pdb:none /nodefaultlib
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\helloservice100d.* .
# End Special Build Tool
