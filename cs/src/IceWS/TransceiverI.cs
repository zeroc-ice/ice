...
namespace IceWS
{
    ...
    sealed class TransceiverI : IceInternal.Transceiver
    {
        ...
        internal TransceiverI(Instance instance, IceInternal.Transceiver del, string host, int port, string resource)
        {
            init(instance, del);
            _host = host;
            _port = port;
        ...
        internal TransceiverI(Instance instance, IceInternal.Transceiver del)
        {
            init(instance, del);
            _host = "";
            _port = -1;
