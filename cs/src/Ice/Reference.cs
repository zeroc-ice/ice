...
public sealed class Reference
{
    ...
    public Reference
    changeContext(Ice.Context newContext)
    {
    ...
    public Reference
    changeFacet(Ice.FacetPath newFacet)
    {
    ...
    public Reference
    changeCompress(bool newCompress)
    {
	//
    ...
    public Reference
    changeCollocationOptimization(bool newCollocationOptimization)
    {
    ...
    //
    internal
    Reference(Instance inst, Ice.Identity ident, Ice.Context ctx, Ice.FacetPath fac, int md,
