...
public class Object_DelM : Object_Del
{
    ...
    public virtual void
    ice_ping(Ice.Context __context)
    {
    ...
    ice_facets(Ice.Context __context)
    {
    ...
    public virtual bool
    ice_invoke(string operation, OperationMode mode, ByteSeq inParams, out ByteSeq outParams, Ice.Context __context)
    {
    ...
    public virtual void
    ice_invoke_async(AMI_Object_ice_invoke cb, string operation, Ice.OperationMode mode, Ice.ByteSeq inParams,
                     Ice.Context context)
    {
...
*/
    ...
    protected internal virtual IceInternal.Outgoing
    getOutgoing(string operation, OperationMode mode, Ice.Context context)
    {
    ...
    reclaimOutgoing(IceInternal.Outgoing outg)
    {
	//
