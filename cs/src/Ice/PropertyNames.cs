...
namespace IceInternal
{
    public sealed class PropertyNames
    {
        public static Property[] IceProps =
        {
             ...
             new Property(@"^Ice\.Admin\.Logger\.PingPeriod$", false, null),
        ...
        public static Property[] IceBoxProps =
        {
             ...
             new Property(@"^IceBox\.ServiceManager\.Locator\.Context\.[^\s]+$", false, null),
             ...
             new Property(@"^IceBox\.ServiceManager\.Router\.Context\.[^\s]+$", false, null),
