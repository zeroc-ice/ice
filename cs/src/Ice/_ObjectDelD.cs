...
public class _ObjectDelD : _ObjectDel
{
    ...
    public virtual bool
    ice_invoke(string operation, Ice.OperationMode mode, Ice.ByteSeq inParams, out Ice.ByteSeq outParams,
               Ice.Context context)
    {
    ...
    __initCurrent(Current current, string op, Ice.OperationMode mode, Ice.Context context)
    {
    ...
    public virtual void
    setup(IceInternal.Reference rf, Ice.ObjectAdapter adapter)
    {
	//
	// No need to synchronize, as this operation is only called
	// upon initialization.
