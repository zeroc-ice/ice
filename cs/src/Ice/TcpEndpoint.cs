...
sealed class TcpEndpoint : Endpoint
{
    ...
    public
    TcpEndpoint(Instance instance, string ho, int po, int ti, bool co)
    {
	_instance = instance;
	_host = ho;
	_port = po;
    ...
    //
    public Transceiver
    serverTransceiver(ref Endpoint endpoint)
    {
	endpoint = this;
	return null;
    }
    ...
    //
    public Acceptor
    acceptor(ref Endpoint endpoint)
    {
