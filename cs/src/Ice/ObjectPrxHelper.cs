...
public class ObjectPrxHelper : ObjectPrx
{
    ...
    public bool
    ice_isA(string __id, Context __context)
    {
	int __cnt = 0;
	while(true)
	{
    ...
    public bool
    ice_invoke(string operation, OperationMode mode, ByteSeq inParams, out ByteSeq outParams)
    {
	return ice_invoke(operation, mode, inParams, out outParams, null);
    }
    
    public bool
    ice_invoke(string operation, OperationMode mode, ByteSeq inParams, out ByteSeq outParams, Context context)
    {
	int __cnt = 0;
	while(true)
	{
    ...
    public void
    ice_invoke_async(AMI_Object_ice_invoke cb, string operation, OperationMode mode, ByteSeq inParams)
    {
    ...
    public ObjectPrx
    ice_newContext(Context newContext)
    {
    ...
    public ObjectPrx
    ice_newFacet(FacetPath newFacet)
    {
    ...
    public ObjectPrx
    ice_collocationOptimization(bool b)
    {
    ...
    //
    public void
    setup(IceInternal.Reference rf)
    {
	//
