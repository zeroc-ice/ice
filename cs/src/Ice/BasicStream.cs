...
public class BasicStream
{
    ...
    public virtual IceInternal.Instance
    instance()
    {
	return _instance;
    }
    ...
    public virtual void
    writeStringSeq(Ice.StringSeq v)
    {
	if(v == null)
	{
	    writeSize(0);
    ...
    public virtual void
    writeStringSeq(Ice.FacetPath v)
    {
	if(v == null)
	{
	    writeSize(0);
    ...
    public virtual void
    marshalFacets(bool b)
    {
	_marshalFacets = b;
    }
    
    internal virtual void
    writeInstance(Ice.Object v, int index)
    {
	writeInt(index);
    ...
    internal virtual void
    patchReferences(object instanceIndex, object patchIndex)
    {
	//
