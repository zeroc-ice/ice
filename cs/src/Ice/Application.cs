...
public abstract class Application
{
    ...
    public int
    main(string[] args, string configFile)
    {
    ...
    //
    private static void
    destroyOnInterruptCallback(int sig)
    {
    ...
    private static void
    shutdownOnInterruptCallback(int sig)
    {
	if(_nohup && sig == SIGHUP)
	{
	    return;
