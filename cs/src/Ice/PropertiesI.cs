...
sealed class PropertiesI : LocalObjectImpl, Properties
{
    ...
    public string
    getPropertyWithDefault(string key, string val)
    {
	lock(this)
	{
	    string result = _properties[key];
    ...
    public int
    getPropertyAsIntWithDefault(string key, int val)
    {
	lock(this)
	{
	    string result = _properties[key];
    ...
    public StringSeq
    parseCommandLineOptions(string pfx, StringSeq options)
    {
	lock(this)
	{
	    string prefix = pfx;
    ...
    public StringSeq
    parseIceCommandLineOptions(StringSeq options)
    {
	lock(this)
	{
    ...
    private void
    parse(System.IO.StreamReader input)
    {
	try
	{
	    string line;
