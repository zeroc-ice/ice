...
tests = [
    ...
    ("Ice/acm", ["core", "nosilverlight"]),
    ("Ice/servantLocator", ["core"]),
    ("Ice/interceptor", ["core", "nosilverlight"]),
    ("Ice/dictMapping", ["core"]),
    ("Ice/seqMapping", ["core"]),
    ("Ice/background", ["core", "nosilverlight", "nosocks"]),
    ...
    ("Ice/metrics", ["core", "nossl", "nows", "noipv6", "nocompress", "nosilverlight", "nosocks"]),
    ("Ice/enums", ["core"]),
    ("Ice/serialize", ["core", "nosilverlight"]),
    ("Ice/networkProxy", ["core", "noipv6", "nosocks", "nosilverlight"]),
    ...
    ("Glacier2/sessionHelper", ["service", "nosilverlight", "nossl", "nows", "noipv6"]),
