...
public class Client: TestHelperI {
    public override func run(args: [String]) throws {
        ...
        let factory = FactoryI(helper: self)
        ...
        do {
            ...
            try Promise<Void> { seal in
                firstly {
                    ...
                    try self.test(p2 == .MyEnumMember && p3 == .MyEnumMember)
                    seal.fulfill(())
                }.catch { e in
                    seal.reject(e)
                }
        ...
        do {
            ...
            try Promise<Void> { seal in
                firstly {
                    ...
                    try self.test(p2!.m == "test" && p3!.m == "test")
                    seal.fulfill(())
                }.catch { e in
                    seal.reject(e)
                }
        ...
        do {
            ...
            try Promise<Void> { seal in
                firstly {
                    ...
                    try self.test(p2![1]!!.a == 58 && p3![1]!!.a == 58)
                    seal.fulfill(())
                }.catch { e in
                    seal.reject(e)
                }
