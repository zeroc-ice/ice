...
class InitialI: Initial {
    ...
    func opSmallStruct(p1: SmallStruct?, current _: Ice.Current) throws -> (
    ...
    func opFixedStruct(p1: FixedStruct?, current _: Ice.Current) throws -> (
    ...
    func opVarStruct(p1: VarStruct?, current _: Ice.Current) throws -> (
        returnValue: VarStruct?, p3: VarStruct?
    ) {
        return (p1, p1)
    }

    func opOneOptional(p1: OneOptional?, current _: Ice.Current) throws -> (
    ...
    func opMyInterfaceProxy(p1: MyInterfacePrx?, current _: Ice.Current) throws -> (
    ...
    func opByteSeq(p1: ByteSeq?, current _: Ice.Current) throws -> (
        returnValue: ByteSeq?, p3: ByteSeq?
    ) {
        return (p1, p1)
    }

    func opBoolSeq(p1: BoolSeq?, current _: Ice.Current) throws -> (
        returnValue: BoolSeq?, p3: BoolSeq?
    ) {
        return (p1, p1)
    }

    func opShortSeq(p1: ShortSeq?, current _: Ice.Current) throws -> (
    ...
    func opLongSeq(p1: LongSeq?, current _: Ice.Current) throws -> (
        returnValue: LongSeq?, p3: LongSeq?
    ) {
        return (p1, p1)
    }

    func opFloatSeq(p1: FloatSeq?, current _: Ice.Current) throws -> (
        returnValue: FloatSeq?, p3: FloatSeq?
    ) {
        return (p1, p1)
    }

    func opDoubleSeq(p1: DoubleSeq?, current _: Ice.Current) throws -> (
        returnValue: DoubleSeq?, p3: DoubleSeq?
    ) {
        return (p1, p1)
    }

    func opStringSeq(p1: StringSeq?, current _: Ice.Current) throws -> (
    ...
    func opSmallStructSeq(p1: SmallStructSeq?, current _: Ice.Current) throws -> (
    ...
    func opSmallStructList(p1: SmallStructList?, current _: Ice.Current) throws -> (
    ...
    func opFixedStructSeq(p1: FixedStructSeq?, current _: Ice.Current) throws -> (
    ...
    func opFixedStructList(p1: FixedStructList?, current _: Ice.Current) throws -> (
    ...
    func opVarStructSeq(p1: VarStructSeq?, current _: Ice.Current) throws -> (
    ...
    func opSerializable(p1: Serializable?, current _: Current) throws -> (
    ...
    func opIntIntDict(p1: [Int32: Int32]?, current _: Ice.Current) throws -> (
    ...
    func opStringIntDict(p1: [String: Int32]?, current _: Ice.Current) throws -> (
    ...
    func opMStruct2(p1: SmallStruct?, current _: Current) throws -> (
    ...
    func opMSeq2(p1: StringSeq?, current _: Current) throws -> (
    ...
    func opMDict2(p1: StringIntDict?, current _: Current) throws -> (
