...
class MyDerivedClassI: ObjectI<MyDerivedClassTraits>, MyDerivedClass {
    ...
    func opByteAsync(p1: UInt8, p2: UInt8, current _: Current) -> Promise<
    ...
    func opShortIntLongAsync(
        p1: Int16,
        p2: Int32,
        p3: Int64,
        current _: Current
    ) -> Promise<(returnValue: Int64, p4: Int16, p5: Int32, p6: Int64)> {
        return Promise.value((p3, p1, p2, p3))
    }

    func opFloatDoubleAsync(
        p1: Float,
        p2: Double,
        current _: Current
    ) -> Promise<(returnValue: Double, p3: Float, p4: Double)> {
        return Promise.value((p2, p1, p2))
    }

    func opStringAsync(p1: String, p2: String, current _: Current) -> Promise<
    ...
    func opStructAsync(
        ...
        p2: Structure,
        current _: Current
    ) -> Promise<(returnValue: Structure, p3: Structure)> {
        var p3 = p1
        p3.s.s = "a new string"
        return Promise.value((p2, p3))
    }

    func opByteSAsync(p1: ByteS, p2: ByteS, current _: Current) -> Promise<
        (returnValue: ByteS, p3: ByteS)
    > {
        return Promise.value((p1 + p2, ByteSeq(p1.reversed())))
    }

    func opBoolSAsync(p1: BoolS, p2: BoolS, current _: Current) -> Promise<
        (returnValue: BoolS, p3: BoolS)
    > {
        return Promise.value((p1.reversed(), p1 + p2))
    }

    func opShortIntLongSAsync(
        p1: ShortS,
        p2: IntS,
        p3: LongS,
        current _: Current
    ) -> Promise<(returnValue: LongS, p4: ShortS, p5: IntS, p6: LongS)> {
        return Promise.value((p3, p1, p2.reversed(), p3 + p3))
    }

    func opFloatDoubleSAsync(
        p1: FloatS,
        p2: DoubleS,
        current _: Current
    ) -> Promise<(returnValue: DoubleS, p3: FloatS, p4: DoubleS)> {
        return Promise.value((p2 + p1.map { Double($0) }, p1, p2.reversed()))
    }

    func opStringSAsync(p1: StringS, p2: StringS, current _: Current) -> Promise<
        (returnValue: StringS, p3: StringS)
    > {
        return Promise.value((p1.reversed(), p1 + p2))
    }

    func opByteSSAsync(p1: ByteSS, p2: ByteSS, current _: Current) -> Promise<
        (returnValue: ByteSS, p3: ByteSS)
    > {
        return Promise.value((p1 + p2, p1.reversed()))
    }

    func opBoolSSAsync(p1: BoolSS, p2: BoolSS, current _: Current) -> Promise<
        (returnValue: BoolSS, p3: BoolSS)
    > {
        return Promise.value((p1.reversed(), p1 + p2))
    }

    func opShortIntLongSSAsync(
        p1: ShortSS,
        p2: IntSS,
        p3: LongSS,
        current _: Current
    ...
    func opFloatDoubleSSAsync(
        p1: FloatSS,
        p2: DoubleSS,
        current _: Current
    ) -> Promise<(returnValue: DoubleSS, p3: FloatSS, p4: DoubleSS)> {
        return Promise.value((p2 + p2, p1, p2.reversed()))
    }

    func opStringSSAsync(
        p1: StringSS,
        p2: StringSS,
        current _: Current
    ) -> Promise<(returnValue: StringSS, p3: StringSS)> {
        return Promise.value((p2.reversed(), p1 + p2))
    }

    func opStringSSSAsync(
        p1: StringSSS,
        p2: StringSSS,
        current _: Current
    ) -> Promise<(returnValue: StringSSS, p3: StringSSS)> {
        return Promise.value((p2.reversed(), p1 + p2))
    }

    func opByteBoolDAsync(
        p1: ByteBoolD,
        p2: ByteBoolD,
        current _: Current
    ) -> Promise<(returnValue: ByteBoolD, p3: ByteBoolD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p1))
    }

    func opShortIntDAsync(
        p1: ShortIntD,
        p2: ShortIntD,
        current _: Current
    ) -> Promise<(returnValue: ShortIntD, p3: ShortIntD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p1))
    }

    func opLongFloatDAsync(
        p1: LongFloatD,
        p2: LongFloatD,
        current _: Current
    ) -> Promise<(returnValue: LongFloatD, p3: LongFloatD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p1))
    }

    func opStringStringDAsync(
        p1: StringStringD,
        p2: StringStringD,
        current _: Current
    ) -> Promise<(returnValue: StringStringD, p3: StringStringD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p1))
    }

    func opStringMyEnumDAsync(
        p1: StringMyEnumD,
        p2: StringMyEnumD,
        current _: Current
    ) -> Promise<(returnValue: StringMyEnumD, p3: StringMyEnumD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p1))
    }

    func opMyEnumStringDAsync(
        p1: MyEnumStringD,
        p2: MyEnumStringD,
        current _: Current
    ) -> Promise<(returnValue: MyEnumStringD, p3: MyEnumStringD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p1))
    }

    func opMyStructMyEnumDAsync(
        p1: MyStructMyEnumD,
        p2: MyStructMyEnumD,
        current _: Current
    ) -> Promise<(returnValue: MyStructMyEnumD, p3: MyStructMyEnumD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p1))
    }

    func opByteBoolDSAsync(
        p1: ByteBoolDS,
        p2: ByteBoolDS,
        current _: Current
    ) -> Promise<(returnValue: ByteBoolDS, p3: ByteBoolDS)> {
        return Promise.value((p1.reversed(), p2 + p1))
    }

    func opShortIntDSAsync(
        p1: ShortIntDS,
        p2: ShortIntDS,
        current _: Current
    ) -> Promise<(returnValue: ShortIntDS, p3: ShortIntDS)> {
        return Promise.value((p1.reversed(), p2 + p1))
    }

    func opLongFloatDSAsync(
        p1: LongFloatDS,
        p2: LongFloatDS,
        current _: Current
    ) -> Promise<(returnValue: LongFloatDS, p3: LongFloatDS)> {
        return Promise.value((p1.reversed(), p2 + p1))
    }

    func opStringStringDSAsync(
        p1: StringStringDS,
        p2: StringStringDS,
        current _: Current
    ) -> Promise<(returnValue: StringStringDS, p3: StringStringDS)> {
        return Promise.value((p1.reversed(), p2 + p1))
    }

    func opStringMyEnumDSAsync(
        p1: StringMyEnumDS,
        p2: StringMyEnumDS,
        current _: Current
    ) -> Promise<(returnValue: StringMyEnumDS, p3: StringMyEnumDS)> {
        return Promise.value((p1.reversed(), p2 + p1))
    }

    func opMyEnumStringDSAsync(
        p1: MyEnumStringDS,
        p2: MyEnumStringDS,
        current _: Current
    ) -> Promise<(returnValue: MyEnumStringDS, p3: MyEnumStringDS)> {
        return Promise.value((p1.reversed(), p2 + p1))
    }

    func opMyStructMyEnumDSAsync(
        p1: MyStructMyEnumDS,
        p2: MyStructMyEnumDS,
        current _: Current
    ) -> Promise<(returnValue: MyStructMyEnumDS, p3: MyStructMyEnumDS)> {
        return Promise.value((p1.reversed(), p2 + p1))
    }
    ...
    func opByteByteSDAsync(
        ...
        p2: ByteByteSD,
        current _: Current
    ) -> Promise<(returnValue: ByteByteSD, p3: ByteByteSD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p2))
    }

    func opBoolBoolSDAsync(
        p1: BoolBoolSD,
        p2: BoolBoolSD,
        current _: Current
    ) -> Promise<(returnValue: BoolBoolSD, p3: BoolBoolSD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p2))
    }

    func opShortShortSDAsync(
        p1: ShortShortSD,
        p2: ShortShortSD,
        current _: Current
    ) -> Promise<(returnValue: ShortShortSD, p3: ShortShortSD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p2))
    }

    func opIntIntSDAsync(
        p1: IntIntSD,
        p2: IntIntSD,
        current _: Current
    ) -> Promise<(returnValue: IntIntSD, p3: IntIntSD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p2))
    }

    func opLongLongSDAsync(
        p1: LongLongSD,
        p2: LongLongSD,
        current _: Current
    ) -> Promise<(returnValue: LongLongSD, p3: LongLongSD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p2))
    }

    func opStringFloatSDAsync(
        p1: StringFloatSD,
        p2: StringFloatSD,
        current _: Current
    ) -> Promise<(returnValue: StringFloatSD, p3: StringFloatSD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p2))
    }

    func opStringDoubleSDAsync(
        p1: StringDoubleSD,
        p2: StringDoubleSD,
        current _: Current
    ) -> Promise<(returnValue: StringDoubleSD, p3: StringDoubleSD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p2))
    }

    func opStringStringSDAsync(
        p1: StringStringSD,
        p2: StringStringSD,
        current _: Current
    ) -> Promise<(returnValue: StringStringSD, p3: StringStringSD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p2))
    }

    func opMyEnumMyEnumSDAsync(
        p1: MyEnumMyEnumSD,
        p2: MyEnumMyEnumSD,
        current _: Current
    ) -> Promise<(returnValue: MyEnumMyEnumSD, p3: MyEnumMyEnumSD)> {
        return Promise.value((p1.merging(p2) { _, new in new }, p2))
    }
    ...
    func opMStruct2Async(p1: Structure, current _: Current) -> Promise<
    ...
    func opMDict2Async(p1: StringStringD, current _: Current) -> Promise<
