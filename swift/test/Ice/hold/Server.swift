...
class Server: TestHelperI {
    public override func run(args: [String]) throws {
        ...
        communicator.getProperties().setProperty(key: "TestAdapter1.ThreadPool.MaxSize", value: "5")
        communicator.getProperties().setProperty(key: "TestAdapter1.ThreadPool.WarnSize", value: "0")
        ...
        communicator.getProperties().setProperty(key: "TestAdapter2.ThreadPool.MaxSize", value: "5")
        communicator.getProperties().setProperty(key: "TestAdapter2.ThreadPool.WarnSize", value: "0")
