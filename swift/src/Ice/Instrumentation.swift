...
extension InputStream {
    ...
    public func read(tag: Swift.Int32) throws -> InstrumentationThreadState? {
...
extension OutputStream {
    ...
    ///
    /// parameter _: `InstrumentationThreadState` - The enumerator to write.
    public func write(tag: Swift.Int32, value: InstrumentationThreadState?) {
...
extension InputStream {
    ...
    public func read(tag: Swift.Int32) throws -> InstrumentationConnectionState? {
        guard try readOptional(tag: tag, expectedFormat: .Size) else {
            return nil
        }
...
extension OutputStream {
    ...
    ///
    /// parameter _: `InstrumentationConnectionState` - The enumerator to write.
    public func write(tag: Swift.Int32, value: InstrumentationConnectionState?) {
        guard let v = value else {
            return
        }
...
public protocol InstrumentationInvocationObserver: InstrumentationObserver {
    ...
    func getRemoteObserver(
        con: ConnectionInfo?, endpt: Endpoint?, requestId: Swift.Int32, size: Swift.Int32
    )
...
public protocol InstrumentationCommunicatorObserver: Swift.AnyObject {
    ...
    ///
    /// - parameter operation: `Swift.String` The name of the operation.
    ///
