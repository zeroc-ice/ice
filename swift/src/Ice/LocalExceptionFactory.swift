...
class ExceptionFactory: ICEExceptionFactory {
  ...
  static func alreadyRegisteredException(
    _ kindOfObject: String, id: String, file: String, line: Int
  ) -> Error {
    return AlreadyRegisteredException(kindOfObject: kindOfObject, id: id, file: file, line: line)
  }

  static func notRegisteredException(_ kindOfObject: String, id: String, file: String, line: Int)
    -> Error
  {
  ...
  static func featureNotSupportedException(_ unsupportedFeature: String, file: String, line: Int)
    -> Error
  {
  ...
  static func operationNotExistException(
    ...
    category: String,
    facet: String,
    operation: String, file: String, line: Int
  ) -> Error {
  ...
  static func unsupportedProtocolException(
    ...
    supportedMinor: UInt8, file: String, line: Int
  ) -> Error {
  ...
  static func noValueFactoryException(_ reason: String, type: String, file: String, line: Int)
    -> Error
  {
