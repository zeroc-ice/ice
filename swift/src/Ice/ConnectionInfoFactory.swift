...
class ConnectionInfoFactory: ICEConnectionInfoFactory {
    static func createIPConnectionInfo(
        _ underlying: Any,
        incoming: Bool,
        adapterName: String,
        connectionId: String,
    ...
    static func createTCPConnectionInfo(
        ...
        return TCPConnectionInfoI(
            underlying: getUnderlying(underlying), incoming: incoming,
            adapterName: adapterName,
            connectionId: connectionId,
            localAddress: localAddress,
            localPort: localPort,
    ...
    static func createWSConnectionInfo(
        _ underlying: Any,
        incoming: Bool,
        adapterName: String,
        connectionId: String,
    ...
    static func createSSLConnectionInfo(
        _ underlying: Any,
        incoming: Bool,
        adapterName: String,
        connectionId: String,
