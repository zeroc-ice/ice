...
extension InputStream {
  ...
  public func read(tag: Swift.Int32) throws -> CompressBatch? {
...
extension OutputStream {
  ...
  ///
  /// parameter _: `CompressBatch` - The enumerator to write.
  public func write(tag: Swift.Int32, value: CompressBatch?) {
...
extension InputStream {
  ...
  public func read() throws -> ACMClose {
  ...
  public func read(tag: Swift.Int32) throws -> ACMClose? {
    guard try readOptional(tag: tag, expectedFormat: .Size) else {
      return nil
    }
...
extension OutputStream {
  ...
  public func write(_ v: ACMClose) {
  ...
  ///
  /// parameter _: `ACMClose` - The enumerator to write.
  public func write(tag: Swift.Int32, value: ACMClose?) {
    guard let v = value else {
      return
    }
...
extension InputStream {
  ...
  public func read() throws -> ACMHeartbeat {
  ...
  public func read(tag: Swift.Int32) throws -> ACMHeartbeat? {
    guard try readOptional(tag: tag, expectedFormat: .Size) else {
      return nil
    }
...
extension OutputStream {
  ...
  public func write(_ v: ACMHeartbeat) {
  ...
  ///
  /// parameter _: `ACMHeartbeat` - The enumerator to write.
  public func write(tag: Swift.Int32, value: ACMHeartbeat?) {
    guard let v = value else {
      return
    }
...
extension InputStream {
  ...
  public func read(tag: Swift.Int32) throws -> ConnectionClose? {
    guard try readOptional(tag: tag, expectedFormat: .Size) else {
      return nil
    }
...
extension OutputStream {
  ...
  ///
  /// parameter _: `ConnectionClose` - The enumerator to write.
  public func write(tag: Swift.Int32, value: ConnectionClose?) {
    guard let v = value else {
      return
    }
    write(tag: tag, val: v.rawValue, maxValue: 2)
