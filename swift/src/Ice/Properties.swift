...
public protocol Properties: Swift.AnyObject {
    ...
    /// - parameter key: `Swift.String` The property key.
    ///
    /// - parameter value: `Swift.String` The default value to use if the property does not exist.
    ///
    /// - returns: `Swift.String` - The property value or the default value.
    ...
    /// - parameter key: `Swift.String` The property key.
    ///
    /// - parameter value: `Swift.Int32` The default value to use if the property does not exist.
    ///
    /// - returns: `Swift.Int32` - The property value interpreted as an integer, or the default value.
